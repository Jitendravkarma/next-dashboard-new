  ...
  return (
    <span className="ms-auto">
      <input
        ...
        className="ti-form-input p-2 rounded-md !w-auto"
        placeholder="Search..."
      />
    </span>
  );
...
export const BasicTable = () => {
  ...
  return (
    <>
      ...
      <table
        {...getTableProps()}
        className="table table-hover mb-0 table-bordered w-full"
      >
        <thead>
    ...
    <>
      <div className="e-table">
        ...
        <div className="table-responsive table-bordered">
          <table
            {...getTableProps()}
            className="border-top-0 text-nowrap border-bottom !w-full"
          >
            <thead>
              {headerGroups.map((headerGroup) => (
                <tr {...headerGroup.getHeaderGroupProps()} key={Math.random()}>
