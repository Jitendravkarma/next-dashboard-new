...
export const sales = [
  { id: 1, icon: "briefcase-2-line", class: "Total Sales", data: "15,800", data1: "+25.8%", color: "success", color1: "!border-t-primary", color2: "primary" },
  { id: 2, icon: "bill-line", class: "Total Tax", data: "$12,650", data1: "+12.2%", color: "success", color1: "!border-t-secondary", color2: "secondary" },
  { id: 3, icon: "wallet-2-line", class: "Total Income", data: "$14,800", data1: "+7.45%", color: "success", color1: "!border-t-success", color2: "success" },
  { id: 4, icon: "line-chart-line", class: "Total Expenses", data: "$7,566", data1: "-3.21%", color: "danger", color1: "!border-t-info", color2: "info" },
  { id: 5, icon: "money-dollar-box-line", class: "Sales Profit", data: "$7,474", data1: "+36.03%", color: "success", color1: "!border-t-warning", color2: "warning" },
  { id: 6, icon: "profile-line", class: "Opex Ratio", data: "32%", data1: "+0.89%", color: "success", color1: "!border-t-danger", color2: "danger" },
];
...
export class WidgetsRevenue extends Component {
  ...
  render() {
    return (
      ...
      <div>
        <ReactApexChart height={180} width={"100%"} options={this.state.options} series={this.state.series} type="area" />
      </div>
    );
  }
};
...
export class Applicants extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      options: {
        ...
        colors: ['rgba(var(--color-primary))', 'rgba(90,102,241, 0.1)'],
        grid: {
  ...
  render() {
    return (
      ...
      <div>
        <ReactApexChart height={348} width={"100%"} options={this.state.options} series={this.state.series} type="line" />
      </div>
    );
  }
};
...
export class SessionsDevice extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      options: {
        ...
        colors: ["#f43f63", "#60a5fa", "rgba(var(--color-primary))"],
        dataLabels: {
          enabled: false
        },
        legend: {
  ...
  render() {
    return (
      ...
      <div>
        <ReactApexChart height={348} width={"100%"} options={this.state.options} series={this.state.series} type="bubble" />
      </div>
    );
  }
};
...
export class TargetReport extends Component {
  ...
  render() {
    return (
      ...
      <div>
        <ReactApexChart height={240} width={"100%"} options={this.state.options} series={this.state.series} type="bar" />
      </div>
    );
  }
};
  ...
  return (
    ...
    <div className="flex">
      <div className="controls">
        <div>
          <button className="me-2" onClick={handleZoomIn}>
