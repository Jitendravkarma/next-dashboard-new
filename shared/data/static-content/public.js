...
export const HeroContent = [
    {
      text: <span>Enhance Your Marketing With  <br />Data Scrapper</span>,
    },
    {
      text: <span>Boost Your Business With  <br />Data Scrapper</span>,
    },
    {
      text: <span>Increase Your Sales With  <br />Data Scrapper</span>,
    },
]
...
export const tabs = [
  ...
  {
    key: "Quality Information Collection",
...
export const priceplanmonth = [
  {
    ...
    content: [
      {
        tooltips:
          "Basic features include access to essential tools for simple tasks.",
        text: "Access to basic features",
        question: true, // Tooltip enabled
      },
      {
        tooltips:
      ...
      {
        tooltips: "Downloads are limited to a certain number per plan period.",
  ...
  },
  {
    ...
    content: [
      {
        tooltips:
          "Access all Standard Plan features for efficient web scraping.",
      ...
      {
        tooltips: "Direct contact with support for timely assistance.",
        text: "Direct Contact",
        question: true,
      },
      {
      ...
      {
        tooltips: "Receive priority support for Standard Plan users.",
  ...
  },
  {
    ...
    content: [
      ...
      {
        tooltips: "Get direct support contact for critical issues.",
        text: "Direct Contact",
        question: true,
      },
      {
        tooltips: "Download unlimited data records without caps.",
