...
export const seo_contact = {
    ...
    description: `Contact So Lets Talk Data! Contact us for inquiries, support, partnerships and custom data scraping solutions. We are here to assist with your web extraction needs.`,
    keywords: `Contact So Lets Talk Data, customer support, web scraping queries, data extraction services, web crawler assistance, scraping software support, API integration support`
}

export const seo_signin = {
    title: `Sign In to Your So Lets Talk Data Account`,
    description: `Log in to your So Lets Talk Data account to access powerful web scraping tools, manage data extraction, and effortlessly automate business intelligence tasks.`,
...
export const seo_signup = {
    title: `Sign Up for So Lets Talk Data Tools`,
    description: `Create a free account on So Lets Talk Data and start extracting data from Google, Maps, Websites and Documents instantly. Join now and automate data collection!`,
...
export const seo_forget_password = {
    title: `Reset Your Password - So Lets Talk Data`,
    description: `Securely reset your So Lets Talk Data password and regain access to your web scraping tools. Follow the simple steps to recover your account.`,
...
export const seo_privacy = {
    title: `Privacy Policy | So Lets Talk Data`,
    description: `Your privacy matters! Read the privacy policy of So Lets Talk Data to understand how we collect, use and protect your data while providing web scraping services.`,
    keywords: `Contact So Lets Talk Data, customer support, web scraping queries, data extraction services, web crawler assistance, scraping software support, API integration support`
}
...
export const seo_google_search = {
    title: `Google Search - So Lets Talk Data`,
...
export const seo_google_map = {
    title: `Powerful Google Maps Scraper & Data Extractor for Accurate Results - So Lets Talk Data`,
...
export const seo_website_scraper = {
    title: `Website Data Scraper Software | Efficient Web Scraping Tools - So Lets Talk Data`,
...
export const seo_image_scraper = {
    title: `Effortlessly Scrape Images from Any Website | Free Image Scraper - So Lets Talk Data`,
...
export const seo_directory_scraper = {
    title: `Business Directory & Yellow Pages Scraper | Free Download Tool - So Lets Talk Data`,
...
export const seo_whois_data = {
    title: `Whois Domain Database - So Lets Talk Data`,
...
export const seo_verify = {
    title: `Email Verification - So Lets Talk Data`,
...
export const seo_docs = {
    title: `Documentation - So Lets Talk Data`,
...
export const seo_live_data = {
    title: `Live Website Data - So Lets Talk Data`,
