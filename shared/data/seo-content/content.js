export const seo_home = {
    title: `Simple Data Scraping Made Possible by Data Scrapper`,
    description: `Data Scrapper – The ultimate web scraping and data extraction tool for Google Search, Google Maps, Websites, Documents, Images, Business Directories and Whois Domains. Automated data collection for lead generation, market research and business intelligence.`,
...
export const seo_pricing = {
    title: `Pricing - Data Scrapper`,
    description: `Explore Data Scrapper's pricing plans and choose the best web scraping solution for your needs. Affordable plans for Google Search Scraper, Google Maps Scraper, Website Data Scraper, Whois Domain Lookup, and more. Start extracting data today!`,
...
export const seo_about = {
    ...
    description: `Learn more about Data Scrapper – a powerful web scraping solution designed to automate data extraction from Google Search, Google Maps, websites, documents, and more. Explore our mission, technology and expertise in data mining and automation.`,
    keywords: `About Data Scrapper, web scraping company, data extraction experts, automated lead generation, business data mining, advanced web crawler, scraping solutions`
}

export const seo_contact = {
    title: `Contact Us - Get in Touch for Data Scraping Solutions`,
    description: `Contact Data Scrapper! Contact us for inquiries, support, partnerships and custom data scraping solutions. We are here to assist with your web extraction needs.`,
    keywords: `Contact Data Scrapper, customer support, web scraping queries, data extraction services, web crawler assistance, scraping software support, API integration support`
}

export const seo_signin = {
    title: `Sign In to Your Data Scrapper Account`,
    description: `Log in to your Data Scrapper account to access powerful web scraping tools, manage data extraction, and effortlessly automate business intelligence tasks.`,
...
export const seo_signup = {
    title: `Sign Up for Data Scrapper Tools`,
    description: `Create a free account on Data Scrapper and start extracting data from Google, Maps, Websites and Documents instantly. Join now and automate data collection!`,
...
export const seo_forget_password = {
    title: `Reset Your Password - Data Scrapper`,
    description: `Securely reset your Data Scrapper password and regain access to your web scraping tools. Follow the simple steps to recover your account.`,
...
export const seo_terms = {
    title: `Terms and Conditions | Data Scrapper`,
...
export const seo_privacy = {
    title: `Privacy Policy | Data Scrapper`,
    description: `Your privacy matters! Read the privacy policy of Data Scrapper to understand how we collect, use and protect your data while providing web scraping services.`,
    keywords: `Contact Data Scrapper, customer support, web scraping queries, data extraction services, web crawler assistance, scraping software support, API integration support`
}
...
export const seo_google_search = {
    title: `Google Search - Data Scrapper`,
...
export const seo_google_map = {
    title: `Powerful Google Maps Scraper & Data Extractor for Accurate Results - Data Scrapper`,
...
export const seo_website_scraper = {
    title: `Website Data Scraper Software | Efficient Web Scraping Tools - Data Scrapper`,
...
export const seo_document_scraper = {
    title: `Document Data Scraper | Efficient Contact Info Scraper - Data Scrapper`,
...
export const seo_image_scraper = {
    title: `Effortlessly Scrape Images from Any Website | Free Image Scraper - Data Scrapper`,
...
export const seo_directory_scraper = {
    title: `Business Directory & Yellow Pages Scraper | Free Download Tool - Data Scrapper`,
...
export const seo_whois_data = {
    title: `Whois Domain Database - Data Scrapper`,
...
export const seo_verify = {
    title: `Email Verification - Data Scrapper`,
...
export const seo_docs = {
    title: `Documentation - Data Scrapper`,
    description: `Check out the comprehensive Data Scrapper documentation to learn how to efficiently scrape data from Google Search, Google Maps, business directories, websites, documents, and more. Get started with API usage, advanced filtering, and automation for seamless data extraction.`,
    keywords: `Data Scrapper documentation, data scraping API, web scraping guide, Google Maps scraper, business directory scraper, website data extractor, automation tools, data extraction guide, scraping software tutorial, how to scrape websites, web crawling guide`
}

export const seo_live_scraping = {
    title: `Live Website Scraping - Data Scrapper`,
    description: `Check out the comprehensive Data Scrapper documentation to learn how to efficiently scrape data from Google Search, Google Maps, business directories, websites, documents, and more. Get started with API usage, advanced filtering, and automation for seamless data extraction.`,
    keywords: `Data Scrapper documentation, data scraping API, web scraping guide, Google Maps scraper, business directory scraper, website data extractor, automation tools, data extraction guide, scraping software tutorial, how to scrape websites, web crawling guide`
}

export const seo_live_data = {
    title: `Live Website Data - Data Scrapper`,
...
export const seo_bing = {
    title: `Bing Search Scraper - Data Scrapper`,
    description: `Check out the comprehensive Data Scrapper documentation to learn how to efficiently scrape data from Google Search, Google Maps, business directories, websites, documents, and more. Get started with API usage, advanced filtering, and automation for seamless data extraction.`,
    keywords: `Data Scrapper documentation, data scraping API, web scraping guide, Google Maps scraper, business directory scraper, website data extractor, automation tools, data extraction guide, scraping software tutorial, how to scrape websites, web crawling guide`
}

export const seo_yahoo = {
    title: `Yahoo Search Scraper - Data Scrapper`,
    description: `Check out the comprehensive Data Scrapper documentation to learn how to efficiently scrape data from Google Search, Google Maps, business directories, websites, documents, and more. Get started with API usage, advanced filtering, and automation for seamless data extraction.`,
    keywords: `Data Scrapper documentation, data scraping API, web scraping guide, Google Maps scraper, business directory scraper, website data extractor, automation tools, data extraction guide, scraping software tutorial, how to scrape websites, web crawling guide`
}

export const seo_duck = {
    title: `Duck Duck Go Search Scraper - Data Scrapper`,
    description: `Check out the comprehensive Data Scrapper documentation to learn how to efficiently scrape data from Google Search, Google Maps, business directories, websites, documents, and more. Get started with API usage, advanced filtering, and automation for seamless data extraction.`,
    keywords: `Data Scrapper documentation, data scraping API, web scraping guide, Google Maps scraper, business directory scraper, website data extractor, automation tools, data extraction guide, scraping software tutorial, how to scrape websites, web crawling guide`
}

export const seo_facebook = {
    title: `Facebook Scraper - Data Scrapper`,
    description: `Check out the comprehensive Data Scrapper documentation to learn how to efficiently scrape data from Google Search, Google Maps, business directories, websites, documents, and more. Get started with API usage, advanced filtering, and automation for seamless data extraction.`,
    keywords: `Data Scrapper documentation, data scraping API, web scraping guide, Google Maps scraper, business directory scraper, website data extractor, automation tools, data extraction guide, scraping software tutorial, how to scrape websites, web crawling guide`
}

export const seo_youtube = {
    title: `Youtube Scraper - Data Scrapper`,
    description: `Check out the comprehensive Data Scrapper documentation to learn how to efficiently scrape data from Google Search, Google Maps, business directories, websites, documents, and more. Get started with API usage, advanced filtering, and automation for seamless data extraction.`,
    keywords: `Data Scrapper documentation, data scraping API, web scraping guide, Google Maps scraper, business directory scraper, website data extractor, automation tools, data extraction guide, scraping software tutorial, how to scrape websites, web crawling guide`
}
...
export const seo_not_found = {
    ...
    description: `This page is not avaiable on Data Scrapper`,
    keyword: `Page Not Found`
}

export const seo_justdial_scraper = {
    title: `Justdail Scraper | Efficient Web Scraping Tools - Data Scrapper`,
    description: `Automate data collection from any website with our powerful website data scraper. Extract text, links, images and structured data for research, analysis and business insights. No coding required!`,
    keywords: `Website data extraction, web scraper tool, online data collection, web crawling software, HTML scraper, website content extraction, automated web scraping`
}
export const seo_indiamart_scraper = {
    title: `IndiaMart Scraper | Efficient Web Scraping Tools - Data Scrapper`,
    description: `Automate data collection from any website with our powerful website data scraper. Extract text, links, images and structured data for research, analysis and business insights. No coding required!`,
    keywords: `Website data extraction, web scraper tool, online data collection, web crawling software, HTML scraper, website content extraction, automated web scraping`
}
export const seo_tradeindia_scraper = {
    title: `Tradeindia Scraper | Efficient Web Scraping Tools - Data Scrapper`,
    description: `Automate data collection from any website with our powerful website data scraper. Extract text, links, images and structured data for research, analysis and business insights. No coding required!`,
    keywords: `Website data extraction, web scraper tool, online data collection, web crawling software, HTML scraper, website content extraction, automated web scraping`
}
export const seo_exportersindia_scraper = {
    title: `ExportersIndia Scraper | Efficient Web Scraping Tools - Data Scrapper`,
    description: `Automate data collection from any website with our powerful website data scraper. Extract text, links, images and structured data for research, analysis and business insights. No coding required!`,
    keywords: `Website data extraction, web scraper tool, online data collection, web crawling software, HTML scraper, website content extraction, automated web scraping`
}
export const seo_email_scraper = {
    title: `Email Scraper | Efficient Web Scraping Tools - Data Scrapper`,
    description: `Automate data collection from any website with our powerful website data scraper. Extract text, links, images and structured data for research, analysis and business insights. No coding required!`,
    keywords: `Website data extraction, web scraper tool, online data collection, web crawling software, HTML scraper, website content extraction, automated web scraping`
}
export const seo_phone_scraper = {
    title: `Phone Scraper Software | Efficient Web Scraping Tools - Data Scrapper`,
    description: `Automate data collection from any website with our powerful website data scraper. Extract text, links, images and structured data for research, analysis and business insights. No coding required!`,
    keywords: `Website data extraction, web scraper tool, online data collection, web crawling software, HTML scraper, website content extraction, automated web scraping`
}