...
export const seo_contact = {
    ...
    description: `Contact So Lets Talk Digital! Contact us for inquiries, support, partnerships and custom data scraping solutions. We are here to assist with your web extraction needs.`,
    keywords: `Contact So Lets Talk Digital, customer support, web scraping queries, data extraction services, web crawler assistance, scraping software support, API integration support`
}

export const seo_signin = {
    title: `Sign In to Your So Lets Talk Digital Account`,
    description: `Log in to your So Lets Talk Digital account to access powerful web scraping tools, manage data extraction, and effortlessly automate business intelligence tasks.`,
...
export const seo_signup = {
    title: `Sign Up for So Lets Talk Digital Tools`,
    description: `Create a free account on So Lets Talk Digital and start extracting data from Google, Maps, Websites and Documents instantly. Join now and automate data collection!`,
...
export const seo_forget_password = {
    title: `Reset Your Password - So Lets Talk Digital`,
    description: `Securely reset your So Lets Talk Digital password and regain access to your web scraping tools. Follow the simple steps to recover your account.`,
...
export const seo_terms = {
    title: `Terms and Conditions | So Lets Talk Digital`,
    description: `Read the terms and conditions of So Lets Talk Digital. Understand the rules, policies, and usage guidelines for our web scraping services, ensuring compliance and ethical data extraction.`,
...
export const seo_privacy = {
    title: `Privacy Policy | So Lets Talk Digital`,
    description: `Your privacy matters! Read the privacy policy of So Lets Talk Digital to understand how we collect, use and protect your data while providing web scraping services.`,
    keywords: `Contact So Lets Talk Digital, customer support, web scraping queries, data extraction services, web crawler assistance, scraping software support, API integration support`
}

export const seo_faq = {
    title: `Frequently Asked Questions | Document & Data Scraping Tools`,
    description: `Find answers to common questions about So Lets Talk Digital. Learn how to use our web scraping tools, pricing details, features, API access, and data extraction best practices. Get expert insight and troubleshooting help.`,
...
export const seo_google_search = {
    title: `Google Search - So Lets Talk Digital`,
...
export const seo_google_map = {
    title: `Powerful Google Maps Scraper & Data Extractor for Accurate Results - So Lets Talk Digital`,
...
export const seo_website_scraper = {
    title: `Website Data Scraper Software | Efficient Web Scraping Tools - So Lets Talk Digital`,
...
export const seo_document_scraper = {
    title: `Document Data Scraper | Efficient Contact Info Scraper - So Lets Talk Digital`,
...
export const seo_image_scraper = {
    title: `Effortlessly Scrape Images from Any Website | Free Image Scraper - So Lets Talk Digital`,
...
export const seo_directory_scraper = {
    title: `Business Directory & Yellow Pages Scraper | Free Download Tool - So Lets Talk Digital`,
...
export const seo_whois_data = {
    title: `Whois Domain Database - So Lets Talk Digital`,
...
export const seo_verify = {
    title: `Email Verification - So Lets Talk Digital`,
...
export const seo_docs = {
    title: `Documentation - So Lets Talk Digital`,
    description: `Check out the comprehensive So Lets Talk Digital documentation to learn how to efficiently scrape data from Google Search, Google Maps, business directories, websites, documents, and more. Get started with API usage, advanced filtering, and automation for seamless data extraction.`,
    keywords: `So Lets Talk Digital documentation, data scraping API, web scraping guide, Google Maps scraper, business directory scraper, website data extractor, automation tools, data extraction guide, scraping software tutorial, how to scrape websites, web crawling guide`
}

export const seo_live_scraping = {
    title: `Live Website Scraping - So Lets Talk Digital`,
    description: `Check out the comprehensive So Lets Talk Digital documentation to learn how to efficiently scrape data from Google Search, Google Maps, business directories, websites, documents, and more. Get started with API usage, advanced filtering, and automation for seamless data extraction.`,
    keywords: `So Lets Talk Digital documentation, data scraping API, web scraping guide, Google Maps scraper, business directory scraper, website data extractor, automation tools, data extraction guide, scraping software tutorial, how to scrape websites, web crawling guide`
}

export const seo_live_data = {
    title: `Live Website Data - So Lets Talk Digital`,
...
export const seo_not_found = {
    ...
    description: `This page is not avaiable on So Lets Talk Digital`,
