...
const Modalsearch = () => {
  ...
  const ModalData = [
    { id: 1, class: "Team", icon: "user-line", path: "/pages/team" },
    { id: 2, class: "Forms", icon: "file-text-line", path: "/forms/form-inputs" },
    { id: 3, class: "Maps", icon: "map-pin-line", path: "/maps/leaflet-maps/" },
    { id: 4, class: "Widgets", icon: "server-line", path: "/widgets" },
  ];

  const Alertdata = [
    { id: 1, class: "Notifications", path: "/advance-ui/notifications/" },
    { id: 2, class: "Alerts", path: "/components/alerts/" },
    { id: 3, class: "Tables", path: "/basic-ui/tables/basic-tables" },
  ];
      ...
      <div className="ti-modal-box">
        <div className="ti-modal-content">
          <div className="ti-modal-body">
            <div className="header-search">
              ...
              <div className="relative">
                ...
                <input
                  id="icon"
                  name="icon"
                  className="py-2 ltr:pl-11 rtl:pr-11 ltr:pr-12 rtl:pl-12 ti-form-input focus:z-10"
                  type="search"
                ...
                <div className="search-dropdown hs-dropdown ti-dropdown open">
                  <button type="button" aria-label="button" className="hs-dropdown-toggle ti-dropdown-toggle text-gray-500 dark:!bg-transparent dark:text-white/70 p-0 !border-0 shadow-none"> <i className="ri ri-more-2-line search-dropdown-btn-icon"></i> </button>
                  <div className="hs-dropdown-menu ti-dropdown-menu" data-popper-placement="bottom-start" >
                    <a className="ti-dropdown-item" href="#!">Action</a>
                    <a className="ti-dropdown-item" href="#!">Another Acttion</a>
            ...
            {show1 ? (
              <div className="box search-result relative z-[9] search-fix  border border-gray-200 dark:border-white/10 mt-1 w-100 overflow-hidden">
              ...
              <div>
                {allData.map((idx) => (
                  <div key={idx.id} className="badge me-2 rounded-sm bg-secondary/20 text-secondary relative header-box">
                    ...
                    >
                      <span className="inline-block text-secondary me-1">
