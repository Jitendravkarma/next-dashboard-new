...
const PrimaryButton = () => {
  ...
  return (
    <div className="flex justify-center space-x-4">
      {/* Get Started Button */}
      <Link href={"https://modiguru.com/tradetap"} target='_blank' className="lg:text-base text-xs font-medium bg-blue-500 hover:bg-blue-600 text-white rounded-md py-2 px-4">
        Buy Now
      </Link>
      {/* Learn More Button */}
