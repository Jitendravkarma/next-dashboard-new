...
const PriceTable = () => {
  ...
  return (
    <div>
      ...
      <div className="px-6 max-w-7xl mx-auto bg-white border border-gray-200 rounded-md overflow-x-auto shadow">
        <div className="w-[500px] md:w-auto mx-auto overflow-x-auto">
