      ...
      <div className="text-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {featurestemplates.map((template, index) => (
            ...
            >
              {
                (template.toolName === "justdial" || template.toolName === "indiamart" || template.toolName === "sulekha" || template.toolName === "phone" || template.toolName === "email") &&
                <div className="bg-red-500 text-white animate-pulse rotate-45 py-1 px-10 text-[10px] absolute top-2 -right-8">
                  New
                </div>
              }
