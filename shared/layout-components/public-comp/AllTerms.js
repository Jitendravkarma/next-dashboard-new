      ...
      <div className="max-w-7xl mx-auto px-4 py-16 lg:py-18 sm:px-6 lg:px-10 flex flex-wrap items-center justify-between p-4">
        <div className="prose">
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>TradeTAP</b>., as stated in this agreement, by using{" "}
            <b>TradeTAP</b>.
          </p>
          <br />
          <p className="text-xss font-light leading-normal">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use <b>TradeTAP</b> if you do not
          ...
          <p className="text-xss font-light leading-normal">
            We employ the use of cookies. By accessing <b>TradeTAP</b>, you
            agreed to use cookies in agreement with the <b>TradeTAP</b>'s
            Privacy Policy.
          </p>
          ...
          <p className="text-xss font-light leading-normal">
            Unless otherwise stated, <b>TradeTAP</b> and/or its licensors own
            ...
            access this from <b>TradeTAP</b> for your own personal use
          ...
          <ul className="list-disc list-inside text-xss font-light leading-normal  my-5 marker:text-green-500 marker:text-xl">
            <li>
              Republish material from <b>TradeTAP</b>
            </li>
            <li>
              Sell, rent or sub-license material from <b>TradeTAP</b>
            </li>
            <li>
              Reproduce, duplicate or copy material from <b>TradeTAP</b>
            </li>
            <li>
              Redistribute content from <b>TradeTAP</b>
            </li>
          </ul>
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>TradeTAP</b> does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of <b>TradeTAP</b>, its agents and/or
            ...
            applicable laws, <b>TradeTAP</b> shall not be liable for the
          ...
          <p className="text-xss font-light leading-normal">
            <b>TradeTAP</b> reserves the right to monitor all Comments and to
          ...
          <p className="text-xss font-light leading-normal">
            You hereby grant <b>TradeTAP</b> a non-exclusive license to use,
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>TradeTAP</b>; and (d) the link is in the context of general
          ...
          <p className="text-xss font-light leading-normal">
            ...
            sending an e-mail to <b>TradeTAP</b>. Please include your name,
          ...
          <p className="text-xss font-light leading-normal">
            No use of <b>TradeTAP</b>'s logo or other artwork will be allowed
