      ...
      <div className="max-w-7xl mx-auto px-4 py-16 lg:py-18 sm:px-6 lg:px-10 flex flex-wrap items-center justify-between p-4">
        <div className="prose">
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>Scrape Genius</b>., as stated in this agreement, by using{" "}
            <b>Scrape Genius</b>.
          </p>
          <br />
          <p className="text-xss font-light leading-normal">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use <b>Scrape Genius</b> if you do not
          ...
          <ul className="list-disc list-inside text-xss font-light leading-normal  my-5 marker:text-green-500 marker:text-xl">
            <li>
              Republish material from <b>Scrape Genius</b>
            </li>
            <li>
            ...
            <li>
              Redistribute content from <b>Scrape Genius</b>
            </li>
          </ul>
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>Scrape Genius</b> does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of <b>Scrape Genius</b>, its agents and/or
            ...
            applicable laws, <b>Scrape Genius</b> shall not be liable for the
          ...
          <p className="text-xss font-light leading-normal">
            <b>Scrape Genius</b> reserves the right to monitor all Comments and to
          ...
          <p className="text-xss font-light leading-normal">
            You hereby grant <b>Scrape Genius</b> a non-exclusive license to use,
          ...
          <p className="text-xss font-light leading-normal">
            ...
            sending an e-mail to <b>Scrape Genius</b>. Please include your name,
          ...
          <p className="text-xss font-light leading-normal">
            No use of <b>Scrape Genius</b>'s logo or other artwork will be allowed
