      ...
      <div className="max-w-7xl mx-auto px-4 py-16 lg:py-18 sm:px-6 lg:px-10 flex flex-wrap items-center justify-between p-4">
        <div className="prose">
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>Lead Data</b>., as stated in this agreement, by using{" "}
            <b>Lead Data</b>.
          </p>
          <br />
          <p className="text-xss font-light leading-normal">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use <b>Lead Data</b> if you do not
          ...
          <p className="text-xss font-light leading-normal">
            Unless otherwise stated, <b>Lead Data</b> and/or its licensors own
            ...
            access this from <b>Lead Data</b> for your own personal use
          ...
          <ul className="list-disc list-inside text-xss font-light leading-normal  my-5 marker:text-green-500 marker:text-xl">
            <li>
              Republish material from <b>Lead Data</b>
            </li>
            <li>
            ...
            <li>
              Redistribute content from <b>Lead Data</b>
            </li>
          </ul>
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>Lead Data</b> does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of <b>Lead Data</b>, its agents and/or
            ...
            applicable laws, <b>Lead Data</b> shall not be liable for the
          ...
          <p className="text-xss font-light leading-normal">
            <b>Lead Data</b> reserves the right to monitor all Comments and to
          ...
          <p className="text-xss font-light leading-normal">
            You hereby grant <b>Lead Data</b> a non-exclusive license to use,
          ...
          <p className="text-xss font-light leading-normal">
            ...
            sending an e-mail to <b>Lead Data</b>. Please include your name,
          ...
          <p className="text-xss font-light leading-normal">
            No use of <b>Lead Data</b>'s logo or other artwork will be allowed
