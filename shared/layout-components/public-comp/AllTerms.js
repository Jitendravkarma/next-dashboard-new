  ...
  return (
    <section className="bg-white">
      <div className="max-w-7xl mx-auto px-4 py-16 lg:py-18 sm:px-6 lg:px-10 flex flex-wrap items-center justify-between p-4">
        <div className="prose">
          <p className="text-xss font-bold leading-normal">
            Welcome to <b>So Lets Talk Data</b>!
          </p>
          <br />
          <p className="text-xss font-light leading-normal">
            This service is owned and run by <b>{companyDetails.company_name}</b>. Which
            also owns this product. You accept the terms and conditions of{" "}
            <b>So Lets Talk Data</b>., as stated in this agreement, by using{" "}
            <b>So Lets Talk Data</b>.
          </p>
          <br />
          <p className="text-xss font-light leading-normal">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use <b>So Lets Talk Data</b> if you do not
          ...
          <p className="text-xss font-light leading-normal">
            We employ the use of cookies. By accessing <b>So Lets Talk Data</b>, you
            agreed to use cookies in agreement with the <b>So Lets Talk Data</b>'s
            Privacy Policy.
          </p>
          ...
          <p className="text-xss font-light leading-normal">
            Unless otherwise stated, <b>So Lets Talk Data</b> and/or its licensors own
            ...
            access this from <b>So Lets Talk Data</b> for your own personal use
          ...
          <ul className="list-disc list-inside text-xss font-light leading-normal  my-5 marker:text-green-500 marker:text-xl">
            <li>
              Republish material from <b>So Lets Talk Data</b>
            </li>
            <li>
              Sell, rent or sub-license material from <b>So Lets Talk Data</b>
            </li>
            <li>
              Reproduce, duplicate or copy material from <b>So Lets Talk Data</b>
            </li>
            <li>
              Redistribute content from <b>So Lets Talk Data</b>
            </li>
          </ul>
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>So Lets Talk Data</b> does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of <b>So Lets Talk Data</b>, its agents and/or
            ...
            applicable laws, <b>So Lets Talk Data</b> shall not be liable for the
          ...
          <p className="text-xss font-light leading-normal">
            <b>So Lets Talk Data</b> reserves the right to monitor all Comments and to
          ...
          <p className="text-xss font-light leading-normal">
            You hereby grant <b>So Lets Talk Data</b> a non-exclusive license to use,
            reproduce, edit and authorize others to use, reproduce and edit any
            of your Comments in any and all forms, formats or media.
          </p>

          <h3 className="font-bold text-2xl mt-8 mb-3">
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>So Lets Talk Data</b>; and (d) the link is in the context of general
          ...
          <p className="text-xss font-light leading-normal">
            ...
            sending an e-mail to <b>So Lets Talk Data</b>. Please include your name,
          ...
          <p className="text-xss font-light leading-normal">
            No use of <b>So Lets Talk Data</b>'s logo or other artwork will be allowed
            for linking absent a trademark license agreement.
          </p>

          <h3 className="font-bold text-2xl mt-8 mb-3">iFrames</h3>
          ...
          <h3 className="font-bold text-2xl mt-8 mb-3">Content Liability</h3>
          ...
          <h3 className="font-bold text-2xl mt-8 mb-3">Disclaimer</h3>
          ...
          {/* <div className="text-center mt-28 mb-5 bg-blue-100 rounded-md py-16 px-5">
              ...
              <div className="text-sm sm:text-lg font-light leading-normal">
                ...
                <p className="mt-3 text-2xl sm:text-5xl text-center">
                  <a href={`mailto:${resellerContactInfo.email}`}>
