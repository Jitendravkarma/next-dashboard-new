      ...
      <div className="max-w-7xl mx-auto px-4 py-16 lg:py-18 sm:px-6 lg:px-10 flex flex-wrap items-center justify-between p-4">
        <div className="prose">
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>Data Scrapper</b>., as stated in this agreement, by using{" "}
            <b>Data Scrapper</b>.
          </p>
          <br />
          <p className="text-xss font-light leading-normal">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use <b>Data Scrapper</b> if you do not
          ...
          <p className="text-xss font-light leading-normal">
            We employ the use of cookies. By accessing <b>Data Scrapper</b>, you
            agreed to use cookies in agreement with the <b>Data Scrapper</b>'s
            Privacy Policy.
          </p>
          ...
          <p className="text-xss font-light leading-normal">
            Unless otherwise stated, <b>Data Scrapper</b> and/or its licensors own
            ...
            access this from <b>Data Scrapper</b> for your own personal use
          ...
          <ul className="list-disc list-inside text-xss font-light leading-normal  my-5 marker:text-green-500 marker:text-xl">
            <li>
              Republish material from <b>Data Scrapper</b>
            </li>
            <li>
              Sell, rent or sub-license material from <b>Data Scrapper</b>
            </li>
            <li>
              Reproduce, duplicate or copy material from <b>Data Scrapper</b>
            </li>
            <li>
              Redistribute content from <b>Data Scrapper</b>
            </li>
          </ul>
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>Data Scrapper</b> does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of <b>Data Scrapper</b>, its agents and/or
            ...
            applicable laws, <b>Data Scrapper</b> shall not be liable for the
          ...
          <p className="text-xss font-light leading-normal">
            <b>Data Scrapper</b> reserves the right to monitor all Comments and to
          ...
          <p className="text-xss font-light leading-normal">
            You hereby grant <b>Data Scrapper</b> a non-exclusive license to use,
          ...
          <p className="text-xss font-light leading-normal">
            ...
            <b>Data Scrapper</b>; and (d) the link is in the context of general
          ...
          <p className="text-xss font-light leading-normal">
            ...
            sending an e-mail to <b>Data Scrapper</b>. Please include your name,
          ...
          <p className="text-xss font-light leading-normal">
            No use of <b>Data Scrapper</b>'s logo or other artwork will be allowed
