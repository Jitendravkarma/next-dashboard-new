...
const PolicyContentData = () => {
  const { resellerContactInfo } = useUserContext()
    ...
    },
    {
      ...
      description:
      <p className="text-xss font-light leading-normal">
        At LeadSeas, we provide digital products and services that are delivered electronically. Below is our Shipping and Delivery Policy outlining how we process and deliver our services.
      </p>, 
      list: true, 
      listItems: [
        <li>
