...
const DocYouTubeChannel = () => {
    const { yt_channel } = useUserContext()
  return (
    <p className="text-base text-gray-600">
        ...
        <Link href={yt_channel} target="_blank" className="my-3 inline-block text-white bg-red-500 hover:bg-red-600 rounded-sm py-2 px-3">
