...
const Workflow = () => {
  const servicesData = [
    ...
    },
    {
      ...
      description:
      <span>
          Our platform ensures seamless <b>data extraction</b> with unmatched efficiency. With <b>Lead Global's</b> advanced <b>Document Scraper</b> service, extracting critical information such as email addresses and phone numbers has never been easier.
