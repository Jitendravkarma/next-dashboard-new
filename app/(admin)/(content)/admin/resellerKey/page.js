...
// 		},
	...
	return (
		<div>
			...
			<PageHeader currentpage="Reseller License " img="/assets/img/users/profile.png" activepage="Admin" mainpage="Reseller License " />
			...
			{
				allocateKeyBox &&
				<AllocateKey id={userId} closeModel={()=>allocateKeyBoxClose()}/>
			}
			{/* alert boxes */}
		</div>
	);
