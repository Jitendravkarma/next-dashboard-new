...
import { SpacebetweenSwiper } from "@/shared/data/pages/landingadata/landingdata";
  ...
  return (
    <div>
            ...
            <div className="flex">
              ...
              <div className="ltr:ml-3 rtl:mr-3">
                <div className="text-sm font-medium">
                  Check Our Latest Projects <Link href="#!" scroll={false} className="font-semibold">here</Link> !
                </div>
              </div>
      ...
      <div className="landing-page-wrapper relative">
            ...
            <div className="header-content justify-between">
              ...
              <div className="header-center">
                <div className="responsive-logo my-auto">
                  <Link className="responsive-logo-light" href="/dashboards/sales" aria-label="Brand"><img
                    src={"../assets/img/brand-logos/desktop-logo.png"} alt="logo" className="mx-auto" /></Link>
                  <Link className="responsive-logo-dark" href="/dashboards/sales" aria-label="Brand"><img
                    src={"../assets/img/brand-logos/desktop-dark.png"} alt="logo" className="mx-auto" /></Link>
                </div>
              </div>
              <div className="header-right ltr:!ml-0 rtl:!mr-0">
                ...
                <div id="headercollapse-heading"
                  className="hs-collapse w-full overflow-hidden transition-[height] duration-300 hidden absolute top-[5.2rem] inset-x-0 p-5 bg-white dark:bg-bgdark"
                  aria-labelledby="headercollapse">
                  <div className="flex space-x-3 rtl:space-x-reverse">
                    <Link href="/authentication/sign-up/basic" className="ti-btn w-[6.375rem] ti-btn-dark !mb-0 !p-2">Sign
                      Up</Link>
                    <Link href="/authentication/sign-in/basic/" className="ti-btn w-[6.375rem] !mb-0 !p-2 ti-btn-primary whitespace-nowrap">Get Started</Link>
                    <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn !mb-0 !p-2 !px-3 ti-btn-secondary"
        ...
        <aside className="app-sidebar sticky-pin" id="sidebar">
            ...
            <div className="main-sidebar">
              ...
              <nav className="main-menu-container nav nav-pills flex-column sub-open">
                <div className="landing-logo-container my-auto hidden lg:block">
                  <div className="responsive-logo">
                    <Link className="responsive-logo-light" href={"/dashboards/sales"} aria-label="Brand"><img
                      src="../assets/img/brand-logos/desktop-logo.png" alt="logo" className="mx-auto" /></Link>
                    <Link className="responsive-logo-dark" href={"/dashboards/sales"} aria-label="Brand"><img
                      src="../assets/img/brand-logos/desktop-light.png" alt="logo" className="mx-auto" /></Link>
                  </div>
                </div>
                ...
                <ul className="main-menu ltr:!ml-auto rtl:!mr-auto">
                  ...
                  <li className="slide">
                    <a href="#services" className="side-menu__item">
                ...
                <div className="lg:flex hidden space-x-2 rtl:space-x-reverse">
                  <Link href={"/authentication/sign-up/basic/"} className="ti-btn w-[6.375rem] ti-btn-dark !my-0 !p-2">Sign
                    Up</Link>
                  <Link href={"/authentication/sign-up/basic/"} className="ti-btn w-[6.375rem] !my-0 !p-2 ti-btn-primary whitespace-nowrap">Get Started</Link>
                  <a aria-label="anchor" href="#;" className="ti-btn !my-0 !p-2 !px-3 ti-btn-secondary"
                    data-hs-overlay="#hs-overlay-switcher"><i className="ri-settings-2-line animate-spin"></i></a>
                </div>
              </nav>
            </div>
          </div>
        </aside><div className="main-content landing-main !p-0" onClick={() => handleClick()}>
              ...
              <div className="grid grid-cols-12 lg:gap-0 gap-6">
                <div className="col-span-12 xxl:col-span-7 my-auto">
                  <div className="landing-content">
                    ...
                    <div className="mt-10 lg:flex justify-start lg:space-x-2 lg:!space-y-0 !space-y-2 rtl:space-x-reverse">
                      <Link href="#!" scroll={false} className="!py-3 !px-3 ti-btn !my-0 ti-btn-secondary">
                        See How it Works <i className="ri-arrow-right-line rtl:rotate-180"></i>
                      </Link>
                      <Link href="#!" scroll={false} className="!py-3 !px-3 ti-btn !my-0 ti-btn-danger">
                ...
                <div className="col-span-12 xxl:col-span-5">
                  <img alt="landing-banner" src={"../assets/img/landing/banner.png"} className="ltr:ml-auto rtl:mr-auto" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="" id="services">
            <div className="section container mx-auto space-y-6">
              <div className="text-center max-w-[80rem] mx-auto mb-12">
                <h2
                  className="justify-center section-title text-center text-3xl font-bold text-gray-800 dark:text-white md:text-4xl">
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                ...
                <div className="my-auto">
                  <div className="space-y-2">
                    <h2
                      className="section-title text-center text-3xl font-bold text-gray-800 dark:text-white md:text-4xl">
                  ...
                  <Link href={"/about-us"} className="py-2 px-3 ti-btn m-0 ti-btn-primary mt-6">
              ...
              <div className="grid lg:grid-cols-2 gap-6">
                <div className="my-auto">
                  <div className="space-y-2">
                    ...
                    <div className="space-y-3">
                      <p className="text-base text-gray-500 dark:text-white/70 mb-3">
                        There are many variations of passages of Lorem Ipsum available, but the majority have suffered
                        alteration in some form, by injected humour, or randomised words which {`don't`} look even slightly
                        believable. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence
                        structures, to generate Lorem Ipsum which looks reasonable.
          ...
          <div
            className="section flex relative  bg-cover before:bg-primary/90 before:absolute before:w-full before:h-full before:top-0 before:inset-x-0"
          >
            <div className="container mx-auto z-[0] text-center">
              <h2 className="section-title text-center text-3xl font-bold text-white md:text-4xl justify-center">We
              ...
              <Link href={"/contact-us/"} className="ti-btn m-0 py-3 px-6 ti-btn-danger">Contact Us</Link>
            </div>
          </div>
                ...
                <div className="box mb-0 border-0 rounded-none shadow-none !bg-transparent">
                  <div className="box-body">
                    ...
                    <div className="flex-grow">
                      ...
                      <Link className="p-0 font-semibold text-primary text-sm flex" href="#!" scroll={false}>
                        Learn More<i
          ...
          <div className="section flex relative bg-cover before:bg-primary/90 before:absolute before:w-full before:h-full before:top-0 before:inset-x-0">
            <div className="container  mx-auto z-[0]">
              <div className="text-center max-w-[80rem] mx-auto mb-12">
                <h2 className="section-title text-center text-3xl font-bold text-white md:text-4xl justify-center">
              ...
              <div className="grid lg:grid-cols-4 gap-0  rounded-sm">
                <div className="">
                  <div className="text-center space-y-3 p-4">
                    <p className="text-4xl text-white mb-0 font-bold"><span className="count-up" data-count="137">
                      <CountUp
                        end={137}
                        start={0}
                        duration={4.94}
              ...
              <div className="grid grid-cols-12 gap-6">
                <div className="col-span-12 xl:col-span-4 my-auto">
                  <div className="space-y-3 my-auto">
                    <h2
                      className="section-title text-center text-3xl font-bold text-gray-800 dark:text-white md:text-4xl mb-2">
                    ...
                    <Link className="ti-btn ti-btn-primary mt-3" href="#!" scroll={false}>Read More<i
              ...
              <div className="grid sm:grid-cols-5 lg:!grid-cols-9 gap-6">
                <div className="space-y-2 text-center">
                  <Link href={"/pages/team/"}>
                    <img src={"../assets/img/users/1.jpg"} alt="team" className="avatar rounded-full" />
                    <div className="">
                ...
                <div className="space-y-2 text-center">
                  <Link href={"/pages/team/"}>
                    <img src={"../assets/img/users/10.jpg"} alt="team" className="avatar rounded-full" />
                    <div className="">
                ...
                <div className="space-y-2 text-center">
                  <Link href={"/pages/team/"}>
                    <img src={"../assets/img/users/2.jpg"} alt="team" className="avatar rounded-full" />
                    <div className="">
                ...
                <div className="space-y-2 text-center">
                  <Link href={"/pages/team/"}>
                    <img src={"../assets/img/users/12.jpg"} alt="team" className="avatar rounded-full" />
                    <div className="">
                ...
                <div className="space-y-2 text-center">
                  <Link href={"/pages/team/"}>
                    <img src={"../assets/img/users/3.jpg"} alt="team" className="avatar rounded-full" />
                    <div className="">
                ...
                <div className="space-y-2 text-center">
                  <Link href={"/pages/team/"}>
                    <img src={"../assets/img/users/4.jpg"} alt="team" className="avatar rounded-full" />
                    <div className="">
                ...
                <div className="space-y-2 text-center">
                  <Link href={"/pages/team/"}>
                    <img src={"../assets/img/users/15.jpg"} alt="team" className="avatar rounded-full" />
                    <div className="">
                ...
                <div className="space-y-2 text-center">
                  <Link href={"/pages/team/"}>
                    <img src={"../assets/img/users/6.jpg"} alt="team" className="avatar rounded-full" />
                    <div className="">
                ...
                <div className="space-y-2 text-center">
                  <Link href={"/pages/team/"}>
                    <img src={"../assets/img/users/7.jpg"} alt="team" className="avatar rounded-full" />
                    <div className="">
              ...
              <div className="grid grid-cols-12 gap-6 max-w-[80rem] mx-auto">
                  ...
                  <div className="box mb-0">
                    <div className="box-body p-0">
                      <div className="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-sm">
                        <img src={"../assets/img/gallery/2.jpg"} className="w-full" alt="blog-img" />
                        <Link href={"/pages/blog/blog-details/"}>
                          <div
                ...
                <div className="col-span-12 lg:col-span-3">
                  <div className="box">
                    <div className="box-body p-0">
                      <div className="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-sm">
                        <img src={"../assets/img/gallery/3.jpg"} className="w-full" alt="blog-img" />
                        <Link href={"/pages/blog/blog-details/"}>
                          <div
                            className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-black/50">
                            <div className="flex justify-start items-end h-full">
                  ...
                  <div className="box mb-0">
                    <div className="box-body p-0">
                      <div className="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-sm">
                        <img src={"../assets/img/gallery/9.jpg"} className="w-full" alt="blog-img" />
                        <Link href={"/pages/blog/blog-details/"}>
                          <div
                            className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-black/50">
                            <div className="flex justify-start items-end h-full">
                ...
                <div className="col-span-12 lg:col-span-3">
                  <div className="box">
                    <div className="box-body p-0">
                      <div className="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-sm">
                        <img src={"../assets/img/gallery/8.jpg"} className="w-full" alt="blog-img" />
                        <Link href={"/pages/blog/blog-details/"}>
                          <div
                            className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-black/50">
                            <div className="flex justify-start items-end h-full">
                  ...
                  <div className="box mb-0">
                    <div className="box-body p-0">
                      <div className="relative overflow-hidden bg-no-repeat bg-cover shadow-lg rounded-sm">
                        <img src={"../assets/img/gallery/10.jpg"} className="w-full" alt="blog-img" />
                        <Link href={"/pages/blog/blog-details/"}>
                          <div
                            className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed bg-black/50">
                            <div className="flex justify-start items-end h-full">
                  ...
                  <div className="p-6">
                    <div className="space-x-3 flex rtl:space-x-reverse items-center">
                      ...
                      <div>
                        ...
                        <Link href="#!" scroll={false} className="text-sm font-normal text-gray-500 dark:text-white/70"> +
                      ...
                      <div className="box-body">
                        <div className="my-auto text-center">
                          <div className="space-y-4 text-start">
                            ...
                            <Link className="ti-btn ti-btn-primary mb-0 w-full" href="#!" scroll={false}>Send Message</Link>
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          <div id="statistics" className="section flex relative bg-cover before:bg-primary/90 before:absolute before:w-full before:h-full before:top-0 before:inset-x-0">
            <div className="container mx-auto z-[0] text-center space-y-5">
              <h2 className="section-title text-center text-3xl font-bold text-white md:text-4xl justify-center">Get
              ...
              <div className="max-w-md space-x-3 rtl:space-x-reverse flex justify-center mx-auto">
                <input type="email" className="ti-form-input me-2" placeholder="Enter Your Email" />
                <Link href="#!" scroll={false} className="ti-btn !m-0 !p-2 !px-5 ti-btn-danger whitespace-nowrap">Notify Me</Link>
              </div>
            </div>
          </div>
          ...
          <footer className="section !pb-0 bg-bgdark">
                ...
                <div className="grid grid-cols-12 gap-6">
                  <div className="col-span-12 lg:col-span-4">
                    <div className="space-y-4 px-4">
                      ...
                      <img src={"../assets/img/brand-logos/desktop-dark.png"} className="w-auto" alt="img" />
                      ...
                      <div className="flex space-x-1 rtl:space-x-reverse">
                        <button aria-label="button" type="button"
                          className="!my-0 !rounded-full !p-2 ti-btn ti-btn-outline !border-0 bg-white/5 dark:bg-white/5 text-gray-400 dark:text-gray-400">
                    ...
                    <div className="grid lg:grid-cols-2 gap-6">
                      <div className="space-y-3 px-4">
                        ...
                        <ul className="space-y-3 text-gray-400 dark:text-gray-400">
                          <li><Link href="#!" scroll={false}>Our Team</Link></li>
                          ...
                          <li><Link href="#!" scroll={false}>Terms and Services</Link></li>
                        </ul>
                      </div>
                      <div className="space-y-3 px-4">
                        <div>
                        ...
                        <ul className="space-y-3 text-gray-400 dark:text-gray-400">
                          <li><Link href="#!" scroll={false}>Email</Link></li>
                          <li><Link href="#!" scroll={false}>Profile</Link></li>
                          <li><Link href="#!" scroll={false}>Timeline</Link></li>
                          <li><Link href="#!" scroll={false}>Projects</Link></li>
                          <li><Link href="#!" scroll={false}>Contacts</Link></li>
                          <li><Link href="#!" scroll={false}>Portfolio</Link></li>
                        </ul>
                      </div>
                    </div>
                  </div>
                  <div className="col-span-12 lg:col-span-4">
                    <div className="space-y-3 px-4">
                      ...
                      <ul className="space-y-3 text-gray-400 dark:text-gray-400">
                        <li> <Link href="#!" scroll={false} className="inline-flex"><i
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
              <p className="text-center text-white">Copyright © <span id="year">2023</span> <Link href="#!" scroll={false}
                className="text-primary"> Synto</Link>. Designed with <span className="ri ri-heart-fill text-red-500"></span> by <Link
                  className="text-primary" href="#!" scroll={false}> Spruko </Link> All rights reserved </p>
            </div>
          </footer>
