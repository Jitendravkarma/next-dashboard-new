...
"use client"
import { listdata } from "@/shared/data/components/cardsdata";
					...
					<div className="box">
						...
						<div className="box-body">
							<div className="max-w-xs flex flex-col">
								<Link className="ti-list-group gap-x-3.5 text-primary ti-icon-link focus:ring-primary dark:border-white/10" href="#!" scroll={false} >
								...
								<Link className="ti-list-group gap-x-3.5 bg-white text-gray-800 hover:text-primary ti-icon-link focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white dark:hover:text-primary" href="#!" scroll={false} >
									<svg className="flex-none" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
								...
								<Link className="ti-list-group gap-x-3.5 text-gray-400 ti-list-group-disabled ti-icon-link focus:ring-primary dark:border-white/10 dark:text-white/70" href="#!" scroll={false} >
									<svg className="flex-none" width="16" height="16" viewBox="0 0 16 16" fill="currentColor">
					...
					<div className="box">
						...
						<div className="box-body">
							<ul className="flex flex-col">
								<li className="ti-list-group"> A simple default list group item </li>
								{listdata.map((idx) => (
									<li className={`ti-list-group bg-${idx.color}/10 text-${idx.color}`} key={Math.random()}>
										{`A simple ${idx.color} list group item`}
									</li>
								))}
					...
					<div className="box">
						...
						<div className="box-body">
							<ul className="flex flex-col">
								<li className="ti-list-group"> A simple default list group item </li>
								{listdata.map((idx) => (
									<li className={`ti-list-group text-white bg-${idx.color} border-${idx.color}`} key={Math.random()}>
										{`A simple ${idx.color} list group item`}
									</li>
								))}
								<li className="ti-list-group bg-gray-100 border border-gray-200 text-gray-600">
								...
								<li className="ti-list-group bg-black border border-white/10 text-white dark:bg-gray-900 dark:text-white">
									A simple dark list group item
								</li>
							</ul>
						</div>
