		...
		<div>
			...
			<div className="grid grid-cols-12 gap-x-6">
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						<div className="box-header">
							<h5 className="box-title">Active content bordered</h5>
						</div>
						<div className="box-body">
							<div className="hs-accordion-group">
								<div className="hs-accordion hs-accordion-active:border-gray-200 bg-white border border-transparent rounded-sm dark:hs-accordion-active:border-white/10 dark:bg-bgdark dark:border-transparent" id="hs-active-bordered-heading-one">
									<button type="button" className="hs-accordion-toggle hs-accordion-active:text-primary inline-flex justify-between items-center gap-x-3 w-full font-semibold text-start text-gray-800 py-4 px-5 hover:text-gray-500 disabled:opacity-50 disabled:pointer-events-none dark:hs-accordion-active:text-primary dark:text-gray-200 dark:hover:text-white/80 dark:focus:outline-none dark:focus:text-gray-400" aria-controls="hs-basic-active-bordered-collapse-one">
										Accordion #1
								...
								<div className="hs-accordion hs-accordion-active:border-gray-200 active bg-white border border-transparent rounded-sm dark:hs-accordion-active:border-white/10 dark:bg-bgdark dark:border-transparent" id="hs-active-bordered-heading-two">
								...
								<div className="hs-accordion hs-accordion-active:border-gray-200 bg-white border border-transparent rounded-sm dark:hs-accordion-active:border-white/10 dark:bg-bgdark dark:border-transparent" id="hs-active-bordered-heading-three">
