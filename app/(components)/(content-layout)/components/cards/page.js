"use client"
import { CardSelect, bgcolor } from "@/shared/data/components/cardsdata";
		...
		<div>
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="xxl:col-span-3 md:col-span-6 col-span-12">
					<div className="box">
						<img src={"../../assets/img/media/1.jpg"} className="box-img-top rounded-t-sm" alt="..." />
						<div className="box-body">
							...
							<Link href="#!" scroll={false} className="ti-btn ti-btn-primary">Read More</Link>
						</div>
				...
				<div className="xxl:col-span-3 md:col-span-6 col-span-12">
					...
					<div className="box">
						...
						<div className="box-footer space-x-4 rtl:space-x-reverse">
							<Link href="#!" scroll={false} className="text-sm text-danger inline-block">Buy Now</Link>
							<Link href="#!" scroll={false} className="text-sm text-success"><u>Review</u></Link>
						</div>
					</div>
				</div>
				<div className="xxl:col-span-3 md:col-span-6 col-span-12">
					<div className="box">
						<img src={"../../assets/img/media/2.jpg"} className="box-img-top rounded-t-sm" alt="..." />
						<div className="box-body">
				...
				<div className="xxl:col-span-3 md:col-span-6 col-span-12">
					<div className="box">
						<img src={"../../assets/img/media/3.jpg"} className="box-img-top rounded-t-sm" alt="..." />
						...
						<div className="box-body space-x-4 rtl:space-x-reverse">
							<Link href="#!" scroll={false} className="text-sm text-primary inline-block">Box link</Link>
							<Link href="#!" scroll={false} className="text-sm text-secondary">Another link</Link>
						</div>
					</div>
				</div>
			</div>
			...
			<div className="grid grid-cols-12 gap-x-6">
				...
				<div className="xxl:col-span-6 col-span-12">
					...
					<div className="grid sm:grid-cols-3 gap-x-6">
						<div className="box">
							<div className="box-body">
								<img src={"../../assets/img/media/4.jpg"} className="rounded-sm mb-4" alt="..." />
								...
								<Link href="#!" scroll={false} className="ti-btn ti-btn-primary">Purchase</Link>
							</div>
						</div>
						<div className="box">
							<div className="box-body">
								<img src={"../../assets/img/media/5.jpg"} className="rounded-sm mb-4" alt="..." />
								<h6 className="text-base box-title font-semibold mb-2">Product B</h6>
								<p className="text-[0.813rem] mb-4">With supporting text below as a natural
									lead-in to additional content.</p>
								<Link href="#!" scroll={false} className="ti-btn ti-btn-secondary">Purchase</Link>
							</div>
						</div>
						<div className="box">
							<div className="box-body">
								<img src={"../../assets/img/media/6.jpg"} className="rounded-sm mb-4" alt="..." />
					...
					<div className="grid grid-cols-12 gap-x-6">
						<div className="xxl:col-span-4 col-span-12">
							<div className="box">
								<div className="box-body">
									<div className="mb-2">
										<img src={"../../assets/img/users/15.jpg"} className="avatar avatar-sm rounded-md" alt="Image Description" />
									</div>
									...
									<Link href="#!" scroll={false} className="ti-btn ti-btn-primary">Go somewhere</Link>
								</div>
							</div>
						</div>
						<div className="xxl:col-span-4 col-span-12">
							<div className="box text-center">
								<div className="box-body">
									<div className="mb-2">
										<img src={"../../assets/img/users/3.jpg"} className="avatar avatar-sm rounded-md" alt="Image Description" />
									</div>
						...
						<div className="xxl:col-span-4 col-span-12">
							<div className="box text-end">
								<div className="box-body">
									<div className="mb-2">
										<img src={"../../assets/img/users/11.jpg"} className="avatar avatar-sm rounded-md" alt="Image Description" />
									</div>
			...
			<div className="grid grid-cols-12 gap-x-6">
						...
						<div className="box-header">
							<div className="flex items-center w-full">
								<div className="ltr:mr-2 rtl:ml-2">
									<img src={"../../assets/img/users/11.jpg"} className="avatar rounded-full" alt="Image Description" />
								</div>
								<div className="">
								...
								<div className="ltr:ml-auto rtl:mr-auto">
									<div className="hs-dropdown ti-dropdown">
										...
										<div className="hs-dropdown-menu ti-dropdown-menu" aria-labelledby="hs-dropdown-custom-icon-trigger1">
											<Link className="ti-dropdown-item" href="#!" scroll={false} >Edit</Link>
											<Link className="ti-dropdown-item" href="#!" scroll={false} >Download</Link>
											<Link className="ti-dropdown-item" href="#!" scroll={false} >Delete</Link>
										</div>
									</div>
								</div>
							</div>
					...
					<div className="box">
						...
						<div className="box-footer">
							<div className="flex items-center">
								<img src={"../../assets/img/users/12.jpg"} className="avatar w-6 h-6 rounded-full ltr:mr-2 rtl:ml-2" alt="Image Description" />
				...
				<div className="xxl:col-span-3 col-span-12">
					<div className="box text-center">
						...
						<div className="box-body pt-1">
							<img src={"../../assets/img/users/5.jpg"} className="avatar avatar-lg rounded-full ltr:mr-2 rtl:ml-2 mb-2" alt="Image Description" />
				...
				<div className="xxl:col-span-2 col-span-12">
					<div className="box">
						<div className="box-body">
							<img src={"../../assets/img/media/7.jpg"} className="rounded-sm mb-4 w-full" alt="..." />
				...
				<div className="xxl:col-span-2 col-span-12">
					<div className="box">
						<div className="box-body">
							<img src={"../../assets/img/media/8.jpg"} className="rounded-sm mb-4 w-full" alt="..." />
				...
				<div className="xxl:col-span-2 col-span-12">
					<div className="box">
						<div className="box-body">
							<img src={"../../assets/img/media/9.jpg"} className="rounded-sm mb-4 w-full" alt="..." />
				...
				<div className="xxl:col-span-3 col-span-12">
					<div className="box text-center">
						...
						<div className="box-body">
							...
							<div className="space-x-2 rtl:space-x-reverse">
								<Link href="#!" scroll={false} className="ti-btn ti-btn-primary mt-2">Read More</Link>
								<Link href="#!" scroll={false} className="ti-btn ti-btn-outline ti-btn-outline-secondary mt-2">Close</Link>
							</div>
						</div>
					...
					<div className="box">
						<div className="box-header">
							<div className="xxxl:flex w-full">
								<img src={"../../assets/img/users/12.jpg"} className="avatar rounded-full ltr:mr-6 rtl:ml-6" alt="Image Description" />
				...
				<div className="xxl:col-span-4 col-span-12">
					<div className="box">
						<div className="box-header flex justify-between">
							...
							<Link aria-label="anchor" className="hs-collapse-toggle inline-flex items-center gap-x-2" href="#!" scroll={false}
					...
					{Show ? (
						<div className="box">
							<div className="box-header flex justify-between">
								...
								<Link aria-label="anchor" href="#!" scroll={false} className="box-remove" onClick={() => setShow(false)}>
				...
				<div className="xxl:col-span-4 col-span-12">
					<div className={`box ${isFullscreen ? "box-fullscreen" : ""}`}>
						<div className="box-header flex justify-between">
							...
							<Link aria-label="anchor" href="#!" scroll={false} className="box-fullscreen" onClick={handleFullscreenClick} ><i className="ri-fullscreen-line"></i> </Link>
						</div>
					...
					<div className="grid grid-cols-12 gap-x-6">
						<div className="xxl:col-span-6 col-span-12">
							<div className="box w-3/4">
								...
								<div className="box-footer">
									<Link href="#!" scroll={false} className="ti-btn ti-btn-primary w-full">Button</Link>
								</div>
							</div>
						</div>
						<div className="xxl:col-span-6 col-span-12">
								...
								<div className=" p-6 dark:bg-black/20 ">
									<div
										...
										<div className="p-4 text-center md:py-7 md:px-5">
											...
											<p className="my-2 text-gray-800 dark:text-white/70">
												With supporting text below as a natural lead-in to additional content.
											</p>
											<Link className="mt-3 ti-btn ti-btn-primary" href="#!" scroll={false} >
												Go somewhere
											</Link>
										</div>
									</div>
									...
									<div className="hidden sm:block">
										<nav
											...
											<Link className="group relative min-w-0 flex-1 bg-white py-4 px-4 border-b-2 border-b-primary text-gray-900 rounded-tl-sm text-sm font-medium text-center overflow-hidden hover:bg-gray-50 focus:z-10 dark:bg-black/20 dark:text-gray-300"
												aria-current="page" href="#!" scroll={false} >
												My Account
											</Link>
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="xxl:col-span-4 col-span-12">
					<div className="box">
						<img src={"../../assets/img/media/10.jpg"} className="box-img-top rounded-t-sm" alt="..." />
						<div className="box-body">
				...
				<div className="xxl:col-span-4 col-span-12">
					<div className="box">
						...
						<img src={"../../assets/img/media/11.jpg"} className="box-img-bottom rounded-b-sm" alt="..." />
					</div>
				</div>
				<div className="xxl:col-span-4 col-span-12">
					<div className="box">
						...
						<img src={"../../assets/img/media/12.jpg"} className="" alt="..." />
						<div className="box-body">
							<p className="text-[0.813rem] mb-0"><small className="text-sm">Last updated 3 mins
								ago</small></p>
						</div>
				...
				<div className="xxl:col-span-4 col-span-12">
					<div className="box">
						...
						<img src={"../../assets/img/media/13.jpg"} className="" alt="..." />
						<div className="box-footer">
							<p className="text-[0.813rem] mb-0"><small className="text-sm">Last updated 3 mins
								ago</small></p>
						</div>
				...
				<div className="xxl:col-span-4 col-span-12">
					<div className="box">
						<img src={"../../assets/img/media/14.jpg"} className="box-img-top rounded-t-sm" alt="..." />
						<div className="box-header">
							<div className="box-title">Image caps are widely used in {`Blog's`}</div>
						</div>
						<div className="box-body">
				...
				<div className="xxl:col-span-4 col-span-12">
					<div className="box">
						...
						<img src={"../../assets/img/media/15.jpg"} className="box-img-bottom rounded-b-sm" alt="..." />
					</div>
				</div>
			</div>
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="xxl:col-span-4 col-span-12">
					<div className="box overlay-box">
						<img src={"../../assets/img/media/16.jpg"} className="box-img" alt="..." />
				...
				<div className="xxl:col-span-4 col-span-12">
					<div className="box overlay-box">
						<img src={"../../assets/img/media/17.jpg"} className="box-img" alt="..." />
				...
				<div className="xxl:col-span-4 col-span-12">
					<div className="box bg-dark overlay-box">
						<img src={"../../assets/img/media/18.jpg"} className="box-img" alt="..." />
						<div className="box-img-overlay flex flex-col p-0">
							<div className="box-header">
								<div className="box-title text-white">
									Image Overlays Are Awesome!
					...
					<div className="box">
						<div className="grid grid-cols-12 gap-0">
							<div className="col-span-12 md:col-span-4">
								<img src={"../../assets/img/media/19.jpg"} className="img-fluid ltr:rounded-l-sm rtl:rounded-r-sm h-full w-full" alt="..." />
							</div>
				...
				<div className="xxl:col-span-4 col-span-12">
					<div className="box">
						<div className="grid grid-cols-12 gap-0">
							...
							<div className="col-span-12 md:col-span-4">
								<img src={"../../assets/img/media/20.jpg"} className="img-fluid ltr:rounded-r-sm rtl:rounded-l-sm h-full w-full" alt="..." />
							</div>
						</div>
					</div>
				</div>
				<div className="xxl:col-span-4 col-span-12">
					<div className="box">
						<div className="grid grid-cols-12 gap-0">
							...
							<div className="col-span-12 md:col-span-4">
								<img src={"../../assets/img/media/21.jpg"} className="img-fluid ltr:rounded-r-sm rtl:rounded-l-sm h-full w-full" alt="..." />
							</div>
						</div>
					</div>
				</div>
			...
			<div className="grid grid-cols-12 gap-x-6">
				{bgcolor.map((idx) => (
					<div className="xxl:col-span-3 col-span-12" key={Math.random()}>
						<div className={`box bg-${idx.color} ${idx.color1}`}>
							<div className="box-body">
								<div className="flex items-center w-full">
									<div className="ltr:mr-2 rtl:ml-2">
										<img src={idx.src} className="avatar rounded-full ring-0" alt="Image Description" />
									</div>
									<div className="">
										<div className="text-base font-semibold">{idx.heading}</div>
										<p className={`mb-0 text-${idx.color1} opacity-70 text-xs`}>{idx.class}</p>
									</div>
									<div className="ltr:ml-auto rtl:mr-auto">
										<div className="hs-dropdown ti-dropdown">
											<button aria-label="button" id="hs-dropdown-custom-icon-trigger11" type="button" className="hs-dropdown-toggle p-0 !bg-transparent border-0 shadow-none focus:ring-0 focus:ring-offset-0  ti-dropdown-toggle">
												<i className={`ri-more-2-line ti-dropdown-icon ${idx.color1}`}></i>
											</button>
					...
					<div className="box border !border-primary">
						<div className="box-body">
							<p className="text-sm font-semibold mb-2 leading-none">Home Page Design
								<Link aria-label="anchor" href="#!" scroll={false} ><i className="ri ri-add-box-line my-auto leading-none ltr:float-right rtl:float-left text-primary text-lg font-normal"></i></Link>
							</p>
							<div className="mb-6 space-x-1 rtl:space-x-reverse">
								<span className="badge m-1 py-1 rounded-md bg-primary/10 text-primary">Framework</span>
								<span className="badge m-1 py-1 rounded-md bg-secondary/10 text-secondary">Angular</span>
								<span className="badge m-1 py-1 rounded-md bg-info/10 text-info">Php</span>
							</div>
					...
					<div className="box border !border-secondary">
						<div className="box-body">
							<p className="text-sm font-semibold mb-2 leading-none">Landing Page Design
								<Link aria-label="anchor" href="#!" scroll={false} ><i className="ri ri-add-box-line my-auto leading-none ltr:float-right rtl:float-left text-secondary text-lg font-normal"></i></Link>
							</p>
							<div className="mb-6 space-x-1 rtl:space-x-reverse">
								<span className="badge m-1 py-1 rounded-md bg-danger/10 text-danger">Laravel</span>
								<span className="badge m-1 py-1 rounded-md bg-teal-500/10 text-teal-500">Codeignitor</span>
								<span className="badge m-1 py-1 rounded-md bg-success/10 text-success">Php</span>
							</div>
							<div className="flex -space-x-2 rtl:space-x-reverse">
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/1.jpg"} alt="Image Description" />
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/4.jpg"} alt="Image Description" />
					...
					<div className="box border !border-warning">
						<div className="box-body">
							<p className="text-sm font-semibold mb-2 leading-none">Update New Project
								<Link aria-label="anchor" href="#!" scroll={false} ><i className="ri ri-add-box-line my-auto leading-none ltr:float-right rtl:float-left text-warning text-lg font-normal"></i></Link>
							</p>
							<div className="mb-6 space-x-1 rtl:space-x-reverse">
								<span className="badge m-1 py-1 rounded-md bg-warning/10 text-warning">Laravel</span>
								<span className="badge m-1 py-1 rounded-md bg-secondary/10 text-secondary">Codeignitor</span>
								<span className="badge m-1 py-1 rounded-md bg-info/10 text-info">Php</span>
							</div>
							<div className="flex -space-x-2 rtl:space-x-reverse">
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/1.jpg"} alt="Image Description" />
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/4.jpg"} alt="Image Description" />
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/12.jpg"} alt="Image Description" />
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/10.jpg"} alt="Image Description" />
							</div>
						</div>
					</div>
				</div>
					...
					<div className="box border !border-info">
						<div className="box-body">
							<p className="text-sm font-semibold mb-2 leading-none">New Project Discussion
								<Link aria-label="anchor" href="#!" scroll={false} ><i className="ri ri-add-box-line my-auto leading-none ltr:float-right rtl:float-left text-info text-lg font-normal"></i></Link>
							</p>
							<div className="mb-6 space-x-1 rtl:space-x-reverse">
								<span className="badge m-1 py-1 rounded-md bg-info/10 text-info">React</span>
								<span className="badge m-1 py-1 rounded-md bg-primary/10 text-primary">Typescript</span>
							</div>
							<div className="flex -space-x-2 rtl:space-x-reverse">
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/1.jpg"} alt="Image Description" />
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/4.jpg"} alt="Image Description" />
					...
					<div className="box border !border-danger">
						<div className="box-body">
							<p className="text-sm font-semibold mb-2 leading-none">Recent Projects Testing
								<Link aria-label="anchor" href="#!" scroll={false} ><i className="ri ri-add-box-line my-auto leading-none ltr:float-right rtl:float-left text-danger text-lg font-normal"></i></Link>
							</p>
							<div className="mb-6 space-x-1 rtl:space-x-reverse">
								<span className="badge m-1 py-1 rounded-md bg-primary/10 text-primary">Ui</span>
								<span className="badge m-1 py-1 rounded-md bg-secondary/10 text-secondary">Angular</span>
								<span className="badge m-1 py-1 rounded-md bg-info/10 text-info">Java</span>
							</div>
							<div className="flex -space-x-2 rtl:space-x-reverse">
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/1.jpg"} alt="Image Description" />
							</div>
					...
					<div className="box border !border-success">
						<div className="box-body">
							<p className="text-sm font-semibold mb-2 leading-none">About Us Page redesign
								<Link aria-label="anchor" href="#!" scroll={false} ><i className="ri ri-add-box-line my-auto leading-none ltr:float-right rtl:float-left text-success text-lg font-normal"></i></Link>
							</p>
							<div className="mb-6 space-x-1 rtl:space-x-reverse">
								<span className="badge m-1 py-1 rounded-md bg-danger/10 text-danger">Html</span>
								<span className="badge m-1 py-1 rounded-md bg-warning/10 text-warning">Symphony</span>
								<span className="badge m-1 py-1 rounded-md bg-success/10 text-success">Php</span>
							</div>
							<div className="flex -space-x-2 rtl:space-x-reverse">
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/6.jpg"} alt="Image Description" />
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/9.jpg"} alt="Image Description" />
							</div>
						</div>
					</div>
				</div>
					...
					<div className="box border border-gray-200 dark:border-white/10">
						<div className="box-body">
							<p className="text-sm font-semibold mb-2 leading-none">New Employees
								<Link aria-label="anchor" href="#!" scroll={false} ><i className="ri ri-add-box-line my-auto leading-none ltr:float-right rtl:float-left dark:text-white text-lg font-normal"></i></Link>
							</p>
							<div className="mb-6 space-x-1 rtl:space-x-reverse">
								<span className="badge m-1 py-1 rounded-md bg-warning/10 text-warning">Html</span>
								<span className="badge m-1 py-1 rounded-md bg-info/10 text-info">Cake Php</span>
								<span className="badge m-1 py-1 rounded-md bg-success/10 text-success">React</span>
							</div>
							<div className="flex -space-x-2 rtl:space-x-reverse">
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/6.jpg"} alt="Image Description" />
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/5.jpg"} alt="Image Description" />
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/9.jpg"} alt="Image Description" />
							</div>
						</div>
					</div>
					...
					<div className="box border border-dark">
						<div className="box-body">
							<p className="text-sm font-semibold mb-2 leading-none">Terminated Employees
								<Link aria-label="anchor" href="#!" scroll={false} ><i className="ri ri-add-box-line my-auto leading-none ltr:float-right rtl:float-left text-dark dark:text-white text-lg font-normal"></i></Link>
							</p>
							<div className="mb-6">
								<span className="badge m-1 py-1 rounded-md bg-primary/10 text-primary">Angular</span>
							</div>
							<div className="flex -space-x-2 rtl:space-x-reverse">
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/6.jpg"} alt="Image Description" />
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/5.jpg"} alt="Image Description" />
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/9.jpg"} alt="Image Description" />
								<img className="avatar avatar-xs rounded-full" src={"../../assets/img/users/15.jpg"} alt="Image Description" />
							</div>
						</div>
					</div>
				</div>
				...
				<div className="col-span-12">
					<div className="grid border rounded-sm shadow-sm divide-y overflow-hidden sm:flex sm:divide-y-0 sm:divide-x dark:border-gray-700 dark:shadow-black/[0.05]">
						<div className="mb-0 box rounded-none border-0 rtl:border-l flex flex-col flex-[1_0_0%]">
							<img className="w-full h-auto rounded-t-sm ltr:sm:rounded-tr-none rtl:sm:rounded-tl-none" src={"../../assets/img/media/22.jpg"} alt="Image Description" />
						...
						<div className="mb-0 box rounded-none border-0 flex flex-col flex-[1_0_0%]">
							<img className="w-full h-auto" src={"../../assets/img/media/23.jpg"} alt="Image Description" />
							<div className="box-body flex-1">
						...
						<div className="mb-0 box rounded-none border-0 rtl:border-l-0 flex flex-col flex-[1_0_0%]">
							<img className="w-full h-auto ltr:sm:rounded-tr-sm rtl:sm:rounded-tl-sm" src={"../../assets/img/media/24.jpg"} alt="Image Description" />
							<div className="box-body flex-1">
			...
			<div className="grid grid-cols-12 gap-x-6">
						...
						<div className="xxl:col-span-5 col-span-12">
							...
							<div className="box border !border-info">
								...
								<div className="box-body">
									<div className="flex items-center">
										<div className="ltr:mr-3 rtl:ml-3">
											<img src={"../../assets/img/users/8.jpg"} className="avatar avatar-lg  rounded-md" alt="Image Description" />
										</div>
										<div>
				...
				<div className="xxl:col-span-3 col-span-12">
					<div className="box">
						<Link aria-label="anchor" href="#!" scroll={false} className="box-anchor"></Link>
						<img src={"../../assets/img/media/25.jpg"} className="box-img-top rounded-t-sm" alt="..." />
						<div className="box-body">
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12">
					<div className="grid md:grid-cols-4 grid-cols-1 gap-x-6">
						<div className="box">
							<img src={"../../assets/img/media/26.jpg"} className="box-img-top rounded-t-sm" alt="..." />
							<div className="box-body">
						...
						<div className="box">
							<img src={"../../assets/img/media/27.jpg"} className="box-img-top rounded-t-sm" alt="..." />
							<div className="box-body">
						...
						<div className="box">
							<img src={"../../assets/img/media/28.jpg"} className="box-img-top rounded-t-sm" alt="..." />
							<div className="box-body">
								<h6 className="text-base box-title font-semibold">Most tropical areas are suitable</h6>
								<p className="text-[0.813rem]"> If you are going to use a passage of Lorem Ipsum, you need to be sure there
									{`isn't`} anything embarrassing hidden in the middle of text.</p>
						...
						<div className="box">
							<img src={"../../assets/img/media/29.jpg"} className="box-img-top rounded-t-sm" alt="..." />
							<div className="box-body">
			...
			<h6 className="text-base mb-4">Panel actions:</h6>
			<div className="grid grid-cols-12 gap-x-6">
						...
						<div className="box-header flex justify-between items-center">
							...
							<div className="flex items-center gap-x-1">
								<div className="hs-tooltip inline-block">
									<button type="button" className="hs-tooltip-toggle size-8 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none dark:text-white/70 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
										<svg className="flex-shrink-0 size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12a9 9 0 1 1-9-9c2.52 0 4.93 1 6.74 2.74L21 8" /><path d="M21 3v5h-5" /></svg>
										<span className="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity inline-block absolute invisible z-10 py-1 px-2 bg-gray-900 text-xs font-medium text-white rounded shadow-sm dark:bg-bodybg" role="tooltip">
											Refresh
										</span>
									</button>
								</div>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="bg-gray-800/[.1] border border-gray-200 text-sm text-gray-800 p-4 dark:bg-bodybg dark:!border-0 dark:text-white">
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box overflow-hidden">
						<div className="box-body h-80 overflow-y-auto [&amp;::-webkit-scrollbar]:w-2 [&amp;::-webkit-scrollbar-thumb]:rounded-full [&amp;::-webkit-scrollbar-track]:bg-gray-100 [&amp;::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&amp;::-webkit-scrollbar-track]:bg-slate-700 dark:[&amp;::-webkit-scrollbar-thumb]:bg-slate-500">
							<h3 className="text-lg font-bold text-gray-800 dark:text-white">
								Card title
							</h3>
							<p className="mt-2 text-gray-500 dark:text-white/70">
