				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							...
							<p className="mt-2">
								<Link className="hs-collapse-toggle inline-flex items-center gap-x-2 text-primary" href="#!" scroll={false} id="hs-show-hide-collapse" data-hs-collapse="#hs-show-hide-collapse-heading">
