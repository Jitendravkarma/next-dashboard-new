"use client"
import { Listings, NFTsalesOverview } from "@/shared/data/dashboard/ntfdata";
						...
						<div className="col-span-12">
							...
							<div className="grid grid-cols-12 gap-x-6">
								<div className="md:!col-span-4 col-span-12">
									<div className="box">
										<img src={"../../assets/img/nft-images/1.png"} className="box-img-top rounded-sm h-[380px]"
											alt="..." />
										<div className="flex align-center justify-between nft-like-section w-full px-4">
											<div className="flex-auto">
												<button type="button"
													className="ti-btn !my-0 ti-btn-success !rounded-full m-0 !px-2 !py-1"
													aria-label="button">
										...
										<div className="box-body nft-auction-time text-white p-4">
											...
											<div className="flex items-center mb-4">
												<div className="ltr:mr-2 rtl:ml-2 leading-none">
													<img src={"../../assets/img/users/10.jpg"} alt=""
											...
											<div className="flex flex-wrap items-center justify-between">
												<div>
													...
													<div className="flex flex-wrap items-center leading-none">
														<img src={"../../assets/img/crypto-currencies/square-color/Bitcoin.svg"}
															alt=""
								...
								<div className="md:!col-span-4 col-span-12">
									<div className="box">
										<img src={"../../assets/img/nft-images/2.png"} className="box-img-top rounded-sm h-[380px]"
											alt="..." />
										<div className="flex align-center justify-between nft-like-section w-full px-4">
											<div className="flex-auto">
												<button type="button"
								...
								<div className="md:!col-span-4 col-span-12">
									<div className="box">
										<img src={"../../assets/img/nft-images/3.png"} className="box-img-top rounded-sm h-[380px]"
											alt="..." />
										<div className="flex align-center justify-between nft-like-section w-full px-4">
											<div className="flex-auto">
												<button type="button"
										...
										<div className="box-body nft-auction-time text-white p-4">
											...
											<div className="flex items-center mb-4">
												<div className="ltr:mr-2 rtl:ml-2 leading-none">
													<img src={"../../assets/img/users/7.jpg"} alt=""
														className="avatar avatar-sm ring-transparent rounded-full" />
												</div>
												<div>
							...
							<div className="box">
								...
								<div className="box-body p-0">
									<ul className="flex flex-col">
										{Listings.map((idx) => (
											<li className="ti-list-group py-4 border-t-0 border-x-0 text-gray-800 dark:text-white dark:border-white/10" key={Math.random()}>
												<Link href="#!" scroll={false} className="w-full">
													<div className="flex items-center justify-between">
														<div className="flex items-center">
															<img src={idx.src} alt="" className="avatar avatar-sm rounded-sm ltr:mr-2 rtl:ml-2 leading-none nft-img" />
															<div>
																<p className="text-sm font-semibold mb-0">{idx.class}</p>
																<span
																	className="text-gray-500 dark:text-white/70 text-xs">{idx.class1}<span
																		className={`ltr:ml-2 rtl:mr-2 inline-flex text-${idx.color} text-xs`}><i
																			className="ri-arrow-up-s-line align-middle ltr:mr-1 rtl:ml-1"></i>{idx.class3}</span></span>
															</div>
														</div>
								...
								<table className="ti-custom-table ti-custom-table-head whitespace-nowrap">
									<tbody>
										...
										<tr>
											<td>
												<div className="flex items-center min-w-[180px]">
													<img src={"../../assets/img/users/15.jpg"} alt=""
														className="avatar avatar-sm rounded-full ltr:mr-2 rtl:ml-2" />
													<div className="items-center">
										...
										<tr>
											<td>
												<div className="flex items-center min-w-[180px]">
													<img src={"../../assets/img/users/12.jpg"} alt=""
														className="avatar avatar-sm rounded-full ltr:mr-2 rtl:ml-2" />
													<div className="items-center">
								...
								<div className="box-body">
									<div className="grid grid-cols-12 gap-2">
										<div className="col-span-6">
											<img src={"../../assets/img/nft-images/4.png"} alt=""
												className="nft-featuredcollect-image" />
										</div>
										<div className="col-span-6">
											<img src={"../../assets/img/nft-images/5.png"} alt=""
												className="nft-featuredcollect-image" />
										</div>
										<div className="col-span-6">
											<img src={"../../assets/img/nft-images/6.png"} alt=""
												className="nft-featuredcollect-image" />
										</div>
										<div className="col-span-6">
											<img src={"../../assets/img/nft-images/7.png"} alt=""
												className="nft-featuredcollect-image" />
										</div>
									</div>
								</div>
									...
									<div className="flex items-center">
										...
										<div
											...
											<div className="hs-dropdown-menu ti-dropdown-menu hidden"
												...
												<Link className="ti-dropdown-item" href="#!" scroll={false} >Action</Link>
												<Link className="ti-dropdown-item" href="#!" scroll={false} >Another
													Action</Link>
												<Link className="ti-dropdown-item" href="#!" scroll={false} >SomBTCing
													else
													here</Link>
											</div>
										</div>
						...
						<SwiperSlide>
							<div className="box">
								<div className="box-body">
									<div className="grid grid-cols-12 gap-2">
										<div className="col-span-6">
											<img src={"../../assets/img/nft-images/8.png"} alt=""
												className="nft-featuredcollect-image" />
										</div>
										<div className="col-span-6">
											<img src={"../../assets/img/nft-images/9.png"} alt=""
												className="nft-featuredcollect-image" />
										</div>
										<div className="col-span-6">
											<img src={"../../assets/img/nft-images/10.png"} alt=""
												className="nft-featuredcollect-image" />
										</div>
										<div className="col-span-6">
											<img src={"../../assets/img/nft-images/11.png"} alt=""
												className="nft-featuredcollect-image" />
										</div>
									</div>
								</div>
								<div className="box-footer">
									<div className="flex items-center">
										<div className="flex items-center flex-auto">
											...
											<div className="ltr:mr-2 rtl:ml-2">
												<p className="mb-0 font-semibold"><Link
													href="#!" scroll={false} >Melissa Smith</Link></p>
							...
							<div className="box">
								<div className="box-body">
									<div className="grid grid-cols-12 gap-2">
										...
										<div className="col-span-6">
											<img src={"../../assets/img/nft-images/15.png"} alt=""
												className="nft-featuredcollect-image" />
										</div>
										<div className="col-span-6">
											<img src={"../../assets/img/nft-images/15.png"} alt=""
										...
										<div className="col-span-6">
											<img src={"../../assets/img/nft-images/14.png"} alt=""
												className="nft-featuredcollect-image" />
										</div>
									</div>
								</div>
						...
						<div className="box overflow-hidden">
							<div className="box-body">
								...
								<div className="flex items-center space-x-2 rtl:space-x-reverse">
									<Link href="#!" scroll={false} className="ti-btn ti-btn-primary m-0"><i
										className="ti ti-wallet text-xl leading-none"></i>Withdraw Money</Link>
									<Link href="#!" scroll={false} className="ti-btn ti-btn-outline-primary m-0"><i
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12">
					<div className="box">
							...
							<div className="flex justify-between">
								...
								<div className="hs-dropdown ti-dropdown block ltr:ml-auto rtl:mr-auto my-auto">
									<button id="hs-dropdown-custom-icon-trigger2" type="button"
										className="hs-dropdown-toggle !px-2 !py-1 !m-0 ti-btn ti-btn-primary">Sort
						...
						<div className="box-body">
							<div className="overflow-auto crypto-table">
								<table className="table-bordered rounded-sm ti-custom-table ti-custom-table-head whitespace-nowrap">
									<thead className="">
										<tr>
									...
									<tbody>
										<tr>
												...
												<div className="flex items-center">
													...
													<div>
														<p className="mb-0 font-semibold text-sm"><Link
															href="#!" scroll={false} title="nft_name">Starter
															Sense NFT</Link></p>
											...
											<td>
												<span className="text-sm text-success"><i
													className="ti ti-trending-up ltr:mr-1 rtl:ml-1 align-middle inline-flex"></i>15.2%</span>
											</td>
											<td><span className="text-sm text-success"><i
												className="ti ti-trending-up ltr:mr-1 rtl:ml-1 align-middle  inline-flex"></i>3.1%</span>
											</td>
											<td>
												<div className="flex items-center">
													<div className="ltr:mr-2 rtl:ml-2 leading-none">
										...
										<tr>
											<td>
												<div className="flex items-center">
													...
													<div>
														<p className="mb-0 font-semibold text-sm"><Link
															href="#!" scroll={false} title="nft_name">Lorem
															Kekkei</Link></p>
														<Link href="javscript:void(0);"
															className="text-xs text-gray-500 dark:text-white/70 font-normal"
											...
											<td>
												<span className="text-sm text-success"><i
													className="ti ti-trending-up ltr:mr-1 rtl:ml-1 align-middle  inline-flex"></i>3.7%</span>
											</td>
											<td><span className="text-sm text-danger"><i
												className="ti ti-trending-down ltr:mr-1 rtl:ml-1 align-middle  inline-flex"></i>0.5%</span>
											</td>
											<td>
												<div className="flex items-center">
													<div className="ltr:mr-2 rtl:ml-2 leading-none">
										...
										<tr>
											<td>
												<div className="flex items-center">
													...
													<div>
														<p className="mb-0 font-semibold text-sm"><Link
															href="#!" scroll={false} title="nft_name"> NFT
															Uchiha</Link></p>
														<Link href="javscript:void(0);"
															className="text-xs text-gray-500 dark:text-white/70 font-normal"
											...
											<td>
												<span className="text-sm text-danger"><i
													className="ti ti-trending-down ltr:mr-1 rtl:ml-1 align-middle  inline-flex"></i>23.1%</span>
											</td>
											<td><span className="text-sm text-success"><i
												className="ti ti-trending-up ltr:mr-1 rtl:ml-1 align-middle  inline-flex"></i>9.12%</span>
											</td>
											<td>
												<div className="flex items-center">
													<div className="ltr:mr-2 rtl:ml-2 leading-none">
										...
										<tr>
											...
											<td>
												<span className="text-sm text-danger"><i
													className="ti ti-trending-down ltr:mr-1 rtl:ml-1 align-middle  inline-flex"></i>5.2%</span>
											</td>
											<td><span className="text-sm text-danger"><i
												className="ti ti-trending-down ltr:mr-1 rtl:ml-1 align-middle  inline-flex"></i>4.1%</span>
											</td>
											<td>
												<div className="flex items-center">
													<div className="ltr:mr-2 rtl:ml-2 leading-none">
										...
										<tr>
											<td>
												<div className="flex items-center">
													...
													<div>
														<p className="mb-0 font-semibold text-sm"><Link
															href="#!" scroll={false} title="nft_name">Ivan
															Shomer Har</Link></p>
														<Link href="javscript:void(0);"
															className="text-xs text-gray-500 dark:text-white/70 font-normal"
											...
											<td>
												<div className="flex items-center">
													...
													<div>
														<p className="mb-0 font-semibold text-sm"><Link
															href="#!" scroll={false} title="nft_name">
															12.52BTC</Link></p>
													</div>
												</div>
											</td>
											<td>
												<span className="text-sm text-success"><i
													className="ti ti-trending-up ltr:mr-1 rtl:ml-1 align-middle  inline-flex"></i>7.0%</span>
											</td>
											<td><span className="text-sm text-success"><i
												className="ti ti-trending-up ltr:mr-1 rtl:ml-1 align-middle  inline-flex"></i>12.5%</span>
											</td>
											<td>
												<div className="flex items-center">
													<div className="ltr:mr-2 rtl:ml-2 leading-none">
