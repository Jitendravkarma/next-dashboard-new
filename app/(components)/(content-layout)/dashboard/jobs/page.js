"use client"
import { AcceptanceRatio, ApplicationsOverview } from "@/shared/data/dashboard/jobsdata";
									...
									<ul>
											...
											<Link href="#!" scroll={false} className="w-full">
												<div className="flex items-center">
													<img className="avatar avatar-sm rounded-full"
														src={"../../assets/img/users/9.jpg"} alt="image" />
										...
										<li className="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white w-full">
											<Link href="#!" scroll={false} className="w-full">
												<div className="flex items-center">
													<img className="avatar avatar-sm rounded-full"
														src={"../../assets/img/users/2.jpg"} alt="image" />
													<div className="flex-auto ltr:ml-2 rtl:mr-2">
														<p
															className="text-sm font-semibold mb-0 text-gray-800 dark:text-white">
															Nasiha</p>
										...
										<li className="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white w-full">
											<Link href="#!" scroll={false} className="w-full">
												<div className="flex items-center">
													<img className="avatar avatar-sm rounded-full"
														src={"../../assets/img/users/4.jpg"} alt="image" />
													<div className="flex-auto ltr:ml-2 rtl:mr-2">
										...
										<li className="p-0 mb-6 ti-list-group border-0 text-gray-800 dark:text-white w-full">
											<Link href="#!" scroll={false} className="w-full">
												<div className="flex items-center">
													<img className="avatar avatar-sm rounded-full"
														src={"../../assets/img/users/14.jpg"} alt="image" />
													<div className="flex-auto ltr:ml-2 rtl:mr-2">
										...
										<li className="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
											<Link href="#!" scroll={false} className="w-full">
												<div className="flex items-center">
													<img className="avatar avatar-sm rounded-full"
														src={"../../assets/img/users/16.jpg"} alt="image" />
													<div className="flex-auto ltr:ml-2 rtl:mr-2">
							...
							<div className="grid grid-cols-2">
								<div className="p-5 ltr:border-r rtl:border-l border-gray-200 dark:border-white/10">
									<div className="flex items-center">
										...
										<div className="flex-1">
											<p className="mb-0 font-semibold text-gray-800 dark:text-white">Accepted</p>
								...
								<div className="p-5">
									<div className="flex items-center">
										...
										<div className="flex-1">
											<p className="mb-0 font-semibold text-gray-800 dark:text-white">Rejected</p>
					...
					<div className="box">
						...
						<div className="box-body p-0">
							<div className="grid md:grid-cols-3  xxl:grid-cols-5">
								...
								<div className="p-4 ltr:md:border-r rtl:md:border-l xxl:border-b-0 border-b border-gray-200 dark:border-white/10">
									<div className="flex items-start mb-6">
										<img src={"../../assets/img/users/21.jpg"} alt=""
											className="avatar avatar-sm rounded-full ltr:mr-2 rtl:ml-2 leading-none" />
										<div className="flex-auto">
											<div className="recent-recruiter">
									...
									<tbody>
										...
										<tr>
											<td>
												<div className="flex items-center">
													<div className="ltr:mr-2 rtl:ml-2 leading-none">
														<img src={"../../assets/img/flags/3.png"} alt=""
															className="avatar avatar-xs rounded-full" />
													</div>
													<div>
														<span className="text-sm font-semibold">
										...
										<tr>
											<td>
												<div className="flex items-center">
													<div className="ltr:mr-2 rtl:ml-2 leading-none">
														<img src={"../../assets/img/flags/2.png"} alt=""
															className="avatar avatar-xs rounded-full" />
													</div>
													<div>
														<span className="text-sm font-semibold">
										...
										<tr>
											<td>
												<div className="flex items-center">
													<div className="ltr:mr-2 rtl:ml-2 leading-none">
														<img src={"../../assets/img/flags/4.png"} alt=""
															className="avatar avatar-xs rounded-full" />
													</div>
													<div>
														<span className="text-sm font-semibold">
							...
							<ul className="">
								<li className="p-0 mb-3 ti-list-group border-0 text-gray-800 dark:text-white w-full">
									<div className="flex items-center w-full">
										<Link aria-label="anchor" href="#!" scroll={false} className="ltr:pr-3 rtl:pl-3">
										...
										<div className="flex-1 flex justify-between items-center relative">
											<div className="flex-1">
												<Link href="#!" scroll={false} className="text-sm font-semibold">Sr. Mobile App Developer</Link>
												...
												<Link href="#!" scroll={false} className="text-xs">1116 Applicants</Link>
											</div>
								...
								<li className="p-0 mb-3 ti-list-group border-0 text-gray-800 dark:text-white w-full">
									<div className="flex items-center w-full">
										...
										<div className="flex-1 flex justify-between items-center relative">
											<div className="flex-1">
												<Link href="#!" scroll={false} className="text-sm font-semibold">Data Scientist Trainee</Link>
												...
												<Link href="#!" scroll={false} className="text-xs">773 Applicants</Link>
											</div>
											<div className="min-w-fit text-end">
								...
								<li className="p-0 mb-3 ti-list-group border-0 text-gray-800 dark:text-white w-full">
									<div className="flex items-center w-full">
										...
										<div className="flex-1 flex justify-between items-center relative">
											<div className="flex-1">
												<Link href="#!" scroll={false} className="text-sm font-semibold">Sr. Backend Developer</Link>
												...
												<Link href="#!" scroll={false} className="text-xs">16 Applicants</Link>
											</div>
											<div className="min-w-fit text-end">
								...
								<li className="p-0 mb-3 ti-list-group border-0 text-gray-800 dark:text-white w-full">
									<div className="flex items-center w-full">
										...
										<div className="flex-1 flex justify-between items-center relative">
											<div className="flex-1">
												<Link href="#!" scroll={false} className="text-sm font-semibold"> Data Visualization Engineer</Link>
												...
												<Link href="#!" scroll={false} className="text-xs">11 Applicants</Link>
											</div>
											<div className="min-w-fit text-end">
								...
								<li className="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
									<div className="flex items-center w-full">
										...
										<div className="flex-1 flex justify-between items-center relative">
											<div className="flex-1">
												<Link href="#!" scroll={false} className="text-sm font-semibold"> Executive Officer</Link>
												...
												<Link href="#!" scroll={false} className="text-xs">15 Applicants</Link>
											</div>
											<div className="min-w-fit text-end">
												<span className="text-xs text-gray-500 dark:text-white/70">
													1 month ago</span>
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12">
					<div className="box orders-table">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-bordered rounded-sm ">
									<thead className="">
										<tr>
									...
									<tbody>
										...
										<tr>
											<td>
												<div className="flex align-items-center font-semibold min-w-[180px]">
													<img src={"../../assets/img/users/11.jpg"}
														className="avatar avatar-xs ltr:mr-2 rtl:ml-2 rounded-full"
														alt="" />
										...
										<tr>
											<td>
												<div className="flex align-items-center font-semibold min-w-[180px]">
													<img src={"../../assets/img/users/8.jpg"}
														className="avatar avatar-xs ltr:mr-2 rtl:ml-2 rounded-full"
														alt="" />
										...
										<tr>
											<td>
												<div className="flex align-items-center font-semibold min-w-[180px]">
													<img src={"../../assets/img/users/16.jpg"}
														className="avatar avatar-xs ltr:mr-2 rtl:ml-2 rounded-full"
														alt="" />
													<span className="my-auto text-sm">Andrew Garfield </span>
												</div>
