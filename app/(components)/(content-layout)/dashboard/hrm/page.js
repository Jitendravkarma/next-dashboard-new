"use client"
import { SalesOverviewHRM, salarydetails } from "@/shared/data/dashboard/hrmdata";
				...
				<div className="col-span-12 md:col-span-6 xxl:col-span-3">
					<div className="box">
						<div className="box-body">
							<div className="flex">
								<div className="ltr:mr-3 rtl:ml-3">
									<div className="avatar rounded-sm text-secondary  p-2.5 bg-secondary/20 "><i
				...
				<div className="col-span-12 md:col-span-6 xxl:col-span-3">
					<div className="box">
						<div className="box-body">
							<div className="flex">
								<div className="ltr:mr-3 rtl:ml-3">
									<div className="avatar rounded-sm text-warning p-2.5 bg-warning/20 "><i
				...
				<div className="col-span-12 md:col-span-6 xxl:col-span-3">
					<div className="box">
						<div className="box-body">
							<div className="flex">
								<div className="ltr:mr-3 rtl:ml-3">
									<div className="avatar rounded-sm text-success p-2.5 bg-success/20 "><i
						...
						<div className="box-header justify-between flex">
							...
							<div>
								<button type="button" aria-label="button"
									className="ti-btn ti-btn-soft-primary !py-1 !m-0">View All</button>
							</div>
						</div>
						<div className="box-body">
					...
					<div className="box">
						...
						<div className="box-body">
							<ul className="list-unstyled mb-0">
								...
								<li className="ti-list-group mb-3 border-0 p-0 w-full">
									<div className="flex border-0">
										<div className="ltr:mr-3 rtl:ml-3">
											<div className="calendar-icon icons">
								...
								<div className="col-span-12  sm:col-span-6 xl:col-span-3 sm:border-b-0 ltr:border-r rtl:border-l border-b border-gray-200 dark:border-white/10">
									<div className="flex flex-wrap p-6 items-center">
										...
										<div className="flex-1 font-semibold">
											...
											<Link href="#!" scroll={false} className="text-gray-500 dark:text-white/70 text-xs flex">Full
								...
								<table className="ti-custom-table ti-custom-table-head whitespace-nowrap">
									...
									<tbody>
										<tr className="">
											...
											<td><span className="whitespace-nowrap inline-block py-1 px-3 rounded-sm text-xs font-medium ms-3 bg-success/10 text-success/80">Present</span></td>
											<td>09:30 Am</td>
											<td>06:30 Pm</td>
											<td className="font-medium space-x-2 rtl:space-x-reverse">
												...
												<div className="hs-tooltip ti-main-tooltip">
													<Link href="#!" scroll={false} className="customer-edit !m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn !rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary">
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse w-full">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/5.jpg"} alt="Image Description" />
													<div className="block w-full my-auto">
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse w-full">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/6.jpg"} alt="Image Description" />
													<div className="block w-full my-auto">
											...
											<td><span className="whitespace-nowrap inline-block py-1 px-3 rounded-sm text-xs font-medium ms-3 bg-danger/10 text-danger/80">Absent</span></td>
											<td>00:00 Am</td>
											<td>00:00 Pm</td>
											<td className="font-medium space-x-2 rtl:space-x-reverse">
												<div className="hs-tooltip ti-main-tooltip">
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse w-full">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/15.jpg"} alt="Image Description" />
													<div className="block w-full my-auto">
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse w-full">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/21.jpg"} alt="Image Description" />
													<div className="block w-full my-auto">
								...
								<table className="ti-custom-table ti-custom-table-head whitespace-nowrap">
									...
									<tbody>
										<tr className="">
											...
											<td>05-04-2023</td>
											<td>08-04-2023</td>
											<td><span className="whitespace-nowrap inline-block py-1 px-3 rounded-sm text-xs font-medium ms-3 bg-success/10 text-success">Approved</span></td>
											<td className="font-medium space-x-2 rtl:space-x-reverse">
												<div className="hs-tooltip ti-main-tooltip">
													<Link href="#!" scroll={false}
										...
										<tr className="">
											...
											<td>20-04-2023</td>
											<td>24-04-2023</td>
											<td><span className="whitespace-nowrap inline-block py-1 px-3 rounded-sm text-xs font-medium ms-3 bg-warning/10 text-warning">Pending</span></td>
											<td className="font-medium space-x-2 rtl:space-x-reverse">
												<div className="hs-tooltip ti-main-tooltip">
													<Link href="#!" scroll={false}
														className="!m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn !rounded-full p-0 transition-none focus:outline-none ti-btn-soft-primary">
										...
										<tr className="">
											...
											<td>05-04-2023</td>
											<td>06-04-2023</td>
											<td><span className="whitespace-nowrap inline-block py-1 px-3 rounded-sm text-xs font-medium ms-3 bg-danger/10 text-danger">Rejected</span></td>
											<td className="font-medium space-x-2 rtl:space-x-reverse">
												<div className="hs-tooltip ti-main-tooltip">
													<Link href="#!" scroll={false}
														className="!m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn !rounded-full p-0 transition-none focus:outline-none ti-btn-soft-primary">
										...
										<tr className="">
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse w-full">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/8.jpg"} alt="Image Description" />
													<div className="block w-full my-auto">
										...
										<tr className="">
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse w-full">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/16.jpg"} alt="Image Description" />
													<div className="block w-full my-auto">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head whitespace-nowrap table-bordered rounded-sm ti-custom-table-head ">
									...
									<tbody className="">
										{salarydetails.map((idx) => (
											<tr key={Math.random()}>
												<td>{idx.id}</td>
												<td>
													<div className="flex space-x-3 rtl:space-x-reverse w-full min-w-[200px]">
														<img className="avatar avatar-sm rounded-sm" src={idx.src} alt="Image Description" />
														<div className="block w-full my-auto">
															<span className="block text-sm font-semibold text-gray-800 dark:text-gray-300 max-w-[180px] truncate">{idx.class}</span>
															<span className="block text-xs text-gray-400 dark:text-white/80 !font-normal">{idx.mail}</span>
														</div>
													</div>
												</td>
												<td><span>{idx.department}</span></td>
												<td><span>{idx.design}</span></td>
												<td><span>{idx.salary}</span></td>
												<td><span>{idx.leaves}</span></td>
												<td><span>{idx.net}</span></td>
												<td><span className={`whitespace-nowrap inline-block py-1 px-3 rounded-sm text-xs font-medium ms-3 bg-${idx.color}/10 text-${idx.color}`}>{idx.status}</span></td>
												<td className="font-medium space-x-2 rtl:space-x-reverse">
													<div className="hs-tooltip ti-main-tooltip">
														<Link href="#!" scroll={false}
															className="!m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn !rounded-full p-0 transition-none focus:outline-none ti-btn-soft-primary">
