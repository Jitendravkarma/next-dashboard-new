"use client"
import { LeadsBySource, Revenue, leadsreport } from "@/shared/data/dashboard/analyticdata";
		...
		<div>
			...
			<div className="grid grid-cols-12 gap-x-5">
				<div className="col-span-12 xxl:col-span-9">
					<div className="grid grid-cols-12 gap-x-5">
						<div className="col-span-12 xl:col-span-4 md:col-span-12">
							<div className="box">
								...
								<div className="box-body">
									<ul className="flex flex-col">
										<li className="px-0 pt-0 ti-list-group border-0 text-gray-800 dark:text-white">
											<Link href="#!" scroll={false} className="flex  justify-between items-center w-full">
										...
										<li className="px-0 pt-2 pb-0 ti-list-group border-0 text-gray-800 dark:text-white">
											<Link href="#!" scroll={false} className="flex  justify-between items-center w-full">
												<div className="flex space-x-3 rtl:space-x-reverse w-full">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/10.jpg"} alt="Image Description" />
													<div className="flex w-full">
														<div className="block my-auto">
															<p className="block text-sm font-semibold text-gray-800 hover:text-gray-900 my-auto  dark:text-white dark:hover:text-gray-200">
																Charlie Davieson</p>
								...
								<li className="crm-recent-activity-content">
									<div className="flex items-top">
										...
										<div className="crm-timeline-content">
											<span className="font-semibold">Update of calendar events &amp;</span><span><Link href="#!" scroll={false} className="text-primary font-semibold"> Added new events in next week.</Link></span>
										</div>
								...
								<table className="ti-custom-table ti-custom-table-head">
									...
									<tbody>
										...
										<tr>
											<td className="leading-none !text-gray-800 dark:!text-white">
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/logos/1.png"} alt="Image Description" />
													<div className="block my-auto">
										...
										<tr>
											<td className="leading-none !text-gray-800 dark:!text-white">
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/13.jpg"} alt="Image Description" />
													<div className="block my-auto">
										...
										<tr>
											<td className="leading-none !text-gray-800 dark:!text-white">
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/logos/8.png"} alt="Image Description" />
													<div className="block my-auto">
					...
					<div className="box">
											...
											<tr className="" key={Math.random()}>
												...
												<td>
													<div className="flex space-x-3 rtl:space-x-reverse text-start min-w-[200px]">
														...
														<div className="block my-auto">
															<p className="block text-sm font-semibold my-auto text-gray-800 dark:text-white">{idx.class}</p>
															<span className="block text-xs text-gray-400 dark:text-white/80 !font-normal my-auto">{idx.mail}</span>
														</div>
													</div>
												</td>
												<td>{idx.phone}</td>
												...
												<td>
													<div className="inline-flex items-center">
														...
														<span className="ltr:ml-1 rtl:mr-1">{idx.location}</span>
													</div>
												</td>
												<td>{idx.date}</td>
												<td><span className={`truncate whitespace-nowrap inline-block py-1 px-3 rounded-full text-xs font-medium bg-${idx.color}/10 text-${idx.color}/80`}>{idx.status}</span>
												</td>
						...
						<div className="box-footer">
							<div className="sm:flex items-center">
								<div className="">
									showing 10 Entries <i className="ri-arrow-right-line ml-2 font-semibold"></i>
								</div>
