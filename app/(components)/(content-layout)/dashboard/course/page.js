"use client"
import { EarningReport, Instructors, students } from "@/shared/data/dashboard/analyticdata";
				...
				<div className="col-span-12 md:col-span-6 xxl:col-span-3">
					<div className="box">
						<div className="box-body relative">
							<Link aria-label="anchor" href="#!" scroll={false} className="absolute w-full h-full inset-0"></Link>
							<div className="flex items-center">
								<Link aria-label="anchor" href="#!" scroll={false} className="ltr:pr-4 rtl:pl-4 block">
								...
								<div className="flex-1  font-medium">
									<h4 className="text-2xl text-gray-800 dark:text-white font-medium">$98,450</h4>
									<div className="flex justify-between items-center">
										<span className="text-gray-500 dark:text-white/70 text-xs">YTD Earning</span>
										<span className="text-success text-xs"><i
											className="ti ti-trending-up text-base ltr:mr-1 rtl:ml-1  inline-flex"></i>+2.02%</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div className="box">
						<div className="box-body relative">
							...
							<div className="flex items-center">
								...
								<div className="flex-1 font-medium">
									<h4 className="text-2xl text-gray-800 dark:text-white font-medium">15,379</h4>
									<div className="flex justify-between items-center">
										<span className="text-gray-500 dark:text-white/70 text-xs">Total Students</span>
										<span className="text-danger text-xs"><i
											className="ti ti-trending-down text-base ltr:mr-1 rtl:ml-1  inline-flex"></i>+2.02%</span>
									</div>
								</div>
							</div>
						</div>
					...
					<div className="box">
						<div className="box-body relative">
							...
							<div className="flex items-center">
								...
								<div className="flex-1 font-medium">
									<h4 className="text-2xl text-gray-800 dark:text-white font-medium">377</h4>
									<div className="flex justify-between items-center">
					...
					<div className="box">
						<div className="box-body relative">
							...
							<div className="flex items-center">
								...
								<div className="flex-1 font-medium">
									<h4 className="text-2xl text-gray-800 dark:text-white font-medium">11,016</h4>
									<div className="flex justify-between items-center">
												...
												<td className="!p-[0.65rem]" >
													<div className="flex items-center min-w-[200px]">
														...
														<div className="items-center">
															<p className="text-sm mb-0 text-gray-800 dark:text-white">{idx.class}</p>
															<span className="text-xs text-gray-500 dark:text-white/70">{idx.mail}</span>
														</div>
													</div>
												</td>
												<td className="!p-[0.65rem] text-center">{idx.course}</td>
												<td className="!p-[0.65rem] text-center">{idx.complete}</td>
			...
			<div className="grid grid-cols-12 gap-x-5">
				<div className="col-span-12 xxl:col-span-3">
					<div className="box">
						...
						<div className="box-body">
							<ul className="flex flex-col instructors-list">
								{Instructors.map((idx) => (
									<li className={`p-0 ${idx.class1} ti-list-group border-0 text-gray-800 dark:text-white`} key={Math.random()}>
										<Link href="#!" scroll={false} className="w-full">
											<div className="flex items-center">
												<div className="leading-none flex-none">
													<img className="avatar avatar-sm rounded-full" src={idx.src} alt="image" />
												</div>
												<div className="flex-auto ltr:ml-2 rtl:mr-2">
													<p className="text-sm font-semibold mb-0">{idx.class}</p>
													<p className="text-xs text-gray-500 dark:text-white/70 mb-0 !font-normal">{idx.course}</p>
												</div>
												<div className="block text-end">
													<span className="text-sm text-gray-800 dark:text-white font-semibold">{idx.data}</span>
													<p className="text-xs text-gray-500 dark:text-white/70 !font-normal">{idx.data1}</p>
												</div>
											</div>
										</Link>
									</li>
							...
							<ul className="flex flex-col">
								<li className="mb-6 !rounded-sm ti-list-group text-gray-800 dark:text-white w-full">
									<div className="sm:flex items-center w-full">
										<Link href="#!" scroll={false} className="ltr:pr-4 rtl:pl-4 inline-block">
											<img src={"../../assets/img/media/1.jpg"} alt="img" className="avatar w-28 h-28 rounded-sm" />
										</Link>
										<div className="mt-4 sm:mt-0 flex-1 font-semibold">
											...
											<Link href="#!" scroll={false} className="block mb-3 text-sm font-semibold">CSS Zero to Hero
											...
											<div className="sm:flex justify-between items-center">
												<div className="flex items-center" title="Instructor">
													<Link href="#!" scroll={false} className="ltr:pr-2 rtl:pl-2">
														<img src={"../../assets/img/users/3.jpg"} alt="img" className="avatar avatar-xs rounded-full" />
													</Link>
													<Link href="#!" scroll={false} className="flex-1 text-gray-500 dark:text-white/70">Natasha
														Sil</Link>
												</div>
								...
								<li className="mb-6 !rounded-sm ti-list-group text-gray-800 dark:text-white w-full">
									<div className="sm:flex items-center w-full">
										<Link href="#!" scroll={false} className="ltr:pr-4 rtl:pl-4 inline-block">
											<img src={"../../assets/img/media/4.jpg"} alt="img" className="avatar w-28 h-28 rounded-sm" />
										</Link>
										<div className="mt-4 sm:mt-0 flex-1 font-semibold">
											<Link href="#!" scroll={false}
												className="text-gray-500 dark:text-white/70 block mb-1 font-medium text-xs" title="Category"><i
													className="ri-price-tag-3-line text-xs"></i>&nbsp; Marketing</Link>
											<Link href="#!" scroll={false} className="block mb-3 text-sm font-semibold">Marketing Class-27: What
												Is Marketing? How Marketing Helpful To Business? Basic Introduction To Marketing.</Link>
											<div className="sm:flex justify-between items-center">
												<div className="flex items-center" title="Instructor">
													<Link href="#!" scroll={false} className="ltr:pr-2 rtl:pl-2">
														<img src={"../../assets/img/users/4.jpg"} alt="img" className="avatar avatar-xs rounded-full" />
													</Link>
													<Link href="#!" scroll={false} className="flex-1 text-gray-500 dark:text-white/70">Mosh Nah</Link>
												</div>
												<div className="min-w-fit text-xs text-gray-500 dark:text-white/70 inline-flex">
								...
								<li className="mb-0 !rounded-sm ti-list-group text-gray-800 dark:text-white w-full">
									<div className="sm:flex items-center w-full">
										<Link href="#!" scroll={false} className="ltr:pr-4 rtl:pl-4 inline-block">
											<img src={"../../assets/img/media/23.jpg"} alt="img" className="avatar w-28 h-28 rounded-sm" />
										</Link>
										<div className="mt-4 sm:mt-0 flex-1 font-semibold">
											<Link href="#!" scroll={false}
												className="text-gray-500 dark:text-white/70 block mb-1 font-medium text-xs" title="Category"><i
													className="ri-price-tag-3-line text-xs"></i>&nbsp; Programming</Link>
											<Link href="#!" scroll={false} className="block mb-3 text-sm font-semibold">Learn Python-16: What Is
												The Difference Between Shallow Copy and Deep Copy? Implementing Deep Copy In Python.</Link>
											<div className="sm:flex justify-between items-center">
												<div className="flex items-center" title="Instructor">
													<Link href="#!" scroll={false} className="ltr:pr-2 rtl:pl-2">
														<img src={"../../assets/img/users/12.jpg"} alt="img" className="avatar avatar-xs rounded-full" />
													</Link>
													<Link href="#!" scroll={false} className="flex-1 text-gray-500 dark:text-white/70">Telsko
														Navin</Link>
												</div>
												<div className="min-w-fit text-xs text-gray-500 dark:text-white/70 inline-flex">
								...
								<table className="ti-custom-table ti-custom-table-head whitespace-nowrap table-bordered rounded-sm ti-custom-table-head">
									...
									<tbody className="">
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/media/1.jpg"} alt="Image Description" />
											...
											<td className="font-medium space-x-2 rtl:space-x-reverse">
												...
												<div className="hs-tooltip ti-main-tooltip">
													<Link href="#!" scroll={false} className="m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn !rounded-full p-0 transition-none focus:outline-none ti-btn-soft-secondary">
														<i className="ti ti-pencil"></i>
														<span className="hs-tooltip-content ti-main-tooltip-content py-1 px-2 bg-gray-900 text-xs font-medium text-white shadow-sm dark:bg-slate-700 hidden style1" role="tooltip" data-popper-placement="top">
															Edit
														</span>
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/media/4.jpg"} alt="Image Description" />
													<div className="block my-auto">
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/media/10.jpg"} alt="Image Description" />
													<div className="block my-auto">
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/media/15.jpg"} alt="Image Description" />
													<div className="block my-auto">
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/media/23.jpg"} alt="Image Description" />
													<div className="block my-auto">
