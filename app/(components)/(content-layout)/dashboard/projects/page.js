"use client"
import { ProjectAnalysis } from "@/shared/data/dashboard/projectsdata";
				...
				<div className="col-span-12">
					<div className="grid grid-cols-12 gap-x-6">
						<div className="col-span-12 xxl:col-span-3">
							<div className="grid grid-cols-12 gap-x-6">
								<div className="col-span-12 xxl:!col-span-12 md:!col-span-4">
									<div className="box">
										...
										<div className="box-body">
											<div className="flex flex-wrap">
												<div className="flex-1">
													...
													<p className="mb-0 text-xs"><span
														className="badge bg-success/20 text-success py-1 rounded-full font-semibold ltr:mr-1 rtl:ml-1 !mb-0">1.25%</span><span
															className="tx-muted font-semibold text-gray-500 dark:text-white/70">Since Last Month</span></p>
												</div>
												<div className="min-w-fit ltr:ml-2 rtl:mr-2">
										...
										<div className="box-body">
											<div className="flex flex-wrap">
												<div className="flex-1">
													...
													<p className="mb-0 text-xs"><span
														className="badge bg-danger/20 text-danger py-1 rounded-full font-semibold ltr:mr-1 rtl:ml-1 !mb-0">2.23%</span><span
															className="tx-muted font-semibold text-gray-500 dark:text-white/70">Since Last Month</span></p>
												</div>
												<div className="min-w-fit ltr:ml-2 rtl:mr-2">
						...
						<div className="col-span-12 xxl:col-span-3">
							<div className="box projects-tracking-card overflow-hidden text-center">
								<div className="box-body text-center">
									<img src={"../../assets/img/png-images/15.png"} alt="Project-img" className="h-40 w-40 mx-auto" />
									<div>
									...
									<div className="flex mb-5 relative">
										<div className="flex-1">
											...
											<p className="mb-0 font-semibold">
												<span className="opacity-50 ltr:mr-1 rtl:ml-1 inline-flex">Tasks:</span>
										...
										<Link aria-label="anchor" href="#!" scroll={false} className="absolute h-full w-full top-0 left-0"></Link>
									</div>
									<div className="flex justify-between items-center">
										<div className="flex -space-x-2 rtl:space-x-reverse">
											<img className="inline-block avatar avatar-xs rounded-full ring-0" src={"../../assets/img/users/8.jpg"}
												alt="Image Description" />
											<img className="inline-block avatar avatar-xs rounded-full ring-0" src={"../../assets/img/users/4.jpg"}
												alt="Image Description" />
											<img className="inline-block avatar avatar-xs rounded-full ring-0" src={"../../assets/img/users/6.jpg"}
												alt="Image Description" />
											<img className="inline-block avatar avatar-xs rounded-full ring-0" src={"../../assets/img/users/7.jpg"}
												alt="Image Description" />
											<span
										...
										<div className="ltr:ml-1 rtl:mr-1 min-w-fit inline-flex">
											<Link href="#!" scroll={false} className="ltr:mr-2 rtl:ml-2 opacity-60 text-sm text-white  inline-flex"><i
												className="ri-attachment-2 ltr:mr-1 rtl:ml-1 text-sm "></i>3</Link>
											<Link href="#!" scroll={false} className="opacity-60 text-sm text-white  inline-flex"><i
				...
				<div className="xxl:col-span-5 col-span-12 ">
					<div className="box">
						<div className="box-header flex">
							...
							<button aria-label="button" type="button" className="ti-btn ti-btn-soft-primary !py-1 !ms-auto">View All</button>
						</div>
								...
								<table className="ti-custom-table ti-custom-table-head">
									...
									<tbody>
										<tr>
											<td className="leading-none !text-gray-800 dark:!text-white !p-[0.75rem]">
												<div className="flex">
													<div className="ltr:mr-3 rtl:ml-3">
														<span className="avatar avatar-sm"><img src={"../../assets/img/users/2.jpg"} alt="img" className="rounded-full" /></span>
													</div>
													<div className="flex-1">
											...
											<td className="!p-[0.75rem]">31h<span className="ltr:ml-2 rtl:mr-2 text-gray-500 dark:text-white/70 opacity-50 inline-flex">/ 36h</span></td>
										...
										<tr>
											<td className="leading-none !text-gray-800 dark:!text-white !p-[0.75rem]">
												<div className="flex">
													<div className="ltr:mr-3 rtl:ml-3">
														<span className="avatar avatar-sm"><img src={"../../assets/img/users/21.jpg"} alt="img" className="rounded-full" /></span>
													</div>
													<div className="flex-1">
											...
											<td className="!p-[0.75rem]">11h<span className="ltr:ml-2 rtl:mr-2 text-gray-500 dark:text-white/70 opacity-50 inline-flex">/ 20h</span></td>
											<td className="!p-[0.75rem]">
										...
										<tr>
											<td className="leading-none !text-gray-800 dark:!text-white !p-[0.75rem]">
												<div className="flex">
													<div className="ltr:mr-3 rtl:ml-3">
														<span className="avatar avatar-sm"><img src={"../../assets/img/users/3.jpg"} alt="img" className="rounded-full" /></span>
													</div>
													<div className="flex-1">
											...
											<td className="!p-[0.75rem]">20h<span className="ltr:ml-2 rtl:mr-2 text-gray-500 dark:text-white/70 opacity-50 inline-flex">/ 22h</span></td>
											<td className="!p-[0.75rem]">
										...
										<tr>
											...
											<td className="!p-[0.75rem]">83h<span className="ltr:ml-2 rtl:mr-2 text-gray-500 dark:text-white/70 opacity-50 inline-flex">/ 83h</span></td>
											<td className="!p-[0.75rem]">
										...
										<tr>
											<td className="leading-none !text-gray-800 dark:!text-white !p-[0.75rem]">
												<div className="flex">
													<div className="ltr:mr-3 rtl:ml-3">
														<span className="avatar avatar-sm"><img src={"../../assets/img/users/4.jpg"} alt="img" className="rounded-full" /></span>
													</div>
													<div className="flex-1">
											...
											<td className="!p-[0.75rem]">51h<span className="ltr:ml-2 rtl:mr-2 text-gray-500 dark:text-white/70 opacity-50 inline-flex">/ 62h</span></td>
											<td className="!p-[0.75rem]">
				...
				<div className="xxl:col-span-4 col-span-12">
					<div className="box">
						<div className="box-header justify-between flex">
							...
							<div>
								<button aria-label="button" type="button" className="ti-btn ti-btn-soft-primary !py-1 !m-0">View All</button>
							</div>
						</div>
						<div className="box-body">
							<div className="overflow-auto">
										...
										<ul className="list-unstyled mb-0 upcoming-events-list">
											<li className="ti-list-group border-0 p-0 w-full">
												<div className="sm:flex justify-between w-full">
													...
													<div>
														<span className="text-gray-500 dark:text-white/70 inline-flex"><i className="ri-time-line align-middle ltr:mr-1 rtl:ml-1"></i>9:00am - 10:00am</span>
													</div>
												</div>
											</li>
											<li className="ti-list-group border-0 p-0 w-full">
												<div className="sm:flex justify-between w-full">
													...
													<div>
														<span className="text-gray-500 dark:text-white/70  inline-flex"><i className="ri-time-line align-middle ltr:mr-1 rtl:ml-1"></i>12:00pm - 12:45am</span>
													</div>
												</div>
											</li>
											<li className="ti-list-group border-0 p-0 w-full">
												<div className="sm:flex justify-between w-full">
													...
													<div>
														<span className="text-gray-500 dark:text-white/70  inline-flex"><i className="ri-time-line align-middle ltr:mr-1 rtl:ml-1"></i>4:00pm - 5:30pm</span>
													</div>
												</div>
											</li>
											<li className="ti-list-group border-0 p-0 w-full">
												<div className="sm:flex justify-between w-full">
													...
													<div>
														<span className="text-gray-500 dark:text-white/70  inline-flex"><i className="ri-time-line align-middle ltr:mr-1 rtl:ml-1"></i>5:00pm - 5:45pm</span>
													</div>
												</div>
											</li>
										</ul>
										...
										<div className="flex-1">
											...
											<div className="flex items-center justify-between">
												<div className="flex -space-x-2 rtl:space-x-reverse">
													...
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/6.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/7.jpg"} alt="Image Description" />
												</div>
									...
									<tbody className="">
										...
										<tr className="">
											...
											<td>
												<div className="flex -space-x-2 rtl:space-x-reverse">
													...
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/6.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/7.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/19.jpg"} alt="Image Description" />
												</div>
											</td>
										...
										<tr className="">
											...
											<td>
												<div className="flex -space-x-2 rtl:space-x-reverse">
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/8.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/4.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/16.jpg"} alt="Image Description" />
												</div>
											</td>
										...
										<tr className="">
											...
											<td>
												<div className="flex -space-x-2 rtl:space-x-reverse">
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/8.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/14.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/4.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/16.jpg"} alt="Image Description" />
													<span className="inline-flex items-center justify-center avatar w-6 h-6  rounded-full bg-gray-100 border-2 border-gray-200 dark:bg-black/20 dark:border-white/10">
										...
										<tr className="">
											...
											<td>
												<div className="flex -space-x-2 rtl:space-x-reverse">
													...
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/14.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/16.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/3.jpg"} alt="Image Description" />
												</div>
											</td>
							...
							<div className="flex items-center">
								...
								<div className="ltr:ml-auto rtl:mr-auto">
									<nav className="flex justify-center items-center space-x-2 rtl:space-x-reverse">
										<Link className="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex Linktems-center gap-2 rounded-sm" href="#!" scroll={false} >
										...
										<Link className="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center tLinkxt-sm font-medium rounded-sm" href="#!" scroll={false} >2</Link>
										<Link className="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center tLinkxt-sm font-medium rounded-sm" href="#!" scroll={false} >3</Link>
										<Link className="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex Linktems-center gap-2 rounded-sm" href="#!" scroll={false} >
