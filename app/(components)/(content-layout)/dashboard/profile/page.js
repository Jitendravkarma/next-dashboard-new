...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    contactItem.forEach((ele => {
      ele.addEventListener("click", () => {
        setClassName1("main-content-body-show");
      });
    }));
                    ...
                    <div className="box-body">
                      ...
                      <div className="my-4">
                        ...
                        <div className="space-y-2" id="skills">
                          ...
                          <TagsInput
                            //  className="badge bg-gray-100 border dark:bg-black/20 dark:text-white text-gray-800" 
                            value={selected} onChange={setSelected} name="ProductTag" placeHolder="Filter product" />
                        </div>
                      </div>
                      ...
                      <div className="my-4">
                        <div className="grid lg:grid-cols-3 gap-6">
                          ...
                          <div className="space-y-2">
                            ...
                            <DatePicker className="ti-form-input focus:z-10" showIcon selected={startDate1} onChange={(date) => setStartDate1(date)} placeholderText='choose Date' />
                          </div>
                          <div className="space-y-2">
                          ...
                          <div className="space-y-2">
                            <label className="ti-form-label mb-0">Joining Date</label>
                            <DatePicker className="ti-form-input focus:z-10" showIcon selected={startDate2} onChange={(date) => setStartDate2(date)} placeholderText='choose Date' />
                          </div>
                          <div className="space-y-2">
                            <label className="ti-form-label mb-0">Completed Date</label>
                            <DatePicker className="ti-form-input focus:z-10" showIcon selected={startDate3} onChange={(date) => setStartDate3(date)} placeholderText='choose Date' />
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="my-4">
                        <div className="grid lg:grid-cols-4 gap-6">
                          ...
                          <div className="space-y-2">
                            <label className="ti-form-label mb-0">Joining Date</label>
                            <DatePicker className="ti-form-input focus:z-10" showIcon selected={startDate4} onChange={(date) => setStartDate4(date)} placeholderText='choose Date' />
                          </div>
                          <div className="space-y-2">
                            <label className="ti-form-label mb-0">Completed Date</label>
                            <DatePicker className="ti-form-input focus:z-10" showIcon selected={startDate5} onChange={(date) => setStartDate5(date)} placeholderText='choose Date' />
                          </div>
                          <div className="space-y-2">
                          ...
                          <div className="space-y-2">
                            <label className="ti-form-label mb-0">Joining Date</label>
                            <DatePicker className="ti-form-input focus:z-10" showIcon selected={startDate6} onChange={(date) => setStartDate6(date)} placeholderText='choose Date' />
                          </div>
                          <div className="space-y-2">
                            <label className="ti-form-label mb-0">Completed Date</label>
                            <DatePicker className="ti-form-input focus:z-10" showIcon selected={startDate7} onChange={(date) => setStartDate7(date)} placeholderText='choose Date' />
                          </div>
                        </div>
                      </div>
                    </div>
                          ...
                          <div className="box border-0 shadow-none">
                            <div className="box-header">
                              <div className="sm:flex justify-between">
                                ...
                                <button type="button" className="py-1 px-3 ti-btn ti-btn-primary text-sm ms-auto">Log out From All Devices </button>
                              </div>
                            </div>
                            <div className="box-body">
                      ...
                      <div className="sm:grid grid-cols-12 gap-6 space-y-6">
                        <div className="col-span-2 my-auto">
                          <label className="ti-form-label mb-0">Verfication Step - 2
                            <Link aria-label="anchor" className="ltr:ml-2 rtl:mr-2" href="#!" scroll={false} >
                        ...
                        <div className="col-span-10">
                          <div className="flex items-center">
                            <input type="checkbox" className="ti-switch shrink-0 w-11 h-6 before:w-5 before:h-5 sm:ltr:float-right sm:rtl:float-left m-0 " />
                          </div>
                        </div>
                      </div>
                      <div className="my-5">
                              ...
                              <div className="space-y-2">
                                <div className="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  ...
                                  <div className="col-span-3 my-auto">
                                    <input type="checkbox" className="ti-switch shrink-0 w-11 h-6 before:w-5 before:h-5 sm:ltr:float-right sm:rtl:float-left " defaultChecked />
                                  </div>
                                </div>
                                <div className="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  <div className="col-span-9 my-auto">
                                  ...
                                  <div className="col-span-3 my-auto">
                                    <input type="checkbox" className="ti-switch shrink-0 w-11 h-6 before:w-5 before:h-5 sm:ltr:float-right sm:rtl:float-left" />
                                  </div>
                                </div>
                                <div className="sm:grid grid-cols-12 gap-6 space-y-4 md:text-end">
                                  <div className="col-span-9 my-auto">
