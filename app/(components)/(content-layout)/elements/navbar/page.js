			...
			<div className="grid grid-cols-12 gap-x-5">
				...
				<div className="col-span-12">
					<div className="box">
						...
						<div className="box-body">
							<header
								className="relative flex flex-wrap md:justify-start md:flex-nowrap z-40 w-full bg-white text-sm dark:bg-bgdark">
									...
									<div id="navbar-with-mega-menu"
										...
										<div className="flex flex-col gap-5 mt-5 md:flex-row md:items-center md:justify-end md:mt-0 ltr:md:pl-5 rtl:md:pr-5">
											...
											<div className="hs-dropdown [--strategy:static] md:[--strategy:absolute] [--adaptive:none]">
												...
												<div className="hs-dropdown-menu transition-[opacity,margin] ltr:right-0 rtl:left-0 duration-[0.1ms] md:duration-[150ms] hs-dropdown-open:opacity-100 opacity-0 md:w-48 hidden z-10 bg-white md:shadow-md rounded-sm p-2 dark:bg-bgdark md:dark:border dark:border-white/10 dark:divide-white/10 before:absolute top-full md:border before:-top-5 ltr:before:left-0 rtl:before:right-0 before:w-full before:h-5">
						...
						<div className="box-body space-y-4">
							<header
								...
								<nav className="w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between" aria-label="Global">
									<div className="flex items-center justify-between">
										<Link href={"/dashboards/sales/"} className="header-logo">
											<img src={"../../assets/img/brand-logos/desktop-light.png"} alt="logo" className="block" />
										</Link>
										<div className="sm:hidden">
											<button type="button"
