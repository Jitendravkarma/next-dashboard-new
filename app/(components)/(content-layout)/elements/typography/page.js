...
const Typography = () => {
  return (
    <Fragment>
      ...
      <PageHeader currentpage="Typography" activepage="Elements" mainpage="Typography" />
      {/* <!-- Start::row-1 --> */}
      <div className="grid grid-cols-12 gap-x-6">
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Heading tags</h5>
            </div>
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Inline text elements</h5>
            </div>
            <div className="box-body space-y-3">
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Description list alignment</h5>
            </div>
            <div className="box-body space-y-3">
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">First-line and first-letter</h5>
            </div>
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Font Sizes</h5>
            </div>
            <div className="box-body space-y-3">
        ...
        <div className="col-span-12 lg:col-span-6">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Open/closed state</h5>
            </div>
            <div className="box-body space-y-8">
              <div className="">
          ...
          <div className="box">
            <div className="box-header">
              <h5 className="box-title"> Text Decoration </h5>
            </div>
            <div className="box-body space-y-3">
          ...
          <div className="box">
            <div className="box-header">
              <h5 className="box-title"> Text Transform  </h5>
            </div>
            <div className="box-body space-y-3">
