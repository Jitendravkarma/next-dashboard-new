...
const Navtabs = () => {
  return (
    <div>
      <Seo title={"Nav&tabs"} />
      <PageHeader currentpage="Navs & Tabs" activepage="Elements" mainpage="Navs & Tabs" />
      {/* <!-- Start::row-1 --> */}
          ...
          <div className="box">
            ...
            <div className="box-body">
              <nav className="sm:flex space-x-6 rtl:space-x-reverse">
                <a className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" href="#!">
                  Link
                </a>
                <a className="px-1 inline-flex items-center gap-2 text-sm font-medium whitespace-nowrap text-primary hover:text-primary" href="#!" aria-current="page">
                  Active
                </a>
                <a className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-primary hover:text-primary" href="#!">
                  Link
                </a>
                <a className="px-1 inline-flex items-center gap-2 text-sm whitespace-nowrap text-gray-400 pointer-events-none dark:text-white/50" href="#!">
                  Disabled
                </a>
              </nav>
            </div>
      ...
      <div className="grid grid-cols-12 gap-x-6">
            ...
            <div className="box-body">
              ...
              <div className="">
                <div id="hs-tab-js-behavior-1" role="tabpanel" aria-labelledby="hs-tab-js-behavior-item-1">
                  <p className="text-gray-500 dark:text-white/70 p-5 border rounded-ss-none rounded-sm dark:border-white/10 border-gray-200">
            ...
            <div className="box-body">
              <div className="flex">
                <div className="border-e border-gray-200 dark:border-white/10">
                  <nav className="flex flex-col space-y-2 whitespace-nowrap" aria-label="Tabs" role="tablist" data-hs-tabs-vertical="true">
                    <button type="button" className="hs-tab-active:bg-white hs-tab-active:border-e-transparent hs-tab-active:text-primary dark:hs-tab-active:bg-transparent dark:hs-tab-active:border-e-white/10 dark:hs-tab-active:text-primary -me-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500  rounded-s-sm hover:text-gray-700 dark:bg-bodybg dark:border-white/10 dark:text-white/70 dark:hover:text-gray-300 active" id="hs-tab-js-vertical-item-1" data-hs-tab="#hs-tab-js-vertical-1" aria-controls="hs-tab-js-vertical-1">
                      Tab 1
                    </button>
                ...
                <div className="">
                  <div id="hs-tab-js-vertical-1" role="tabpanel" aria-labelledby="hs-tab-js-vertical-item-1">
                    <p className="text-gray-500 dark:text-white/70 p-5 border border-s-0 rounded-sm rounded-ss-none dark:border-white/10 border-gray-200">
                      How hotel deals can help you live a better life. How celebrity cruises aren't as bad as you think. How cultural solutions can help you predict the future. How to cheat at dog friendly hotels and get away with it. 17 problems with summer activities. How to cheat at travel agents and get away with it. How not knowing family trip ideas makes you a rookie. What everyone is saying about daily deals. How twitter can teach you about carnival cruises. How to start using cultural solutions.
                    </p>
                  </div>
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <select id="tab-select" className="mb-5 sm:hidden py-2 px-3 pe-9 block w-full border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70" aria-label="Tabs">
              ...
              <div className="">
                <div id="hs-tab-to-select-1" role="tabpanel" aria-labelledby="hs-tab-to-select-item-1">
                  <p className="text-gray-500 dark:text-white/70 p-5 border rounded-sm  sm:rounded-ss-none dark:border-white/10 border-gray-200">
                    How hotel deals can help you live a better life. How celebrity cruises aren't as bad as you think. How cultural solutions can help you predict the future. How to cheat at dog friendly hotels and get away with it. 17 problems with summer activities. How to cheat at travel agents and get away with it. How not knowing family trip ideas makes you a rookie. What everyone is saying about daily deals. How twitter can teach you about carnival cruises. How to start using cultural solutions.
                  </p>
                </div>
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="sm:border-b-2 border-gray-200 dark:border-white/10">
                <nav className="-mb-0.5 sm:flex sm:space-x-6 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                  <a className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 dark:text-white/70 hover:text-primary" href="#!" id="icon-item-1" data-hs-tab="#icon-1" aria-controls="icon-1">
              ...
              <div className="sm:border-b border-gray-200 dark:border-white/10">
                <nav className="sm:flex sm:space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                  <button type="button" className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary dark:text-white/70 active" id="tabs-with-badges-item-1" data-hs-tab="#tabs-with-badges-1" aria-controls="tabs-with-badges-1">
                    Tab 1 <span className="hs-tab-active:bg-primary hs-tab-active:text-white dark:hs-tab-active:bg-primary dark:hs-tab-active:text-white ms-1 py-0.5 px-1.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-bodybg dark:text-gray-300">99+</span>
                  </button>
                  <button type="button" className="w-full sm:w-auto hs-tab-active:font-semibold hs-tab-active:border-primary hs-tab-active:text-primary py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-primary dark:text-white/70" id="tabs-with-badges-item-2" data-hs-tab="#tabs-with-badges-2" aria-controls="tabs-with-badges-2">
                    Tab 2 <span className="hs-tab-active:bg-primary hs-tab-active:text-white dark:hs-tab-active:bg-primary dark:hs-tab-active:text-white ms-1 py-0.5 px-1.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 dark:bg-bodybg dark:text-gray-300">99+</span>
                  </button>
        ...
        <div className="col-span-12 md:col-span-6 xxl:!col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <div className="border-b-0 border-gray-200 dark:border-white/10">
                <nav className="flex space-x-2 rtl:space-x-reverse" aria-label="Tabs" role="tablist">
                  <a className="hs-tab-active:!bg-transparent hs-tab-active:!text-primary -mb-px py-2 px-3 inline-flex items-center gap-2 bg-gray-50 text-sm font-medium text-center border text-gray-500 rounded-t-sm hover:text-gray-700 dark:bg-bodybg dark:border-white/10 dark:text-white/70 dark:hover:text-gray-300 active" href="#!" id="card-type-item-1" data-hs-tab="#card-type-1" aria-controls="card-type-1">
                    Active
                  </a>
              ...
              <div className="">
                <div id="card-type-1" role="tabpanel" aria-labelledby="card-type-item-1">
                  <p className="text-gray-500 dark:text-white/70 p-5 border rounded-sm rounded-ss-none dark:border-white/10 border-gray-200">
                    How hotel deals can help you live a better life. How celebrity cruises aren't as bad as you think. How cultural solutions can help you predict the future. How to cheat at dog friendly hotels and get away with it. 17 problems with summer activities. How to cheat at travel agents and get away with it. How not knowing family trip ideas makes you a rookie. What everyone is saying about daily deals. How twitter can teach you about carnival cruises. How to start using cultural solutions.
                  </p>
                </div>
