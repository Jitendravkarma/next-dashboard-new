							...
							<div className="relative">
								...
								<div className="relative columns-1 sm:columns-3 gap-8">
									<div className="relative aspect-w-16 aspect-h-9">
										<img className="w-full object-cover rounded-sm" src={"../../assets/img/gallery/1.jpg"} alt="Image Description" />
									</div>
									<div className="relative aspect-w-1 aspect-h-1 mt-8">
										<img className="w-full object-cover rounded-sm" src={"../../assets/img/gallery/2.jpg"} alt="Image Description" />
									</div>
									<div className="relative aspect-w-1 aspect-h-1 mt-8">
										<img className="w-full object-cover rounded-sm" src={"../../assets/img/gallery/4.jpg"} alt="Image Description" />
									</div>
									<div className="hidden sm:block relative aspect-w-1 aspect-h-1 mt-8 sm:mt-0">
										<img className="w-full object-cover rounded-sm" src={"../../assets/img/gallery/9.jpg"} alt="Image Description" />
									</div>
									<div className="hidden sm:block relative aspect-w-16 aspect-h-9 mt-8">
										<img className="w-full object-cover rounded-sm" src={"../../assets/img/gallery/8.jpg"} alt="Image Description" />
									</div>
									<div className="hidden sm:block relative aspect-w-1 aspect-h-1 mt-8">
										<img className="w-full object-cover rounded-sm" src={"../../assets/img/gallery/7.jpg"} alt="Image Description" />
									</div>
									<div className="hidden sm:block relative aspect-w-1 aspect-h-1 mt-8 sm:mt-0">
										<img className="w-full object-cover rounded-sm" src={"../../assets/img/gallery/5.jpg"} alt="Image Description" />
									</div>
									<div className="hidden sm:block relative aspect-w-1 aspect-h-1 mt-8">
										<img className="w-full object-cover rounded-sm" src={"../../assets/img/gallery/6.jpg"} alt="Image Description" />
									</div>
									<div className="hidden sm:block relative aspect-w-16 aspect-h-9 mt-8">
										<img className="w-full object-cover rounded-sm" src={"../../assets/img/gallery/5.jpg"} alt="Image Description" />
									</div>
