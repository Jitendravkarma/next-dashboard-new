"use client"
import { Statistic } from "@/shared/data/dashboard/personaldata";
					...
					<div className="grid grid-cols-12 gap-x-5">
									...
									<div className="flex justify-between">
										<div className="flex-1">
											...
											<h5 className="mb-1 text-3xl text-gray-800 dark:text-white font-semibold">$75,234
												<span className="text-xs text-gray-500 dark:text-white/70 font-normal  ms-1">/ month</span>
											</h5>
											<span className="text-gray-500 dark:text-white/70"><i className="ti ti-trending-up me-1 text-success inline-flex"></i>
												+5%
							...
							<div className="box">
								<div className="box-body">
									<div className="flex justify-between">
										...
										<div className="ltr:ml-auto rtl:mr-auto">
											<span className="avatar rounded-sm bg-secondary text-white p-3"><i
								...
								<div className="box-body">
									<div className="flex justify-between">
										<div className="flex-1">
											...
											<span className="text-gray-500 dark:text-white/70"><i className="ti ti-trending-down me-1 text-danger  inline-flex"></i>
												-10%
												than last month</span>
										</div>
										<div className="ltr:ml-auto rtl:mr-auto">
											<span className="avatar rounded-sm bg-danger text-white p-3"><i
						...
						<div className="col-span-12 xxl:col-span-4">
							<div className="box">
								...
								<div className="box-body dashboard-contacts">
									<ul className="flex flex-col">
										<li className="px-0 pt-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
											<div className="">
												<Link href={"/home"} className="flex items-center space-x-3 rtl:space-x-reverse">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/2.jpg"}
											...
											<div className="ltr:ml-auto rtl:mr-auto space-x-2 rtl:space-x-reverse">
												<Link aria-label="anchor" href={"/pages/contacts/"} className="text-gray-500 dark:text-white/70">
													<i className="ri-heart-line text-base hover:text-danger"></i>
												</Link>
												<Link aria-label="anchor" href={"/pages/contacts/"} className="text-gray-500 dark:text-white/70  inline-flex">
										...
										<li className="px-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
											<div className="">
												<Link href={"/home"} className="flex items-center space-x-3 rtl:space-x-reverse">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/3.jpg"}
														alt="Image Description" />
													<div className="flex">
														<div className="block my-auto">
															<p
											...
											<div className="ltr:ml-auto rtl:mr-auto space-x-2 rtl:space-x-reverse ">
												<Link aria-label="anchor" href={"/pages/contacts/"} className="text-danger">
										...
										<li className="px-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
											<div className="">
												<Link href={"/home"} className="flex items-center space-x-3 rtl:space-x-reverse">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/10.jpg"}
														alt="Image Description" />
													<div className="flex">
														<div className="block my-auto">
															<p
										...
										<li className="px-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
											<div className="">
												<Link href={"/home"} className="flex items-center space-x-3 rtl:space-x-reverse">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/12.jpg"}
														alt="Image Description" />
													<div className="flex">
														<div className="block my-auto">
															<p
										...
										<li className="px-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
											<div className="">
												<Link href={"/home"} className="flex items-center space-x-3 rtl:space-x-reverse">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/5.jpg"}
														alt="Image Description" />
													<div className="flex">
														<div className="block my-auto">
															<p
										...
										<li className="px-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
											<div className="">
												<Link href={"/home"} className="flex items-center space-x-3 rtl:space-x-reverse">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/15.jpg"}
														alt="Image Description" />
													<div className="flex">
														<div className="block my-auto">
															<p
				...
				<div className="col-span-12 xxl:col-span-3">
					<div className="box text-white overflow-hidden">
						<div className="block absolute w-full h-full before:bg-primary/70 before:absolute before:w-full before:h-full">
							<img src={"../../assets/img/png-images/16.png"} alt="" className="w-full xxl:h-full" />
						</div>
						<div className="box-body relative">
							<div className="flex justify-between mb-4">
								<div className="ltr:mr-1 rtl:ml-1">
									...
									<Link href="#!" scroll={false} className="text-xs text-white/70">Change<i
										...
										<div className="flex-1">
											...
											<div className="flex items-center justify-between">
												<div className="flex -space-x-2 rtl:space-x-reverse">
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/8.jpg"}
														alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/4.jpg"}
														alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/6.jpg"}
														alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/7.jpg"}
														alt="Image Description" />
												</div>
										...
										<div className="flex-1">
											...
											<div className="flex items-center justify-between">
												<div className="flex -space-x-2 rtl:space-x-reverse">
													...
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/4.jpg"}
														alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/21.jpg"}
														alt="Image Description" />
												</div>
												<span className="text-gray-500 dark:text-white/70 flex text-xs"><i
													className="ri-time-line ltr:mr-1 rtl:ml-1 my-auto "></i>10-04-23</span>
								...
								<li className="ti-list-group mb-0 border-0 p-0 w-full">
									<div className="flex w-full">
										...
										<div className="flex-1">
											...
											<div className="flex items-center justify-between">
												<div className="flex -space-x-2 rtl:space-x-reverse">
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/8.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/4.jpg"} alt="Image Description" />
													<img className="inline-block avatar w-6 h-6 rounded-full" src={"../../assets/img/users/21.jpg"} alt="Image Description" />
												</div>
			...
			<div className="grid grid-cols-12 gap-x-5">
							...
							<ul className="">
								<li className="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
									<div className="flex items-start w-full">
										<Link href={"/pages/mail/chat/"} className="ltr:mr-2 rtl:ml-2 avatar rounded-full">
											<img src={"../../assets/img/users/17.jpg"} alt="img" className="rounded-full" />
										</Link>
										<div className="flex justify-between relative w-full">
											<Link aria-label="anchor" href={"/pages/mail/chat/"} className="absolute h-full w-full inset-0"></Link>
											<div className="">
								...
								<li className="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
									<div className="flex items-start w-full">
										<Link href={"/pages/mail/chat/"} className="ltr:mr-2 rtl:ml-2 avatar rounded-full">
											<img src={"../../assets/img/users/2.jpg"} alt="img" className="rounded-full" />
										</Link>
										<div className="flex justify-between relative w-full">
											<Link aria-label="anchor" href={"/pages/mail/chat/"} className="absolute h-full w-full inset-0"></Link>
											<div className="">
								...
								<li className="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
									<div className="flex items-start w-full">
										<Link href={"/pages/mail/chat/"} className="ltr:mr-2 rtl:ml-2 avatar rounded-full">
											<img src={"../../assets/img/users/21.jpg"} alt="img" className="rounded-full" />
										</Link>
										<div className="flex justify-between relative w-full">
											<Link aria-label="anchor" href={"/pages/mail/chat/"} className="absolute h-full w-full inset-0"></Link>
											<div className="">
								...
								<li className="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
									<div className="flex items-start w-full">
										<Link href={"/pages/mail/chat/"} className="ltr:mr-2 rtl:ml-2 avatar rounded-full">
											<img src={"../../assets/img/users/11.jpg"} alt="img" className="rounded-full" />
										</Link>
										<div className="flex justify-between relative w-full">
											<Link aria-label="anchor" href={"/pages/mail/chat/"} className="absolute h-full w-full inset-0"></Link>
											<div className="">
								...
								<li className="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
									<div className="flex items-start w-full">
										<Link href={"/pages/mail/chat/"} className="ltr:mr-2 rtl:ml-2 avatar rounded-full">
											<img src={"../../assets/img/users/3.jpg"} alt="img" className="rounded-full" />
										</Link>
										<div className="flex justify-between relative w-full">
											<Link aria-label="anchor" href={"/pages/mail/chat/"} className="absolute h-full w-full inset-0"></Link>
											<div className="">
				...
				<div className="col-span-12 md:col-span-6 xxl:col-span-3">
					<div className="box">
						...
						<div className="box-body">
							<ul className="flex flex-col">
								<li className="flex flex-col gap-x-3.5 bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white pt-2 rounded-sm mb-3">
								...
								<li className="flex flex-col gap-x-3.5 bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white pt-2 rounded-sm">
									<Link href="#!" scroll={false} >
										<div className="flex items-center justify-between">
											<div className="flex items-center space-x-3 rtl:space-x-reverse">
												<div>
									...
									<li className="ti-list-group border-0 p-0 w-full timeline-widget-list">
										<div className="flex w-full">
											...
											<div className="flex flex-auto items-center justify-between">
												<div>
													<Link href="#!" scroll={false} >
														<p className="mb-1 truncate timeline-widget-content text-sm  !max-w-[15rem]">You have
									...
									<li className="ti-list-group border-0 p-0 w-full timeline-widget-list">
										<div className="flex w-full">
											...
											<div className="flex flex-auto items-center justify-between">
												<div>
													<Link href="#!" scroll={false} >
														<p className="mb-1 truncate timeline-widget-content text-sm !max-w-[15rem]">National
									...
									<li className="ti-list-group border-0 p-0 w-full timeline-widget-list">
										<div className="flex w-full">
											...
											<div className="flex flex-auto items-center justify-between">
												<div>
													<Link href="#!" scroll={false} >
														<p className="mb-1 truncate timeline-widget-content text-sm  !max-w-[15rem]">John pup
														...
														<p className="mb-1 truncate timeline-widget-content text-sm !max-w-[15rem]">Amet sed
				...
				<div className="col-span-12 md:col-span-6 xxl:col-span-3">
					<div className="box">
						...
						<div className="box-body">
							<div className="lg:grid hidden grid-cols-5 mb-2">
								<Link href="#!" scroll={false} >
							...
							<div className="flex justify-between">
								<Link href="#!" scroll={false} className="mb-0 w-full ti-btn ti-btn-primary">Send Money</Link>
								<Link href="#!" scroll={false} className="mb-0 w-full ti-btn ti-btn-danger">Cancel</Link>
							</div>
						</div>
					</div>
				</div>
					...
					<div className="box">
						<div className="box-header">
							<div className="justify-between flex">
								...
								<div className="hs-dropdown ti-dropdown block ltr:ml-auto my-auto">
								...
								<table className="ti-custom-table ti-custom-table-head whitespace-nowrap table-bordered rounded-sm ti-custom-table-head ">
									...
									<tbody className="">
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/2.jpg"} alt="Image Description" />
													<div className="block my-auto">
											...
											<td className="font-medium space-x-2 rtl:space-x-reverse">
												<div className="hs-tooltip ti-main-tooltip">
													<Link href="#!" scroll={false} className="m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn !rounded-full p-0 transition-none focus:outline-none ti-btn-soft-primary">
												...
												<div className="hs-tooltip ti-main-tooltip">
													<Link href="#!" scroll={false} className="m-0 hs-tooltip-toggle relative w-8 h-8 ti-btn !rounded-full p-0 transition-none focus:outline-none ti-btn-soft-danger">
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/12.jpg"} alt="Image Description" />
													<div className="block my-auto">
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/14.jpg"} alt="Image Description" />
													<div className="block my-auto">
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/4.jpg"} alt="Image Description" />
													<div className="block my-auto">
										...
										<tr className="">
											...
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse text-start">
													<img className="avatar avatar-sm rounded-sm" src={"../../assets/img/users/3.jpg"} alt="Image Description" />
													<div className="block my-auto">
							...
							<div className="flex items-center">
								...
								<div className="ltr:ml-auto rtl:mr-auto">
									<nav className="flex justify-center items-center space-x-2 rtl:space-x-reverse">
										<Link className="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center gap-2 rounded-sm" href="#!" scroll={false} >
										...
										<Link className="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="#!" scroll={false} >2</Link>
										<Link className="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center text-sm font-medium rounded-sm" href="#!" scroll={false} >3</Link>
										<Link className="text-gray-500 hover:text-primary e py-1 px-2 leading-none inline-flex items-center gap-2 rounded-sm" href="#!" scroll={false} >
