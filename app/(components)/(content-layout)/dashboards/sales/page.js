							...
							<div className="box-body">
								<div className="flex">
									...
									<span className={`badge bg-${idx.color}/10 text-${idx.color} py-1 ltr:ml-auto rtl:mr-auto !my-auto`}>
										<i className={`ti ti-trending-${idx.icon1}`}></i>
										{idx.data}
									</span>
								</div>
								<div className="mt-2">
										...
										{topselling.map((idx) => (
											<tr key={Math.random()}>
												<td className="leading-none !text-gray-800 dark:!text-white !p-[0.65rem]">
													<img src={idx.src}
														className="avatar avatar-sm p-2 rounded-full bg-gray-100 dark:bg-bodybg ltr:mr-2 rtl:ml-2"
														alt="Image Description" />
													{idx.data1}
												</td>
									...
									<tbody className="">
										{orderdetails.map((idx) => (
											<tr className="" key={Math.random()}>
												...
												<td>
													<div className="flex space-x-3 rtl:space-x-reverse w-full">
														<img className="avatar rounded-sm bg-gray-100 dark:bg-bodybg p-2"
