"use client"
import { TeamCategory, TeammemberData, TeammemberData1 } from "@/shared/data/pages/teamdata";
              ...
              <div className="lg:grid grid-cols-12 gap-6 space-y-6 lg:space-y-0">
                ...
                <div className="col-span-12 lg:col-span-4">
                  <div className="flex space-x-3 rtl:space-x-reverse lg:justify-end team-right team-members">
                    <Select className="ti-form-select p-0" classNamePrefix="react-select" options={TeamCategory} placeholder='Categories' />
                    <div className="hs-tooltip ti-main-tooltip">
                      <Link href="#!" scroll={false} className="team-add-btn !m-0 hs-tooltip-toggle ti-btn ti-btn-primary">
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12">
                  ...
                  <div className="col-span-12 md:col-span-6 xxl:col-span-3 team-box" key={Math.random()}>
                    <div className="box overflow-hidden mb-0">
                      <div className="block relative -mb-32 before:bg-primary/70 before:absolute before:w-full before:h-full">
                        <img src={"../../assets/img/png-images/2.png"} alt="" className="w-full h-32" />
                      </div>
                      <div className="box-body">
                        <div className="justify-center text-center relative ">
                          <Link className="relative inline-block mt-8" href={"/home"}>
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex space-x-1 rtl:space-x-reverse justify-center text-center">
                              <div className="hs-tooltip ti-main-tooltip">
                                <button type="button" className="hs-tooltip-toggle !mb-0 !m-0 !rounded-full !p-2 ti-btn ti-btn-outline  !border-gray-200 dark:!border-white/10 text-gray-500 dark:text-white/70 ring-transparent">
                          ...
                          <Link aria-label="anchor" href="#!" scroll={false} className={idx.favoriteclass}><i className="ri-star-fill"></i></Link>
                          <div
                            className="hs-dropdown ti-dropdown z-9 absolute top-0 ltr:right-0 rtl:left-0 block text-gray-100 dark:text-white/70 text-base">
                            ...
                            <div className="hs-dropdown-menu ti-dropdown-menu">
                              <Link className="ti-dropdown-item" href={"/home"}><i className="ri ri-edit-2-line text-lg"></i>Edit</Link>
                              <Link className="ti-dropdown-item" href="#!" scroll={false}><i className="ri ri-delete-bin-6-line text-lg"></i>Delete</Link>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className="box-footer bg-gray-100 dark:bg-bgdark p-0 text-center">
                        <div className="grid grid-cols-12 gap-6">
                          <div className="col-span-6 ltr:border-r rtl:border-l p-3 border-gray-200 dark:border-white/10">
                            <Link href={"/home"} className="space-x-3 rtl:space-x-reverse"><i className="ri-user-line inline-block"></i><span>Profile</span></Link>
                          </div>
                          <div className="col-span-6 p-3">
                            <Link href={"/pages/contacts/"} className="space-x-3 rtl:space-x-reverse"><i
                              className="ri-message-3-line inline-block"></i><span>Chat</span></Link>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="col-span-12 md:col-span-6 xxl:col-span-3 team-box" key={Math.random()}>
                    <div className="box overflow-hidden mb-0">
                      ...
                      <div className="box-body">
                        <div className="justify-center text-center relative ">
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex space-x-1 rtl:space-x-reverse justify-center text-center">
                              <div className="hs-tooltip ti-main-tooltip">
                                <button type="button" className="hs-tooltip-toggle !mb-0 !rounded-full !p-2 ti-btn ti-btn-outline  !border-gray-200 dark:!border-white/10 text-gray-500 dark:text-white/70 ring-transparent">
                                  <i className="ri ri-github-line text-lg leading-none"></i>
                                  <span className="hs-tooltip-content ti-main-tooltip-content py-1 px-2 bg-gray-900 text-xs font-medium text-white shadow-sm dark:bg-slate-700" role="tooltip"> Github</span>
                                </button>
                              </div>
                          ...
                          <div
                            ...
                            <div className="hs-dropdown-menu ti-dropdown-menu">
                              <Link className="ti-dropdown-item" href={"/home"}><i
                                className="ri ri-edit-2-line text-lg"></i>Edit</Link>
                              <Link className="team-remove ti-dropdown-item" href="#!" scroll={false}><i
                      ...
                      <div className="box-footer bg-gray-100 dark:bg-bgdark p-0 text-center">
                        <div className="grid grid-cols-12 gap-6">
                          <div className="col-span-6 ltr:border-r rtl:border-l p-3 border-gray-200 dark:border-white/10">
                            <Link href={"/home"} className="space-x-3 rtl:space-x-reverse"><i className="ri-user-line"></i><span>Profile</span></Link>
                          </div>
                          <div className="col-span-6 p-3">
                            <Link href={"/pages/contacts/"} className="space-x-3 rtl:space-x-reverse"><i
          ...
          <nav className="flex justify-end items-center space-x-2 rtl:space-x-reverse my-4">
            <Link className="w-10 h-10 text-gray-500 dark:text-white/70 bg-gray-200 dark:bg-bgdark hover:text-primary p-4 inline-flex items-center gap-2 rounded-full" href="#!" scroll={false} >
            ...
            <Link className="w-10 h-10  bg-gray-200 dark:bg-bgdark text-gray-500 dark:text-white/70 hover:text-primary p-4 inline-flex items-center text-sm font-medium rounded-full" href="#!" scroll={false} >2</Link>
            <Link className="w-10 h-10  bg-gray-200 dark:bg-bgdark text-gray-500 dark:text-white/70 hover:text-primary p-4 inline-flex items-center text-sm font-medium rounded-full" href="#!" scroll={false} >3</Link>
            <Link className="w-10 h-10 text-gray-500 dark:text-white/70 bg-gray-200 dark:bg-bgdark hover:text-primary p-4 inline-flex items-center gap-2 rounded-full" href="#!" scroll={false} >
