"use client"
import { ContactData, ProfileService, ProfileService1 } from "@/shared/data/pages/contactdata";
...
const Contacts = () => {
  ...
  //URl image
  const [UrlImage, setUrlImage] = useState("../../assets/img/users/1.jpg");
  ...
  /////////////////////
  //URl image
  const [UrlImage1, setUrlImage1] = useState("../../assets/img/png-images/14.jpg");
  //Disabling input feild
  const [UrlDisabled1, setUrlDisabled1] = useState(true);

  const [fileDisabled1, setfileDisabled1] = useState(false);
  //Default image
  const [Image1, setImage1] = useState("../../assets/img/png-images/14.jpg");

  const putImage1 = () => {
    setImage1(ProfileService1.returnImage1());
    if (UrlImage1 != Image) {
      ProfileService1.handleChangeUrl1(UrlImage);
      setImage1(ProfileService1.returnImage1());
    }
    // setSmShow(false)
  };
  ...
  //toggle button for image 
  const toggleImage1 = (type) => {
    if (type == "fileDisabled") {
      setfileDisabled1(false);
      setUrlDisabled1(true);
    }
    if (type == "UrlDisabled") {
      setUrlDisabled1(false);
      setfileDisabled1(true);
    }
  };
              ...
              <div className="box-header">
                <div className="grid grid-cols-12 gap-5">
                  ...
                  <div className="col-span-12 lg:sm:col-span-8">
                    <div className="sm:flex sm:space-x-3 sm:space-y-0 space-y-2 lg:justify-end team-right rtl:space-x-reverse">
                      <div className="hs-dropdown ti-dropdown contact-dropdown">
                        ...
                        <div className="hs-dropdown-menu ti-dropdown-menu hidden"
                          ...
                          <Link className="ti-dropdown-item" href="#!" scroll={false} >A To Z</Link>
                          <Link className="ti-dropdown-item" href="#!" scroll={false} >Z To A</Link>
                          <Link className="ti-dropdown-item" href="#!" scroll={false} >Favorites</Link>
                          <Link className="ti-dropdown-item" href="#!" scroll={false} >All</Link>
                        </div>
                      </div>
                      <Link href="#!" scroll={false} className="team-add-btn m-0 ti-btn ti-btn-secondary whitespace-nowrap">
                        <i className="ti ti-circle-plus leading-none"> </i>Add New Contact
                      </Link>
                      <div className="hs-dropdown ti-dropdown ms-3">
                        ...
                        <div className="flex">
                          <div className="sm:flex sm:space-x-3 sm:space-y-0 space-y-4 rtl:space-x-reverse">
                            ...
                            <div className="space-y-1 my-auto">
                              ...
                              <p className="text-gray-500 dark:text-white/70 font-semibold text-xs truncate xxxl:max-w-[9rem] max-w-[8rem]">
                                {idx.mail}</p>
                              <p className="text-primary dark:text-primary text-xs font-semibold">{idx.number}</p>
                            </div>
                          </div>
                          <div className="ltr:ml-auto rtl:mr-auto">
                            <Link href="#!" scroll={false} ><i className={idx.favoriteclass}></i></Link>
                          </div>
                        </div>
                      </div>
                          ...
                          <div className="sm:col-span-2 col-span-4">
                            <div className="hs-dropdown ti-dropdown flex justify-end">
                              ...
                              <div className="hs-dropdown-menu ti-dropdown-menu">
                                ...
                                <Link className="ti-dropdown-item" href="#!" scroll={false} onClick={() => handleRemove(idx.id)}><i
              ...
              <div className="box-body">
                <div className="relative">
                  <div
                    ...
                    <img src={Image1} alt="" className="h-[150px] w-full rounded-sm" id="profile-img2" />
                    <span data-hs-overlay="#hs-small-modal1"
                      ...
                      <div className="ti-modal-content">
                        ...
                        <div className="ti-modal-body">
                          <div onClick={() => { toggleImage1("fileDisabled"); }}>
                            ...
                            <input type="file" name="file-input" id="file-input" disabled={fileDisabled1} onChange={(ele) => ProfileService1.handleChange1(ele)} className=" inset-0 block w-full h-full cursor-pointer border my-2 border-gray-200 focus:shadow-sm dark:focus:shadow-white/10 rounded-sm text-sm focus:z-10 focus:outline-0 focus:border-gray-200 dark:focus:border-white/10 dark:border-white/10 dark:text-white/70  file:border-0 file:bg-gray-100 ltr:file:mr-4 rtl:file:ml-4 file:py-3 file:px-4 dark:file:bg-black/20 dark:file:text-white/70" />
                          </div>
                          <div onClick={() => { toggleImage1("UrlDisabled"); }}>
                            <input type="text" className="my-auto ti-form-input" name="basic-input" id="basic-input" disabled={UrlDisabled1} onChange={(ele) => { setUrlImage1(ele.target.value); }} placeholder="Paste the URL" />
                          </div><br />
                  ...
                  <div className="absolute top-[5.5rem] inset-x-0 text-center space-y-3">
                    <div className="flex justify-center w-full">
                      <div className="relative">
                        ...
                        <button type="button" className="absolute top-0 ltr:right-0 rtl:left-0 block p-1 rounded-full ring-2 ring-white/10 text-white bg-white/10 dark:bg-bgdark leading-none" data-hs-overlay="#hs-small-modal"><i className="ri ri-pencil-line"></i> <span></span></button>
                ...
                <div className="mt-14 space-y-5">
                  ...
                  <div className="flex space-x-3 rtl:space-x-reverse">
                    ...
                    <div className="my-auto">
                      ...
                      <Link href="#!" scroll={false} className="text-xs text-gray-500 dark:text-white/70">+121 9585652655</Link>
                    </div>
                  </div>
                  <div className="flex space-x-3 rtl:space-x-reverse">
                    <i
                  ...
                  <div className="flex space-x-3 rtl:space-x-reverse">
                    <i
                      className="ri ri-twitter-x-line text-lg leading-none p-3 avatar avatar-sm bg-info/20 dark:bg-info/20 text-info dark:text-info rounded-sm"></i>
                    <div className="my-auto">
