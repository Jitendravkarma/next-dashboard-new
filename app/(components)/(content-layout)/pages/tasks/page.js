...
import { Assigned, NewTask, SortBy, StatusTask } from "@/shared/data/pages/tasksdata";
					...
					<div className="grid grid-cols-12 gap-6">
						<div className="col-span-12 lg:col-span-4">
							<div className="sm:flex sm:space-x-3 sm:space-y-0 space-y-2 task-left rtl:space-x-reverse">
								...
								<Link href="#!" scroll={false} className="hs-dropdown-toggle !py-2 !px-3 ti-btn ti-btn-primary m-0 whitespace-nowrap !my-0" data-hs-overlay="#task-compose"><i className="ri ri-edit-line"></i> Add New Task</Link>
											...
											<div className="ti-modal-body">
												<div className="space-y-3">
													...
													<div>
														...
														<Select classNamePrefix='react-select' isMulti options={NewTask} defaultValue={[]} onChange={(value) => console.log(value)} />
						...
						<div className="col-span-12 lg:col-span-8">
							<div className="sm:flex sm:space-x-3  sm:space-y-0 space-y-2 justify-end task-right rtl:space-x-reverse">
								<Select classNamePrefix='react-select' className="task-choice" options={SortBy} menuPlacement='auto' placeholder='Sort By' />

								<Select classNamePrefix='react-select' className="task-choice" options={StatusTask} menuPlacement='auto' placeholder='Status' />
				...
				<div className="col-span-12 lg:col-span-6 xxxl:!col-span-3">
					<div className="box border-t-[5px] border-t-danger dark:border-t-danger">
									...
									<div className="box task-box">
										<div className="box-body space-y-4">
												...
												<div>
													<span className="badge bg-gray-100 text-gray-800 dark:bg-black/20 dark:text-gray-200 ltr:mr-1 rtl:ml-1">
														...
														<button aria-label="button" type="button"
															className="flex-shrink-0 h-4 w-4 inline-flex items-center justify-center rounded-full text-gray-500 dark:text-white/70 hover:bg-gray-200 dark:hover:bg-black/20 hover:text-white focus:outline-none focus:bg-gray-200 focus:text-gray-500 dark:focus:bg-black/20">
															<i className="ri-close-line"></i>
														</button>
													</span>
													<span className="badge bg-gray-100 text-gray-800 dark:bg-black/20 dark:text-gray-200 ltr:mr-1 rtl:ml-1">
											...
											<div className="sm:flex">
												...
												<span className="ltr:ms-auto rtl:mr-auto badge bg-primary/10 text-primary rounded-sm sm:mb-0">
													Due Date: 25-12-2022
												</span>
											</div>
										</div>
										<div className="box-footer">
											<div className="sm:flex sm:space-y-0 space-y-2">
												<div className="font-medium space-x-2 rtl:space-x-reverse my-auto">
												...
												<div className="flex -space-x-2 rtl:space-x-reverse ltr:ms-auto rtl:mr-auto">
													...
													<img className="avatar w-6 h-6 rounded-full" src={"../../assets/img/users/3.jpg"}
														alt="Image Description" />
													<img className="avatar w-6 h-6 rounded-full" src={"../../assets/img/users/13.jpg"}
														alt="Image Description" />
													<span
											...
											<div>
												...
												<div>
													<span className="badge bg-gray-100 text-gray-800 dark:bg-black/20 dark:text-gray-200 ltr:mr-1 rtl:ml-1">
														Tailwind
														<button aria-label="button" type="button"
															className="flex-shrink-0 h-4 w-4 inline-flex items-center justify-center rounded-full text-gray-500 dark:text-white/70 hover:bg-gray-200 hover:text-gray-500 dark:hover:bg-black/20 dark:hover:text-white focus:outline-none focus:bg-gray-200 focus:text-gray-500 dark:focus:bg-black/20">
															<i className="ri-close-line"></i>
														</button>
													</span>
													<span className="badge bg-gray-100 text-gray-800 dark:bg-black/20 dark:text-gray-200 ltr:mr-1 rtl:ml-1">
										...
										<div className="box-footer">
											<div className="sm:flex sm:space-y-0 space-y-2">
												...
												<div className="flex -space-x-2 rtl:space-x-reverse ltr:ms-auto rtl:mr-auto">
													...
													<img className="avatar w-6 h-6 rounded-full" src={"../../assets/img/users/3.jpg"}
														alt="Image Description" />
													<img className="avatar w-6 h-6 rounded-full" src={"../../assets/img/users/19.jpg"}
														alt="Image Description" />
												</div>
											</div>
										</div>
						...
						<div className="box-footer flex justify-center">
							<Link href="#!" scroll={false} data-hs-overlay="#task-compose"
									...
									<div className="box task-box">
										<div className="box-body space-y-4">
											...
											<div className="sm:flex space-y-2 sm:space-y-0">
												...
												<span className="ltr:ms-auto rtl:mr-auto badge bg-primary/10 text-primary rounded-sm mb-0">
													Due Date: 25-12-2022
												</span>
											</div>
										</div>
										<div className="box-footer">
											<div className="sm:flex space-y-2 sm:space-y-0">
												...
												<div className="flex -space-x-2 rtl:space-x-reverse ltr:ms-auto rtl:mr-auto">
													...
													<img className="avatar w-6 h-6 rounded-full" src={"../../assets/img/users/19.jpg"}
														alt="Image Description" />
													<img className="avatar w-6 h-6 rounded-full" src={"../../assets/img/users/20.jpg"}
														alt="Image Description" />
												</div>
											</div>
										</div>
									...
									<div className="box task-box">
										<div className="box-body space-y-4">
											<div className="flex">
												...
												<div className="ms-auto rtl:mr-auto hs-dropdown ti-dropdown [--placement:left-top]">
													<Link aria-label="anchor" href="#!" scroll={false}
														className="hs-dropdown-toggle ti-dropdown-toggle hover:bg-transparent dark:hover:bg-transparent inline-flex  !p-0 flex-shrink-0 justify-center items-center gap-2 w-full rounded-sm border-0 font-medium text-gray-500 shadow-none align-middle focus:outline-none focus:ring-0 focus:ring-offset-0 transition-all dark:text-white/70">
														<i className="ri ri-more-2-line text-lg leading-none"></i>
													</Link>
									...
									<div className="box task-box">
										...
										<div className="box-footer">
											<div className="sm:flex space-y-2 sm:space-y-0">
												...
												<div className="flex -space-x-2 rtl:space-x-reverse ltr:ms-auto rtl:mr-auto">
													<img className="avatar w-6 h-6 rounded-full" src={"../../assets/img/users/6.jpg"}
														alt="Image Description" />
													<img className="avatar w-6 h-6 rounded-full" src={"../../assets/img/users/3.jpg"}
														alt="Image Description" />
													<img className="avatar w-6 h-6 rounded-full" src={"../../assets/img/users/2.jpg"}
														alt="Image Description" />
													<img className="avatar w-6 h-6 rounded-full" src={"../../assets/img/users/20.jpg"}
														alt="Image Description" /><span
															className="inline-flex items-center justify-center avatar w-6 h-6 rounded-full bg-gray-100 border-2 border-gray-200 dark:bg-black/20 dark:border-white/10">
