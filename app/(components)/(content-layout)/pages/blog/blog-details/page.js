					...
					<div className="box">
						<div className="p-6">
							...
							<div className="box-body px-0 pb-0">
								<div className="sm:flex justify-between mb-5 space-y-2 sm:space-y-0 flex-wrap">
									<div className="sm:flex sm:space-x-4 space-y-2 sm:space-y-0 rtl:space-x-reverse">
										<div className="flex items-center space-x-3 rtl:space-x-reverse">
											<img className="avatar avatar-sm !w-8 !h-8 ring-0 rounded-full" src={"../../../assets/img/users/1.jpg"} alt="avatar" />
								...
								<div className="box bg-gray-100 dark:bg-black/20 mb-5 shadow-none">
									<Link aria-label="anchor" href="#!" scroll={false} className=""></Link>
								...
								<div>
									...
									<div className="flex space-x-2 rtl:space-x-reverse mt-2">
										...
										<img className="avatar avatar-sm rounded-full" src={"../../../assets/img/users/5.jpg"} alt="Image Description" />
										<img className="avatar avatar-sm rounded-full hidden sm:flex" src={"../../../assets/img/users/7.jpg"} alt="Image Description" />
										<img className="avatar avatar-sm rounded-full hidden sm:flex" src={"../../../assets/img/users/2.jpg"} alt="Image Description" />
										<img className="avatar avatar-sm rounded-full hidden sm:flex" src={"../../../assets/img/users/9.jpg"} alt="Image Description" />
						...
						<div className="box-footer bg-transparent">
							<div className="sm:flex items-center justify-between space-y-2 sm:space-y-0">
								<div className="sm:flex items-center sm:space-x-3 space-y-2 sm:space-y-0 rtl:space-x-reverse">
									<Link href="#!" scroll={false} className="text-xs text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-full flex font-normal"><i className="text-xs ri ri-heart-line"></i><span>30 Likes</span></Link>
									<Link href="#!" scroll={false} className="text-xs text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-full flex font-normal"><i className="text-xs ri ri-share-line"></i><span>350 Shares</span></Link>
								</div>
								<div className="space-x-2 rtl:space-x-reverse">
									<Link href="#!" scroll={false} className="text-xs text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-full flex font-normal"><i className="text-xs ri ri-eye-line"></i><span>30k Views</span></Link>
								</div>
							</div>
						</div>
					</div>
