...
import { PaymentStatus, modeofPayment } from "@/shared/data/pages/invoice/invoicelistdata";
...
const Invoicelist = () => {
  ...
  return (
    <div>
          ...
          <div className="box">
            <div className="box-header lg:flex lg:justify-between">
              ...
              <div id="hs-basic-modal" className="hs-overlay ti-modal hidden">
                <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out sm:!max-w-sm md:!max-w-md lg:!max-w-6xl">
                  <div className="ti-modal-content">
                    ...
                    <div className="ti-modal-body p-6">
                      <div className="lg:flex flex-col lg:flex-row space-y-6 justify-between mb-5">
                        <div className="space-y-2">
                          <div className="mb-2">
                            <img src={"../../../assets/img/brand-logos/desktop-logo.png"} alt="logo" className="flex dark:hidden" />
                            <img src={"../../../assets/img/brand-logos/desktop-dark.png"} alt="logo" className="hidden dark:flex" />
                          </div>
                        ...
                        <div className="space-y-2 lg:text-end inline-block">
                          ...
                          <div className="mt-1 flex"><input type="text" className="create-date ti-form-input md:w-72 text-end lg:ltr:ml-3 lg:rtl:mr-3 flatpickr-input invoice-date font-normal" placeholder="created date" /></div>
                          <div className="mt-1 flex"><input type="text" className="due-date ti-form-input md:w-72 text-end lg:ltr:ml-3 lg:rtl:mr-3 flatpickr-input invoice-date font-normal" placeholder="Due Date" /></div>
                        </div>
                      </div>
                      ...
                      <div className="sm:flex space-y-4 justify-between">
                        ...
                        <Link href="#!" scroll={false} className="invoice-add-item ti-btn ti-btn-primary m-0 py-2"><i className="ri ri-add-line"></i>Add Item Deatils</Link>
                      </div>
                      <div className="py-5">
                    ...
                    <div className="ti-modal-footer sm:flex !block space-y-2 text-end">
                      ...
                      <Link className="ti-btn ti-btn-secondary" href="#!" scroll={false} >
                        <i className="ri-send-plane-line"></i> Send Invoice
                      </Link>
                      <Link className="ti-btn ti-btn-danger" href="#!" scroll={false} >
            ...
            <div className="box-body">
              <div className="xl:flex xl:justify-between space-y-3 xl:space-y-0">
                <div className="sm:flex sm:space-x-3 space-y-3 sm:space-y-0 rtl:space-x-reverse">
                  ...
                  <button aria-label="button" type="button" className="ti-btn px-3 py-2 ti-btn-outline !border-gray-200 text-gray-500 dark:text-white/70 hover:text-white hover:bg-gray-500 hover:!border-gray-500 focus:ring-gray-200  dark:hover:bg-black/30 dark:!border-white/10 dark:hover:!border-white/20 dark:focus:ring-white/10 dark:focus:ring-offset-white/10 !mb-0">
                ...
                <div className="md:space-x-3 md:flex space-y-3 md:space-y-0 rtl:space-x-reverse">
                  <div className="inline-flex mr-2 rtl:ml-2">
                    <div
                  ...
                  <div className="hs-dropdown ti-dropdown">
                    ...
                    <div aria-labelledby="hs-dropdown-transform-style" data-hs-transition className="hs-dropdown-menu hidden z-10 hs-dropdown-open:ease-in hs-dropdown-open:opacity-100 hs-dropdown-open:scale-100 transition ease-out scale-95 duration-200 origin-top-left ti-dropdown-menu">
                      <Link className="ti-dropdown-item" href="#!" scroll={false} > All Invoices </Link>
                      <Link className="ti-dropdown-item" href="#!" scroll={false} > Paid Invoices </Link>
                      <Link className="ti-dropdown-item" href="#!" scroll={false} > Unpaid Invoices </Link>
                      <Link className="ti-dropdown-item" href="#!" scroll={false} > Draft Invoices </Link>
                      <Link className="ti-dropdown-item" href="#!" scroll={false} > Overdue Invoices </Link>
                    </div>
                  </div>
                </div>
              </div>
              <div className="mt-5 table-bordered rounded-sm ti-custom-table-head overflow-auto xxxl:overflow-hidden">
                <table className="ti-custom-table ti-custom-table-head edit-table whitespace-nowrap text-center">
                  <thead className="bg-gray-50 dark:bg-black/20">
                    <tr className="cart-box">
                      <th scope="col" className="dark:text-white/70">S.No:</th>
              ...
              <nav className="flex justify-end items-center space-x-2 rtl:space-x-reverse mt-5">
                <Link className="w-10 h-10 bg-white dark:bg-black/20 text-gray-500 hover:bg-primary hover:text-white p-2 inline-flex justify-center text-sm font-medium items-center gap-2 rounded-full" href="#!" scroll={false} >
                ...
                <Link className="w-10 h-10 bg-white dark:bg-black/20 text-gray-500 hover:bg-primary hover:text-white p-2 inline-flex justify-center items-center text-sm font-medium rounded-full" href="#!" scroll={false} >2</Link>
                <Link className="w-10 h-10 bg-white dark:bg-black/20 text-gray-500 hover:bg-primary hover:text-white p-2 inline-flex justify-center items-center text-sm font-medium rounded-full" href="#!" scroll={false} >3</Link>
                <Link className="w-10 h-10 bg-white dark:bg-black/20 text-gray-500 hover:bg-primary hover:text-white p-2 inline-flex justify-center text-sm font-medium items-center gap-2 rounded-full" href="#!" scroll={false} >
      ...
      <div id="invoice-modal" className="hs-overlay hidden ti-modal">
        <div className="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out sm:!max-w-6xl">
          <div className="ti-modal-content">
            <div className="ti-modal-header">
              <h3 className="ti-modal-title invoice-title">
                Create Invoice
              </h3>
            ...
            <div className="ti-modal-body p-6">
              <div className="flex flex-col md:flex-row space-y-6 justify-between mb-5">
                ...
                <div className="space-y-2 text-end inline-block">
                  <h3 className="text-2xl text-primary uppercase font-semibold">Invoice</h3>
                  <input type="text" className="invoice-id ti-form-input md:w-72 inline-block text-end" placeholder="Invoice Id" />
                  <div className="mt-1 flex"><input type="text" className="create-date ti-form-input md:w-72 text-end sm:ltr:ml-3 sm:rtl:mr-3 flatpickr-input invoice-date font-normal" placeholder="created date" /></div>
                  <div className="mt-1 flex"><input type="text" className="due-date ti-form-input md:w-72 text-end sm:ltr:ml-3 sm:rtl:mr-3 flatpickr-input invoice-date font-normal" placeholder="Due Date" /></div>
                </div>
              </div>
              <hr className="pb-5 dark:border-t-white/10" />
              <div className="grid grid-cols-12 gap-6 mb-5">
              ...
              <div className="grid grid-cols-12 gap-6 mb-5 invoice-pay">
                <div className="lg:col-span-6 col-span-12 max-w-xs">
                  <div className="space-y-3">
                    <select className="ti-form-select" data-trigger>
