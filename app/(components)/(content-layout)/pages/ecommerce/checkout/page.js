"use client"
import { AddressType, AvailabileTime, OrderSummery } from "@/shared/data/pages/ecommerce/checkoutdata";
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12 xxl:col-span-9">
							...
							<div className="sm:grid grid-cols-12 gap-6 text-center space-y-4 sm:space-y-0">
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/1.png"} alt="payment-img"
								...
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/2.png"} alt="payment-img"
													className="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto" />
											</span>
								...
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/3.png"} alt="payment-img"
													className="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto" />
											</span>
								...
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/4.png"} alt="payment-img"
													className="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto" />
											</span>
								...
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/5.png"} alt="payment-img"
													className="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto" />
											</span>
								...
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/6.png"} alt="payment-img"
													className="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto" />
											</span>
								...
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/7.png"} alt="payment-img"
													className="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto" />
											</span>
								...
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/8.png"} alt="payment-img"
													className="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto" />
											</span>
								...
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/9.png"} alt="payment-img"
													className="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto" />
											</span>
								...
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/10.png"} alt="payment-img"
													className="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto" />
											</span>
								...
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/11.png"} alt="payment-img"
													className="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto" />
											</span>
								...
								<div className="col-span-12 md:col-span-2">
									<label className="payment-box">
										...
										<span className="payment-sec">
											<span className="block">
												<img src={"../../../assets/img/payment-cards/12.png"} alt="payment-img"
													className="avatar avatar-lg shadow-none !ring-transparent rounded-sm mx-auto" />
											</span>
					...
					<div className="flex justify-between mb-6">
						<Link href={"/pages/ecommerce/cart"} className="ti-btn ti-btn-secondary m-0"><i className="ri-arrow-left-line"></i> Back to cart</Link>
						<Link href={"/pages/ecommerce/order-details/"} className="ti-btn ti-btn-primary  m-0">Place Order<i className="ri-arrow-right-line"></i></Link>
					</div>
				</div>
						...
						<div className="box-body px-0 space-y-5">
							{allData.map((idx) => (
								<div key={Math.random()} className="flex flex-row justify-between border-b pb-5 px-6 border-gray-200 dark:border-white/10">
									...
									<div className="">
										<Link aria-label="anchor" href="#!" scroll={false} className="ti-btn text-xs font-medium rounded-sm p-1 transition-none focus:outline-none ti-btn-soft-danger" onClick={() => handleRemove(idx.id)}>
											<i className="ti ti-trash"></i>
										</Link>
									</div>
								</div>
						...
						<div className="ti-modal-body">
							...
							<div className="grid lg:grid-cols-2 gap-6">
								<div className="space-y-2">
									...
									<Select className=" billing-search2" classNamePrefix='react-select' options={AddressType} placeholder='Select One' />
								</div>
								<div className="space-y-2">
									<label className="ti-form-label mb-0">Available Timings</label>
									<Select className=" billing-search2" classNamePrefix='react-select' options={AvailabileTime} placeholder='Select One' />
								</div>
								<div className="space-y-2">
					...
					<div className="ti-modal-content">
						<div className="ti-modal-body !p-6">
							<div className="checkout-payment-success">
								<div className="mb-5">
									<img src={"../../../assets/img/png-images/13.png"} alt="" className="mx-auto" />
								</div>
								<div className="text-center">
									...
									<a href={"/pages/ecommerce/order-details"} className="ti-btn ti-btn-secondary mt-4">Track Your Order</a>
								</div>
							</div>
						</div>
					</div>
