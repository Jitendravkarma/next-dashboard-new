...
import { Availability, Brand, Category, Color, Gender, ProductStatus, ProductVisibility, Size } from "@/shared/data/pages/ecommerce/addproductsdata";
import Link from "next/link";
import dynamic from "next/dynamic";
import Seo from "@/shared/layout-components/seo/seo";
import enGB from "date-fns/locale/en-GB";
import Editor1 from "@/shared/data/pages/blogs/editordata2";

registerPlugin(FilePondPluginImagePreview, FilePondPluginImageExifOrientation); 0;
				...
				<div className="col-span-12">
					<div className="box !bg-transparent border-0 shadow-none">
												...
												<div className="col-span-12 lg:col-span-6">
													<div className="space-y-2  product-1">
														...
														<div className="flex rounded-sm shadow-sm">
															...
															<DatePicker
																className="ti-form-input published-datepicker rounded-l-none focus:z-10"
																selected={startDate}
						...
						<div className="box-footer text-end border-t-0 px-0">
							<Link href={"/pages/ecommerce/add-products/"} className="ti-btn ti-btn-primary"><i className="ri-add-line"></i>Add Product</Link>
							<Link href='#' className="ti-btn ti-btn-secondary"><i className="ri-file-download-line"></i>Save Product</Link>
