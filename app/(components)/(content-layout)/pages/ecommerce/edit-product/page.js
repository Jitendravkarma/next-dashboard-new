...
import { Availability, Brand, Category, Color, Gender, ProductStatus, ProductVisibility, Size } from "@/shared/data/pages/ecommerce/editproductsdata";
...
const Editproducts = () => {
	...
	const [files, setFiles] = useState([]);  //React filepond
				...
				<div className="col-span-12">
					<div className="box !bg-transparent border-0 shadow-none">
									...
									<div className="box">
										<div className="box-body space-y-3">
											<div className="grid grid-cols-12 gap-4">
												...
												<div className="col-span-12 lg:col-span-6">
													<div className="space-y-2  product-1 published-date">
														...
														<div className="flex rounded-sm shadow-sm">
															...
															<DatePicker className="ti-form-input rounded-l-none rtl:rounded-l-sm rtl:rounded-r-none focus:z-10" selected={startDate} onChange={(date) => setStartDate(date)} showTimeSelect timeFormat="p" timeIntervals={15} dateFormat="Pp" />
														</div>
													</div>
												</div>
												<div className="col-span-12 lg:col-span-6">
												...
												<div className="col-span-12 lg:col-span-6">
													<div className="space-y-2">
														...
														<Select className="" options={Color} classNamePrefix="react-select" placeholder='Availabilty' />
													</div>
												</div>
												<div className="col-span-12 lg:col-span-6">
													<div className="space-y-2  product-1">
											...
											<div className="space-y-2">
												...
												<TagsInput
													//  className="ti-form-input product-tags custom classNameName"
													value={selected} onChange={setSelected} name="ProductTag" placeHolder="Product Tags" />
											</div>
										</div>
									</div>
								</div>
						...
						<div className="box-footer text-end border-t-0 px-0">
							<Link href={"/pages/ecommerce/products/"} className="ti-btn ti-btn-primary"><i className="ri-refresh-line"></i>update Product</Link>
							<Link href='#' className="ti-btn ti-btn-danger"><i className="ri-delete-bin-line"></i>Discard Product</Link>
						</div>
					</div>
				</div>
			</div>
