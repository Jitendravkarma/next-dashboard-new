		...
		<Fragment>
					...
					<div className="box">
						<div className="box-header">
							<div className="sm:flex flex-wrap justify-between">
								...
								<Link href={"/pages/invoice/invoice-details/"} className="ti-btn ti-btn-primary"><i className="ri ri-download-2-fill ltr:mr-1 rtl:ml-1"></i> Invoice</Link>
							</div>
						</div>
										...
										<div className="box-body p-0 space-y-2">
											...
											<div className="flex flex-col">
												<div
													...
													<img src={"../../../assets/img/payment-cards/5.png"} className="avatar !ring-transparent" alt="Image Description" />
													<div>
								...
								<table className="ti-custom-table ti-custom-table-head">
									...
									<tbody>
										<tr>
											...
											<td><Link href="#!" scroll={false} >#1218153635</Link></td>
											<td><Link className="badge bg-red-100 text-red-800" href="#!" scroll={false} >Packed</Link></td>
											<td>30 Nov 2022</td>
											<td>$999</td>
											<td>1</td>
											<td>$699</td>
										...
										<tr>
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse w-[290px]">
													<img className="avatar avatar-lg rounded-sm bg-gray-100 dark:bg-black/20 p-1"
														src={"../../../assets/img/ecommerce/products/7.png"} alt="Image Description" />
													<div>
											...
											<td><Link href="#!" scroll={false} >#1218153635</Link></td>
											<td><Link className="badge bg-sky-100 text-sky-800" href="#!" scroll={false} >Shipped</Link></td>
											<td>30 Nov 2022</td>
											<td>$699</td>
											<td>2</td>
											<td>$1,198</td>
										...
										<tr>
											<td>
												<div className="flex space-x-3 rtl:space-x-reverse w-[290px]">
													...
													<div>
														<p className="block text-sm font-semibold text-gray-800 dark:text-white truncate">Leather Wallet For girls</p>
														<span className="block text-sm text-gray-600 dark:text-white/70">White Color</span>
													</div>
												</div>
											</td>
											<td><Link href="#!" scroll={false} >#1218153635</Link></td>
											<td><Link className="badge bg-yellow-100 text-yellow-800" href="#!" scroll={false} >Out for Delivery</Link></td>
											<td>30 Nov 2022</td>
											<td>$150</td>
											<td>5</td>
											<td>$500</td>
										...
										<tr>
											...
											<td><Link href="#!" scroll={false} >#1218153635</Link></td>
											<td><Link className="badge bg-green-100 text-green-800" href="#!" scroll={false} >Delivered</Link></td>
											<td>30 Nov 2022</td>
											<td>$299</td>
											<td>1</td>
											<td>$199</td>
			...
			<div className="grid grid-cols-12 gap-6">
									...
									<div className="hs-accordion active" id="order-heading-one">
										...
										<div id="order-collapse-one"
											...
											<div className="text-xs">
												<p className="mb-0">Order placed successfully by <Link href="#!" scroll={false}
				...
				<div className="col-span-12 xxl:!col-span-5 md:col-span-6">
					<div className="box">
						<div className="box-header">
							<h5 className="box-title">Payment Summary</h5>
						</div>
						<div className="box-body">
						...
						<div className="box-footer">
							<Link href="#!" scroll={false} className="ti-btn ti-btn-primary w-full p-2">Cancel Order</Link>
						</div>
					</div>
				</div>
