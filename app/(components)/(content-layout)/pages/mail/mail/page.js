...
const Mail = () => {
  ...
  const Handleclickr = () => {
    document.querySelector(".fullscreen-data")?.classList.toggle("mail-fullscreen");
  };
  ...
  return (
    <div>
        ...
        <div className="col-span-12 xl:col-span-4 xxl:!col-span-3">
          <div className="box">
            <div className="box-header bg-transparent">
              <Link href="#!" scroll={false} className="hs-dropdown-toggle py-2 px-3 ti-btn ti-btn-primary w-full" data-hs-overlay="#mail-compose">
            ...
            <div className="box-body">
              <ul>
                ...
                <li className="py-2 mb-1 justify-between text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-sm font-normal">
                  <Link href="#!" scroll={false} className="hs-collapse-toggle inline-flex justify-center items-center gap-2 rounded-sm border border-transparent transition-all text-sm" id="more" data-hs-collapse="#more-heading">
              ...
              <ul>
                <li>
                  <Link href="#!" scroll={false} className="p-2 mb-1 flex justify-between text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-sm font-normal dark:hover:bg-black/20">
                    <div className="flex space-x-3 rtl:space-x-reverse">
              ...
              <ul>
                <li>
                  <Link href="#!" scroll={false} className="p-2 mb-1 flex justify-between text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-sm font-normal hover:bg-gray-200 dark:hover:bg-black/20">
                    <div className="flex space-x-3 rtl:space-x-reverse">
              ...
              <ul>
                <li>
                  <Link href="#!" scroll={false} className="py-2 mb-1 flex justify-between text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-sm font-normal">
                    <div className="flex space-x-3 rtl:space-x-reverse overflow-auto">
                      <div className="relative">
                        <img className="avatar avatar-xs ring-0 rounded-full" src={"../../../assets/img/users/4.jpg"} alt="avatar" />
                        <span className="online"></span>
                      </div>
                      <div>
                        <p className="text-slate-700 font-semibold text-xs dark:text-white my-auto">Katherina Kat</p>
                        <p className="text-xs xxxl:max-w-[250px] max-w-[170px] truncate">Hi! Some quick example text to build</p>
                      </div>
                    </div>
                  </Link>
                </li>
                  ...
                  <Link href="#!" scroll={false} className="py-2 mb-1 flex justify-between text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-sm font-normal">
                    <div className="flex space-x-3 rtl:space-x-reverse overflow-auto">
                      <div className="relative flex-none">
                        <img className="avatar avatar-xs ring-0 rounded-full" src={"../../../assets/img/users/11.jpg"} alt="avatar" />
                        <span className="online"></span>
                      </div>
                      <div>
                        <p className="text-slate-700 font-semibold text-xs dark:text-white my-auto">Benz Makit</p>
                        <p className="text-xs xxxl:max-w-[250px] max-w-[170px] truncate">😎Hi! Kasd voluptua labore et justo ea 👏</p>
                      </div>
                    </div>
                  </Link>
                </li>
            ...
            <div className="box main-inbox">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex mail-option space-x-5 rtl:space-x-reverse">
                    ...
                    <div className="hs-tooltip ti-main-tooltip">
                      <Link href="#!" scroll={false} className="hs-tooltip-toggle text-lg leading-none text-gray-500 dark:text-white/70">
                    ...
                    <div className="hs-dropdown ti-dropdown hs-tooltip ti-main-tooltip">
                      <Link href="#!" scroll={false} className="hs-tooltip-toggle text-lg leading-none text-gray-500 dark:text-white/70" id="snooze-drop2">
                  ...
                  <div className="flex space-x-4 rtl:space-x-reverse">
                    ...
                    <div className="hs-tooltip ti-main-tooltip">
                      <Link href="#!" scroll={false} className="hs-tooltip-toggle text-lg leading-none text-gray-500 dark:text-white/70 opacity-60 flex">
                    ...
                    <div className="hs-tooltip ti-main-tooltip">
                      <Link href="#!" scroll={false} className="hs-tooltip-toggle text-lg leading-none text-gray-500 dark:text-white/70 flex">
                    ...
                    <tbody>
                      <tr onClick={handleClick} className="mail-list bg-gray-100 hover:bg-gray-100 dark:bg-black/20 dark:hover:bg-black/20">
                        ...
                        <td className="!px-3 relative">
                          <Link aria-label="anchor" className="mail-link before:absolute before:inset-x-0 before:top-0 before:bottom-0 before:z-1" href="#!" scroll={false} ></Link>
                          <div className="flex space-x-3 rtl:space-x-reverse">
                            <img className="avatar avatar-xs ring-0 rounded-full" src={"../../../assets/img/users/1.jpg"} alt="avatar" />
                        ...
                        <td className="!px-3 w-44">
                          ...
                          <div className="icons-mail">
                            <div className="flex justify-end items-center space-x-4 rtl:space-x-reverse">
                              <div className="hs-tooltip ti-main-tooltip">
                                <Link href="#!" scroll={false} className="hs-tooltip-toggle text-base text-gray-500 dark:text-white/70">
                      ...
                      <tr onClick={handleClick} className="mail-list bg-gray-100 hover:bg-gray-100 dark:bg-black/20 dark:hover:bg-black/20">
                        ...
                        <td className="!px-3 relative">
                          <Link aria-label="anchor" className="mail-link before:absolute before:inset-x-0 before:top-0 before:bottom-0 before:z-1" href="#!" scroll={false} ></Link>
                          <div className="flex space-x-3 rtl:space-x-reverse">
                            <img className="avatar avatar-xs ring-0 rounded-full" src={"../../../assets/img/users/2.jpg"} alt="avatar" />
                            <p className="text-slate-700 font-semibold text-sm dark:text-white my-auto">
                              Socrates Itumay
                            </p>
                          </div>
                      ...
                      <tr onClick={handleClick} className="mail-list hover:bg-gray-100 dark:hover:bg-black/20">
                        ...
                        <td className="!px-3 relative">
                          <Link aria-label="anchor" className="mail-link before:absolute before:inset-x-0 before:top-0 before:bottom-0 before:z-1" href="#!" scroll={false} ></Link>
                          <div className="flex space-x-3 rtl:space-x-reverse">
                            <img className="avatar avatar-xs ring-0 rounded-full" src={"../../../assets/img/users/3.jpg"} alt="avatar" />
                            <p className="text-slate-700 font-semibold text-sm dark:text-white my-auto">
                              Wiley Waites
                            </p>
                          </div>
                      ...
                      <tr onClick={handleClick} className="mail-list hover:bg-gray-100 dark:hover:bg-black/20">
                        ...
                        <td className="!px-3 relative">
                          <Link aria-label="anchor" className="mail-link before:absolute before:inset-x-0 before:top-0 before:bottom-0 before:z-1" href="#!" scroll={false} ></Link>
                          <div className="flex space-x-3 rtl:space-x-reverse">
                            <img className="avatar avatar-xs ring-0 rounded-full" src={"../../../assets/img/users/5.jpg"} alt="avatar" />
                            <p className="text-slate-700 font-semibold text-sm dark:text-white my-auto">
                              Willie Makit
                            </p>
                          </div>
                      ...
                      <tr onClick={handleClick} className="mail-list hover:bg-gray-100 dark:hover:bg-black/20">
                        ...
                        <td className="!px-3 relative">
                          <Link aria-label="anchor" className="mail-link before:absolute before:inset-x-0 before:top-0 before:bottom-0 before:z-1" href="#!" scroll={false} ></Link>
                          <div className="flex space-x-3 rtl:space-x-reverse">
                            <img className="avatar avatar-xs ring-0 rounded-full" src={"../../../assets/img/users/6.jpg"} alt="avatar" />
                            <p className="text-slate-700 font-semibold text-sm dark:text-white my-auto">
                              Katherina Kat
                            </p>
                          </div>
                      ...
                      <tr onClick={handleClick} className="mail-list bg-gray-100 hover:bg-gray-100 dark:bg-black/20 dark:hover:bg-black/20">
                        ...
                        <td className="!px-3 relative">
                          <Link aria-label="anchor" className="mail-link before:absolute before:inset-x-0 before:top-0 before:bottom-0 before:z-1" href="#!" scroll={false} ></Link>
                          <div className="flex space-x-3 rtl:space-x-reverse">
                            <img className="avatar avatar-xs ring-0 rounded-full" src={"../../../assets/img/users/12.jpg"} alt="avatar" />
                            <p className="text-slate-700 font-semibold text-sm dark:text-white my-auto">
                              Kat Itumay
                            </p>
                          </div>
                      ...
                      <tr onClick={handleClick} className="mail-list hover:bg-gray-100 dark:hover:bg-black/20">
                        ...
                        <td className="!px-3 relative">
                          <Link aria-label="anchor" className="mail-link before:absolute before:inset-x-0 before:top-0 before:bottom-0 before:z-1" href="#!" scroll={false} ></Link>
                          <div className="flex space-x-3 rtl:space-x-reverse">
                            <img className="avatar avatar-xs ring-0 rounded-full" src={"../../../assets/img/users/8.jpg"} alt="avatar" />
                            <p className="text-slate-700 font-semibold text-sm dark:text-white my-auto">
                              Wiley Dover
                            </p>
                          </div>
              ...
              <div className="box-footer bg-transparent">
                <nav className="flex justify-end items-center space-x-2 rtl:space-x-reverse">
                  <Link className="w-10 h-10 text-gray-500 dark:text-white/70 text-sm justify-center bg-gray-100 dark:bg-black/20 hover:text-primary p-2 inline-flex items-center gap-2 rounded-full" href="#!" scroll={false} >
                    <span aria-hidden="true">«</span>
                    <span className="sr-only">Previous</span>
                  </Link>
                  <Link className="w-10 h-10 bg-primary text-white p-2 inline-flex items-center text-sm justify-center font-medium rounded-full" href="#!" scroll={false} aria-current="page">1</Link>
                  <Link className="w-10 h-10 bg-gray-100 dark:bg-black/20 text-gray-500 dark:text-white/70 hover:text-primary p-2 inline-flex items-center text-sm justify-center font-medium rounded-full" href="#!" scroll={false} >2</Link>
                  <Link className="w-10 h-10 bg-gray-100 dark:bg-black/20 text-gray-500 dark:text-white/70 hover:text-primary p-2 inline-flex items-center text-sm justify-center font-medium rounded-full" href="#!" scroll={false} >3</Link>
                  <Link className="w-10 h-10 text-gray-500 dark:text-white/70 text-sm justify-center bg-gray-100 dark:bg-black/20 hover:text-primary p-2 inline-flex items-center gap-2 rounded-full" href="#!" scroll={false} >
            ...
            <div className="box mail-view">
              <div className="px-4 box-header bg-transparent">
                <div className="md:flex items-center justify-between">
                  <div className="sm:flex space-x-5 rtl:space-x-reverse">
                    <div className="sm:flex space-x-5 rtl:space-x-reverse">
                      <div className="hs-tooltip ti-main-tooltip">
                        <Link scroll={false} href="#!" onClick={handleBackClick} className="hs-tooltip-toggle text-lg text-gray-500 dark:text-white/70 mail-btn">
                      ...
                      <div className="hs-tooltip ti-main-tooltip">
                        <Link scroll={false} href="#!" className="hs-tooltip-toggle text-lg text-gray-500 dark:text-white/70">
                      ...
                      <div className="hs-dropdown ti-dropdown hs-tooltip ti-main-tooltip">
                        <Link scroll={false} href="#!" className="hs-tooltip-toggle text-lg text-gray-500 dark:text-white/70" id="snooze-drop1">
                          <i className="ri-time-line"></i>
                          <span className="hs-tooltip-content ti-main-tooltip-content py-1 px-2 bg-gray-900 text-xs font-medium text-white shadow-sm dark:bg-slate-700" role="tooltip" data-popper-placement="top">
                            Snooze
                          </span>
                      ...
                      <div className="hs-dropdown ti-dropdown hs-tooltip ti-main-tooltip">
                        <Link scroll={false} href="#!" className="hs-tooltip-toggle text-lg text-gray-500 dark:text-white/70" id="move-drop">
                      ...
                      <div className="hs-dropdown ti-dropdown hs-tooltip ti-main-tooltip">
                        <Link scroll={false} href="#!" className="hs-tooltip-toggle text-lg text-gray-500 dark:text-white/70" id="label-drop">
                        ...
                        <div className="hs-dropdown-menu ti-dropdown-menu"
                          ...
                          <div className="ti-dropdown-divider">
                            ...
                            <div className="relative flex items-start py-2 px-3 rounded-sm hover:bg-gray-100 dark:hover:bg-bodybg/20">
                              <div className="flex items-center h-5 mt-1">
                                <input id="mail-label" name="mail-label" type="checkbox" className="ti-form-checkbox" />
                              </div>
                              <label htmlFor="mail-label" className="ms-3.5 my-auto">
                            ...
                            <div className="relative flex items-start py-2 px-3 rounded-sm hover:bg-gray-100 dark:hover:bg-bodybg/20">
                              ...
                              <label htmlFor="mail-label2" className="ms-3.5 my-auto">
                            ...
                            <div className="relative flex items-start py-2 px-3 rounded-sm hover:bg-gray-100 dark:hover:bg-bodybg/20">
                              ...
                              <label htmlFor="mail-label3" className="ms-3.5 my-auto">
                            ...
                            <div className="relative flex items-start py-2 px-3 rounded-sm hover:bg-gray-100 dark:hover:bg-bodybg/20">
                              ...
                              <label htmlFor="mail-label4" className="ms-3.5 my-auto">
                  ...
                  <div className="flex space-x-5 rtl:space-x-reverse">
                    ...
                    <div className="opacity-60 text-gray-500 dark:text-white/70 leading-[0]">
                      <button aria-label="button" type="button" className="ti-btn p-0 m-0 focus:ring-0 focus:shadow-none focus:ring-offset-0">
                        <i className="ri ri-arrow-left-s-line leading-none text-lg"></i>
                      </button>
                    </div>
                    <div className=" text-gray-500 dark:text-white/70 leading-[0]">
                      <button aria-label="button" type="button" className="ti-btn p-0 m-0 focus:ring-0 focus:shadow-none focus:ring-offset-0">
                        <i className="ri ri-arrow-right-s-line leading-none text-lg"></i>
                      </button>
                    </div>
                  </div>
                </div>
              ...
              <div className="box-header border-b-0 pb-0 bg-transparent">
                <div className="sm:flex justify-between mb-3">
                  <div className="flex items-center space-x-4 rtl:space-x-reverse">
                    <div className="flex">
                      <img className="avatar avatar-lg ring-0 rounded-sm mail-img" src="../../../assets/img/users/1.jpg" alt="avatar" />
                    </div>
                    <div>
                ...
                <div className="sm:grid grid-cols-12 gap-6 sm:space-y-0 space-y-5">
                  <div className="col-span-12 xxl:col-span-2 md:col-span-4">
                    <div className="border dark:border-white/10 rounded-sm overflow-hidden">
                      <Link scroll={false} href="#!" className="p-3 relative block text-center">
                        <img src="../../../assets/img/gallery/3.jpg" className="rounded-sm w-full" alt="Image Description" />
                        <div className="mt-3 inline-flex">
                          <span>Download</span><i className="ri ri-download-2-line ms-3"></i>
                        </div>
                      </Link>
                    </div>
                  </div>
                  <div className="col-span-12 xxl:col-span-2 md:col-span-4">
                    <div className="border dark:border-white/10 rounded-sm overflow-hidden">
                      <Link scroll={false} href="#!" className="p-3 relative block text-center">
                        <img src="../../../assets/img/gallery/1.jpg" className="rounded-sm w-full" alt="Image Description" />
                        <div className="mt-3 inline-flex">
                          <span>Download</span><i className="ri ri-download-2-line ms-3"></i>
                        </div>
                      </Link>
                  ...
                  <div className="col-span-12 xxl:col-span-2 md:col-span-4">
                    <div className="border dark:border-white/10 rounded-sm overflow-hidden">
                      <Link scroll={false} href="#!" className="p-3 relative block text-center">
                        <img src="../../../assets/img/gallery/2.jpg" className="rounded-sm w-full" alt="Image Description" />
                        <div className="mt-3 inline-flex">
                          <span>Download</span><i className="ri ri-download-2-line ms-3"></i>
                        </div>
                      </Link>
              ...
              <div className="box-footer bg-transparent flex justify-between">
                <button type="submit" className="py-2 px-3 ti-btn ti-btn-primary">
                  <i className="ri ri-arrow-go-back-line me-2"></i>Reply
                </button>
                <button type="button" className="py-2 px-3 ti-btn ti-btn-danger">
                  <i className="ri ri-arrow-go-forward-line me-2"></i>Forward
                </button>
              </div>
            </div>
          )}
      ...
      <div id="mail-compose" className="hs-overlay hidden ti-modal fullscreen-data">
        <div className="hs-overlay-open:!mt-7 !mt-14 ease-out ti-modal-box">
          <div className="ti-modal-content">
            <div className="ti-modal-header">
              ...
              <div className="">
                <button onClick={() => Handleclickr()} aria-label="button" type="button" className="ti-modal-max-screen">
                  <i className="ri-fullscreen-line"></i>
                </button>
                <button onClick={() => Handleclickr()} aria-label="button" type="button" className="ti-modal-min-screen">
            ...
            <div className="ti-modal-body">
              <div className="space-y-3">
                ...
                <div className="rounded-sm shadow-sm hidden mail-cc">
                ...
                <div className="rounded-sm shadow-sm hidden mail-bcc">
            ...
            <div className="ti-modal-footer !block">
              <div className="sm:flex items-center justify-between">
                <div className="flex items-center space-x-1 rtl:space-x-reverse">
                  <Link aria-label="anchor" href="#!" scroll={false} className="text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-sm bg-gray-100 !px-3 !py-1 font-normal hover:bg-gray-300 focus:bg-gary-800 dark:bg-black/20 dark:hover:bg-bgdark"><i className="text-lg ri ri-attachment-2"></i></Link>
                  <Link aria-label="anchor" href="#!" scroll={false} className="text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-sm bg-gray-100 !px-3 !py-1 font-normal hover:bg-gray-300 focus:bg-gary-800 dark:bg-black/20 dark:hover:bg-bgdark"><i className="text-lg ri ri-links-line"></i></Link>
                  <Link aria-label="anchor" href="#!" scroll={false} className="text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-sm bg-gray-100 !px-3 !py-1 font-normal hover:bg-gray-300 focus:bg-gary-800 dark:bg-black/20 dark:hover:bg-bgdark"><i className="text-lg ri ri-image-line"></i></Link>
                  <Link aria-label="anchor" href="#!" scroll={false} className="text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-sm bg-gray-100 !px-3 !py-1 font-normal hover:bg-gray-300 focus:bg-gary-800 dark:bg-black/20 dark:hover:bg-bgdark"><i className="text-lg ri ri-printer-line"></i></Link>
                  <Link aria-label="anchor" href="#!" scroll={false} className="text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-sm bg-gray-100 !px-3 !py-1 font-normal hover:bg-gray-300 focus:bg-gary-800 dark:bg-black/20 dark:hover:bg-bgdark"><i className="text-lg ri ri-delete-bin-6-line"></i></Link>
                </div>
                <div className="">
                  <button type="submit" className="!py-2 !px-3 ti-btn ti-btn-primary ltr:float-right rtl:float-left">
                    Send
                  </button>
                  <button type="button" className="hs-dropdown-toggle ti-btn ti-border !border-gray-200 font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:ring-offset-white focus:ring-primary dark:bg-bgdark dark:hover:bg-black/20 dark:!border-white/10 dark:text-white/70 dark:hover:text-white dark:focus:ring-offset-white/10"
                    data-hs-overlay="#mail-compose">
                    Cancel
                  </button>
                </div>
