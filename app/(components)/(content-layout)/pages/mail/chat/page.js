...
const Chat = () => {
  ...
  const ResponsiveData = () => (
    document.querySelector(".chat-user-details")?.classList.toggle("open")
  )
            ...
            <div className="box-body px-0 pb-0">
              <div className="main-chat-content space-y-5">
                <div className="chat-active space-y-3 pb-6 px-6 border-b border-gray-200 dark:border-white/10">
                  ...
                  <Swiper breakpoints={breakpoints} slidesPerView={6} className="active-chat" pagination={{ clickable: true, }} autoplay={{ delay: 2500, disableOnInteraction: false, }}>
                    <div className="mySwiper6">
                      <SwiperSlide>
                        <Link className="relative inline-block" href="#!" scroll={false} >
                      ...
                      <SwiperSlide>
                        <Link className="relative inline-block" href="#!" scroll={false} >
                          <img className="avatar avatar-sm rounded-full" src={"../../../assets/img/users/3.jpg"} alt="Image Description" />
                          <span className="online"></span>
                        </Link>
                      </SwiperSlide>
                      <SwiperSlide>
                      ...
                      <SwiperSlide>
                        <Link className="relative inline-block" href="#!" scroll={false} >
                          <img className="avatar avatar-sm rounded-full" src={"../../../assets/img/users/19.jpg"} alt="Image Description" />
                          <span className="online"></span>
                        </Link>
                      </SwiperSlide>
                      <SwiperSlide>
                        <Link className="relative inline-block" href="#!" scroll={false} >
                          <img className="avatar avatar-sm rounded-full" src={"../../../assets/img/users/18.jpg"} alt="Image Description" />
                          <span className="online"></span>
                        </Link>
                      </SwiperSlide>
                      <SwiperSlide>
                        <Link className="relative inline-block" href="#!" scroll={false} >
                          <img className="avatar avatar-sm rounded-full" src={"../../../assets/img/users/17.jpg"} alt="Image Description" />
                          <span className="online"></span>
                        </Link>
                      </SwiperSlide>
                      <SwiperSlide>
                        <Link className="relative inline-block" href="#!" scroll={false} >
                          <img className="avatar avatar-sm rounded-full" src={"../../../assets/img/users/16.jpg"} alt="Image Description" />
                          <span className="online"></span>
                        </Link>
                      </SwiperSlide>
                      <SwiperSlide>
                        <Link className="relative inline-block" href="#!" scroll={false} >
                          <img className="avatar avatar-sm rounded-full" src={"../../../assets/img/users/15.jpg"} alt="Image Description" />
                          <span className="online"></span>
                        </Link>
                      </SwiperSlide>
                      <SwiperSlide>
                        <Link className="relative inline-block" href="#!" scroll={false} >
                          <img className="avatar avatar-sm rounded-full" src={"../../../assets/img/users/14.jpg"} alt="Image Description" />
                          <span className="online"></span>
                        </Link>
                      </SwiperSlide>
                      <SwiperSlide>
                        <Link className="relative inline-block" href="#!" scroll={false} >
                          <img className="avatar avatar-sm rounded-full" src={"../../../assets/img/users/13.jpg"} alt="Image Description" />
                          <span className="online"></span>
                        </Link>
                      </SwiperSlide>
                      <SwiperSlide>
                        <Link className="relative inline-block" href="#!" scroll={false} >
                          <img className="avatar avatar-sm rounded-full" src={"../../../assets/img/users/12.jpg"} alt="Image Description" />
                          <span className="online"></span>
                        </Link>
                      </SwiperSlide>
                    </div>
                  ...
                  <div className="ti-tab-content mt-3" id="messagelist">
                    <div id="messages-style-1" role="tabpanel" aria-labelledby="messages-1">
                      <ul className="flex flex-col divide-y divide-gray-200 dark:divide-white/10">
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(_e) => changeTheInfo({ name: 'Socrates Itumay 😄', img: '2', status: 'online' })}
                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <Link className="relative inline-block avatar avatar-sm rounded-full" href="#!" scroll={false} >
                                <img className="rounded-full" src={"../../../assets/img/users/2.jpg"}
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(_e) => changeTheInfo({ name: 'Eos Tempor 😄', img: '20', status: 'online' })}

                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <Link className="relative inline-block avatar avatar-sm rounded-full" href="#!" scroll={false} >
                                <img className="rounded-full" src={"../../../assets/img/users/20.jpg"}
                                  alt="Image Description" />
                                <span className="online"></span>
                              </Link>
                            </div>
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Et Kasd 😄', img: '15', status: 'online' })}
                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <Link className="relative inline-block avatar avatar-sm rounded-full" href="#!" scroll={false} >
                                <img className="rounded-full" src={"../../../assets/img/users/15.jpg"} alt="Image Description" />
                                <span className="online"></span>
                              </Link>
                            </div>
                            <div className="w-full">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Ipsum Et 😄', img: '18', status: 'offline' })}

                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <Link className="relative inline-block avatar avatar-sm rounded-full" href="#!" scroll={false} >
                                <img className="rounded-full" src={"../../../assets/img/users/18.jpg"} alt="Image Description" />
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Ut nonmuy 😄', img: '19', status: 'online' })}

                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <Link className="relative inline-block avatar avatar-sm rounded-full" href="#!" scroll={false} >
                                <img className="rounded-full" src={"../../../assets/img/users/19.jpg"} alt="Image Description" />
                                <span className="online"></span>
                              </Link>
                            </div>
                            <div className="w-full">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Dolor dilta 😄', img: '16', status: 'online' })}

                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <Link className="relative inline-block avatar avatar-sm rounded-full" href="#!" scroll={false} >
                                <img className="rounded-full" src={"../../../assets/img/users/16.jpg"} alt="Image Description" />
                                <span className="online"></span>
                              </Link>
                            </div>
                            <div className="w-full">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Voluptua Ipsum 😄', img: '13', status: 'offline' })}

                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <Link className="relative inline-block avatar avatar-sm rounded-full" href="#!" scroll={false} >
                                <img className="rounded-full" src={"../../../assets/img/users/13.jpg"} alt="Image Description" />
                                <span className="offline"></span>
                              </Link>
                            </div>
                            <div className="w-full">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Joan Powell 😄', img: '14', status: 'offline' })}

                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <Link className="relative inline-block avatar avatar-sm rounded-full" href="#!" scroll={false} >
                                <img className="rounded-full" src={"../../../assets/img/users/14.jpg"} alt="Image Description" />
                                <span className="offline"></span>
                              </Link>
                            </div>
                            <div className="w-full">
                    ...
                    <div id="messages-style-2" className="hidden" role="tabpanel" aria-labelledby="messages-2">
                      <ul className="flex flex-col divide-y divide-gray-200 dark:divide-white/10">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Anna Sthesia 😄', img: '2', status: 'online' })}
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Abraham Clark 😄', img: '20', status: 'online' })}

                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <img className="avatar avatar-xs rounded-full" src={"../../../assets/img/users/20.jpg"}
                                alt="Image Description" />
                            </div>
                            <div className="flex items-center justify-between w-full">
                              <div className="items-center">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Anderson 😄', img: '3', status: 'offline' })}
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Andren Vanhron 😄', img: '4', status: 'offline' })}
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Albert silver 😄', img: '16', status: 'offline' })}

                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <img className="avatar avatar-xs rounded-full" src={"../../../assets/img/users/16.jpg"} alt="Image Description" />
                            </div>
                            <div className="flex items-center justify-between w-full">
                              <div className="items-center">
                                <p className="text-slate-700 font-semibold text-sm dark:text-white">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Bernadette 😄', img: '5', status: 'online' })}
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Brenden Wanger 😄', img: '18', status: 'offline' })}
                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <img className="avatar avatar-xs rounded-full" src={"../../../assets/img/users/18.jpg"} alt="Image Description" />
                            </div>
                            <div className="flex items-center justify-between w-full">
                              <div className="items-center">
                                <p className="text-slate-700 font-semibold text-sm dark:text-white">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Bradely Greer 😄', img: '9', status: 'online' })}

                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <img className="avatar avatar-xs rounded-full" src={"../../../assets/img/users/9.jpg"}
                                alt="Image Description" />
                            </div>
                            <div className="flex items-center justify-between w-full">
                              <div className="items-center">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Bruno Nash 😄', img: '10', status: 'online' })}
                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <img className="avatar avatar-xs rounded-full" src={"../../../assets/img/users/10.jpg"}
                                alt="Image Description" />
                            </div>
                            <div className="flex items-center justify-between w-full">
                              <div className="items-center">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Caesar Vance 😄', img: '6', status: 'online' })}

                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <img className="avatar avatar-xs rounded-full" src={"../../../assets/img/users/6.jpg"}
                                alt="Image Description" />
                            </div>
                            <div className="flex items-center justify-between w-full">
                              <div className="items-center">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Cara Stevens 😄', img: '8', status: 'offline' })}

                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <img className="avatar avatar-xs rounded-full" src={"../../../assets/img/users/8.jpg"}
                                alt="Image Description" />
                            </div>
                            <div className="flex items-center justify-between w-full">
                              <div className="items-center">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Cedric Kelly 😄', img: '4', status: 'online' })}
                    ...
                    <div id="messages-style-3" className="hidden" role="tabpanel" aria-labelledby="messages-3">
                      <ul className="flex flex-col divide-y divide-gray-200 dark:divide-white/10">
                          ...
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            ...
                            <div className="flex items-center justify-between w-full">
                              ...
                              <div className="my-auto space-x-3 rtl:space-x-reverse">
                                <i className="text-base text-gray-500 dark:text-white/70 ti ti-phone-call inline-flex"></i>
                                <i className="text-base text-gray-500 dark:text-white/70 ti ti-video inline-flex"></i>
                              </div>
                            </div>
                          </div>
                        </li>
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Socrates Itumy 😄', img: '5', status: 'online' })}
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Cedric Kelly 😄', img: '20', status: 'online' })}
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Tiger Nixon 😄', img: '5', status: 'offline' })}
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Tatyana Fitzpatrick 😄', img: '9', status: 'online' })}
                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <img className="avatar avatar-xs rounded-full" src={"../../../assets/img/users/9.jpg"}
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Unity Bulter 😄', img: '10', status: 'online' })}
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Thor Walton 😄', img: '11', status: 'offlne' })}
                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                        ...
                        <li className="ti-list-group border-0 text-gray-800 dark:text-white relative checkforactive">
                          <Link aria-label="anchor" className="before:absolute before:inset-0 before:z-1" href="#!" scroll={false}
                            onClick={(e) => changeTheInfo({ name: 'Abraham Clark 😄', img: '6', status: 'offline' })}
                          ></Link>
                          <div className="flex items-center space-x-3 rtl:space-x-reverse w-full">
                            <div className="flex">
                              <img className="avatar avatar-xs rounded-full" src={"../../../assets/img/users/6.jpg"}
            ...
            <div className="box-header bg-transparent">
              <div className="sm:flex justify-between">
                <div className="flex items-center space-x-4 rtl:space-x-reverse">
                  <div className="flex">
                    <Link className="relative inline-block" href="#!" scroll={false} >
                      <img className="avatar avatar-sm rounded-full chatimageperson" src={"../../../assets/img/users/2.jpg"}
                        alt="Image Description" />
                  ...
                  <div>
                    <p className="text-base">
                      <Link href="#!" scroll={false} className="chatnameperson responsive-userinfo-open">Airi Satou</Link>
                    </p>
                ...
                <div className="flex my-auto main-chat-right-icons mt-5 sm:mt-auto flex-wrap">
                  ...
                  <Link aria-label="anchor" className="ti-btn ti-btn-outline !rounded-full !p-2 !border-gray-200 text-gray-500 dark:text-white/70 hover:text-gray-700 hover:bg-gray-100 hover:!border-gray-200 focus:ring-gray-200  dark:hover:bg-black/30 dark:!border-white/10 dark:hover:!border-white/20 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
                    href="#!" scroll={false} ><i className="text-base leading-none ti ti-phone-call"></i></Link>
                  <Link aria-label="anchor" className="ti-btn ti-btn-outline !rounded-full !p-2 !border-gray-200 text-gray-500 dark:text-white/70 hover:text-gray-700 hover:bg-gray-100 hover:!border-gray-200 focus:ring-gray-200  dark:hover:bg-black/30 dark:!border-white/10 dark:hover:!border-white/20 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
                    href="#!" scroll={false} ><i className="text-base leading-none ti ti-video"></i></Link>
                  <Link aria-label="anchor" className="ti-btn ti-btn-outline !rounded-full !p-2 !border-gray-200 text-gray-500 dark:text-white/70 hover:text-gray-700 hover:bg-gray-100 hover:!border-gray-200 focus:ring-gray-200  dark:hover:bg-black/30 dark:!border-white/10 dark:hover:!border-white/20 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
                    href="#!" scroll={false} ><i className="text-base leading-none ti ti-user-plus"></i></Link>
                  <Link aria-label="anchor" onClick={ResponsiveData} className="ti-btn ti-btn-outline !rounded-full !p-2 !border-gray-200 text-gray-500 dark:text-white/70 hover:text-gray-700 hover:bg-gray-100 hover:!border-gray-200 focus:ring-gray-200  dark:hover:bg-black/30 dark:!border-white/10 dark:hover:!border-white/20 dark:focus:ring-white/10 dark:focus:ring-offset-white/10 responsive-userinfo-open"
                    href="#!" scroll={false} ><i className="text-base leading-none ti ti-user-circle"
                  ...
                  <div className="hs-dropdown ti-dropdown block ltr:mr-1 rtl:ml-1 my-auto">
                    ...
                    <div className="hs-dropdown-menu ti-dropdown-menu" aria-labelledby="hs-dropdown-custom-icon-trigger">
                      <Link className="ti-dropdown-item" href="#!" scroll={false} ><i
                  ...
                  <Link aria-label="anchor" onClick={ResponsiveData1} className="responsive-chat-close ti-btn ti-btn-outline rounded-full p-2 border-gray-200 text-gray-400 dark:text-white/70 hover:text-white hover:bg-gray-500 hover:border-gray-200 focus:ring-gray-200  dark:hover:bg-black/30 dark:border-white/10 dark:hover:border-white/20 dark:focus:ring-white/10 dark:focus:ring-offset-white/10"
                    href="#!" scroll={false} ><i className="text-base leading-none ti ti-x"></i></Link>
                </div>
              </div>
            </div>
            <div className="main-chat-content2 chat-content">
              <img className="w-full h-full rounded-sm opacity-10" src={"../../../assets/img/png-images/1.png"}
                alt="Image Description" />
              <div className="absolute top-0 inset-x-0">
                <div id="chatlist" onClick={ResponsiveData}>
                  <div className="box-body p-8">
                    ...
                    <div className="chat-left">
                      <img src={"../../../assets/img/users/2.jpg"} className="chatimageperson avatar rounded-full"
                        alt="Image Description" />
                    ...
                    <div className="chat-right">
                      ...
                      <img src={"../../../assets/img/users/1.jpg"} className="avatar rounded-full" alt="Image Description" />
                    </div>
                    <div className="chat-left">
                      <img src={"../../../assets/img/users/2.jpg"} className="chatimageperson avatar rounded-full"
                        alt="Image Description" />
                      <div className="flex flex-col items-start space-y-2">
                        ...
                        <div className="chat-inner-msg space-y-1">
                          <div
                            ...
                            <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn p-0"><i className="ri ri-play-circle-line"></i></Link>
                            ...
                            <Link aria-label="anchor" href="#!" scroll={false} className="ti-btn p-0"><i className="ri ri-download-2-line"></i></Link>
                          </div>
                          <p className="text-start text-xs text-gray-500 dark:text-white/70">
                            08:50 AM
                          </p>
                    ...
                    <div className="chat-right">
                      <div className="flex flex-col items-end space-y-2">
                        ...
                        <div className="chat-inner-msg flex space-y-1 space-x-3 rtl:space-x-reverse">
                          <img src={"../../../assets/img/gallery/3.jpg"} className="w-1/4 rounded-sm ltr:ml-auto rtl:mr-auto"
                            alt="Image Description" />
                          <img src={"../../../assets/img/gallery/1.jpg"} className="w-1/4 rounded-sm ltr:ml-auto rtl:mr-auto"
                            alt="Image Description" />
                          <img src={"../../../assets/img/gallery/4.jpg"} className="w-1/4 rounded-sm ltr:ml-auto rtl:mr-auto"
                            alt="Image Description" />
                        </div>
                        <p className="text-end text-xs text-gray-500 dark:text-white/70">
                          10:35 AM
            ...
            <div className="box-footer">
              <div className="flex items-center space-x-3 rtl:space-x-reverse">
                <div className="hidden sm:flex">
                  <Link aria-label="anchor" className="ti-btn px-1 py-1 text-gray-500 bg-gray-100 focus:ring-gray-500 dark:text-white/70 dark:bg-bodybg dark:hover:bg-black/20 dark:hover:text-gray-300 dark:focus:ring-offset-white/10"
                    href="#!" scroll={false} ><i className="text-xl ti ti-paperclip"></i></Link>
                  <Link aria-label="anchor" className="ti-btn px-1 py-1 text-gray-500 bg-gray-100 focus:ring-gray-500 dark:text-white/70 dark:bg-bodybg dark:hover:bg-black/20 dark:hover:text-gray-300 dark:focus:ring-offset-white/10"
                    href="#!" scroll={false} ><i className="text-xl ti ti-mood-smile"></i></Link>
                </div>
                ...
                <div className="flex">
                  <Link aria-label="anchor" className="hidden sm:block ti-btn px-1 py-1 text-gray-500 bg-gray-100 focus:ring-gray-500 dark:bg-bodybg dark:text-white/70 dark:hover:bg-black/20 dark:hover:text-gray-300 dark:focus:ring-offset-white/10"
                    href="#!" scroll={false} ><i className="text-xl ti ti-microphone"></i></Link>
                  <Link aria-label="anchor" className="ti-btn px-1 py-1 ti-btn-primary" href="#!" scroll={false} ><i
                  ...
                  <div className="space-y-4">
                    <div className="text-center space-y-2">
                      <div className="flex justify-center">
                        <Link className="relative inline-block" href="#!" scroll={false} >
                          <img className="w-24 h-24 rounded-full chatimageperson" src={"../../../assets/img/users/2.jpg"}
                            alt="Image Description" />
                    ...
                    <div className="flex sm:space-x-3 justify-center text-center rtl:space-x-reverse space-x-1">
                      <div className="block">
                      ...
                      <div className="border p-3 rounded-sm border-gray-200 dark:border-white/10">
                        <div id="chat-gallery-1" role="tabpanel" aria-labelledby="chat-gallery-item-1">
                          <div className="grid grid-cols-3 gap-6">
                            <Link href="#!" scroll={false} className="inner">
                            ...
                            <li
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                <div className="space-x-2">
                                  <Link aria-label="anchor" href="#!" scroll={false} ><span><i
