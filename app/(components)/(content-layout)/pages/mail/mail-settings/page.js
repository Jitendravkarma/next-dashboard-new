"use client"
import { ProfileService } from "@/shared/data/pages/contactdata";
import { DateFormat, LanguageData, MarkAsRead, Refresh, ReturnReceipt, RowPage, TimeFormat, TimeZoneData } from "@/shared/data/pages/mail/mailsettingdata";
...
const Mailsettings = () => {
  ...
  useEffect(() => {
    ...
    contactItem.forEach((ele => {
      ele.addEventListener("click", () => { setClassName("main-content-body-show"); });
    }));
            ...
            <div className="box">
              ...
              <div className="box-body">
                ...
                <div id="mail-3" className="hidden" role="tabpanel" aria-labelledby="mail-item-3">
                  ...
                  <p className="text-gray-500 dark:text-white/70 mb-5 text-sm">Some quick example text to build on the card title and make up the bulk of the {`card's`} content.</p>
                  <div className="space-y-6">
                    <div className="sm:grid grid-cols-12 md:gap-6">
                      <div className="col-span-12 md:col-span-2 my-auto">
