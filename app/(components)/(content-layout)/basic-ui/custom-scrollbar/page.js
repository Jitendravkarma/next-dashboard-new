...
const CustomScrollbar = () => {
  ...
  return (
    <Fragment>
      ...
      <PageHeader currentpage="Custom-Scrollbar" activepage="Basic Ui" mainpage="Custom-Scrollbar" />
            ...
            <div className="box-body">
              <div className="max-h-[400px] space-y-4 pe-8 overflow-y-auto [&amp;::-webkit-scrollbar]:w-2 [&amp;::-webkit-scrollbar-track]:bg-gray-100 [&amp;::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&amp;::-webkit-scrollbar-track]:bg-slate-700 dark:[&amp;::-webkit-scrollbar-thumb]:bg-slate-500">
                <div>
                  ...
                  <p className="mt-1 text-sm leading-6 text-gray-400 dark:text-white/70">This is some placeholder content for the scrollspy page. Note that as you scroll down the page, the appropriate navigation link is highlighted. It's repeated throughout the component example. We keep adding some more example copy here to emphasize the scrolling and highlighting.</p>
                </div>
