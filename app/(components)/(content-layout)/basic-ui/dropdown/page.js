"use client"
import { dropdown } from "@/shared/data/basic-ui/dropdownsdata";
			...
			<div className="grid grid-cols-12 gap-x-6">
						...
						<div className="box-body">
							<div className="hs-dropdown ti-dropdown">
								<button id="hs-dropdown-custom-trigger" type="button"
									...
									<img className="ti-dropdowm-profileimg" src={"../../assets/img/users/1.jpg"} alt="Maria" />
					...
					<div className="box">
						...
						<div className="box-body">
							<div className="hs-dropdown ti-dropdown" data-hs-dropdown-auto-close="inside">
								<button id="hs-dropdown-item-checkbox1" type="button" className="hs-dropdown-toggle ti-dropdown-toggle"> Actions <svg className="hs-dropdown-open:rotate-180 ti-dropdown-caret" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M2 5L8.16086 10.6869C8.35239 10.8637 8.64761 10.8637 8.83914 10.6869L15 5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path> </svg> </button>
								<div className="hs-dropdown-menu ti-dropdown-menu" aria-labelledby="hs-dropdown-item-checkbox1" data-popper-placement="bottom-start" >
									<div className="relative flex items-start py-2 px-3 rounded-sm hover:bg-gray-100 dark:hover:bg-black/20">
										<div className="flex items-center h-5 mt-1">
											<input id="hs-dropdown-item-checkbox-delete" name="hs-dropdown-item-checkbox-delete" type="checkbox" className="ti-form-checkbox" aria-describedby="hs-dropdown-item-checkbox-delete-description" defaultChecked />
										</div>
										<label htmlFor="hs-dropdown-item-checkbox-delete" className="ms-3.5">
											<span className="block text-sm font-semibold text-gray-800 dark:text-white">Delete</span>
											<span id="hs-dropdown-item-checkbox-delete-description" className="block text-sm text-gray-600 dark:text-white/70">Notify me when this action happens.</span>
										</label>
									</div>
									<div className="relative flex items-start py-2 px-3 rounded-sm hover:bg-gray-100 dark:hover:bg-black/20">
										<div className="flex items-center h-5 mt-1">
											<input id="hs-dropdown-item-checkbox-archive1" name="hs-dropdown-item-checkbox-archive1" type="checkbox" className="ti-form-checkbox" aria-describedby="hs-dropdown-item-checkbox-archive-description" />
										</div>
										<label htmlFor="hs-dropdown-item-checkbox-archive1" className="ms-3.5">
											<span className="block text-sm font-semibold text-gray-800 dark:text-white">Archive</span>
											<span id="hs-dropdown-item-checkbox-archive-description" className="block text-sm text-gray-600 dark:text-white/70">Notify me when this action happens.</span>
										</label>
									</div>
								</div>
							</div>
				...
				<div className="col-span-12 lg:col-span-6  xl:!col-span-3">
					<div className="box">
						...
						<div className="box-body">
							<div className="hs-dropdown ti-dropdown" data-hs-dropdown-auto-close="inside">
								<button id="hs-dropdown-item-checkbox2" type="button" className="hs-dropdown-toggle ti-dropdown-toggle"> Actions
									<svg className="hs-dropdown-open:rotate-180 ti-dropdown-caret" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"> <path d="M2 5L8.16086 10.6869C8.35239 10.8637 8.64761 10.8637 8.83914 10.6869L15 5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path> </svg>
								</button>
								<div className="hs-dropdown-menu ti-dropdown-menu hidden" aria-labelledby="hs-dropdown-item-checkbox2">
									<div className="relative flex items-start py-2 px-3 rounded-sm hover:bg-gray-100 dark:hover:bg-black/20">
										<div className="flex items-center h-5 mt-1">
						...
						<div className="box-body">
							...
							<div className="ti-dropdown m-1">
								...
								<div className="hs-dropdown ti-dropdown [--placement:bottom-left]">
									<button id="hs-split-dropdown" type="button" className="hs-dropdown-toggle relative ltr:-ml-[.025rem] rtl:-mr-[.025rem] h-[2.875rem] w-[2.875rem] ltr:rounded-r-md rtl:rounded-l-md focus:z-10 ti-dropdown-toggle rounded-none">
						...
						<div className="box-body">
							...
							<div className="ti-dropdown m-1">
								...
								<div className="hs-dropdown ti-dropdown [--placement:left-top]">
									<button id="hs-split-dropleft" type="button" className="hs-dropdown-toggle relative ltr:-ml-[.025rem] rtl:-mr-[.025rem] h-[2.875rem] w-[2.875rem] ltr:rounded-r-md rtl:rounded-l-md focus:z-10 ti-dropdown-toggle rounded-none">
										<span className="sr-only">Toggle Dropdown</span>
										<svg className="w-auto h-2.5 text-gray-600" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M11 1L5.31305 7.16086C5.13625 7.35239 5.13625 7.64761 5.31305 7.83914L11 14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
										</svg>
					...
					<div className="box">
						...
						<div className="box-body">
							<div className="hs-dropdown ti-dropdown [--placement:right-top] m-1">
								<button id="hs-dropright" type="button" className="hs-dropdown-toggle ti-dropdown-toggle ltr:-ml-[.125rem] rtl:-mr-[.125rem]">
									Dropright
							...
							<div className="ti-dropdown m-1">
								...
								<div className="hs-dropdown ti-dropdown [--placement:right-top]">
									<button id="hs-split-dropright" type="button" className="hs-dropdown-toggle relative ti-dropdown-toggle rounded-none ltr:-ml-[.125rem] rtl:-mr-[.125rem] h-[2.875rem] w-[2.875rem] ltr:rounded-r-md rtl:rounded-l-md focus:z-10">
										<span className="sr-only">Toggle Dropdown</span>
										<svg className="w-auto h-2.5 ti-dropdown-caret " width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M5 1L10.6869 7.16086C10.8637 7.35239 10.8637 7.64761 10.6869 7.83914L5 14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
										</svg>
						...
						<div className="box-body">
							...
							<div className="ti-dropdown m-1">
								...
								<div className="hs-dropdown ti-dropdown [--placement:top-left]">
									<button id="hs-split-dropup" type="button" className="hs-dropdown-toggle relative ti-dropdown-toggle rounded-none ltr:-ml-[.125rem] rtl:-mr-[.125rem]  h-[2.875rem] w-[2.875rem] ltr:rounded-r-md rtl:rounded-l-md focus:z-10 ">
										<span className="sr-only">Toggle Dropdown</span>
										<svg className="hs-dropdown-open:rotate-180 ti-dropdown-caret" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
											<path d="M2 11L8.16086 5.31305C8.35239 5.13625 8.64761 5.13625 8.83914 5.31305L15 11" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
										</svg>
				...
				<div className="col-span-12 xl:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							{dropdown.map((idx) => (
								<div className="hs-dropdown ti-dropdown" key={Math.random()}>
									<button id="hs-dropdown-default7" type="button"
										className={`hs-dropdown-toggle ti-btn ti-btn-${idx.color} rounded-sm`}>
										Actions
							...
							{dropdown.map((idx) => (
								<div className="hs-dropdown ti-dropdown" key={Math.random()}>
									<button id="hs-dropdown-default8" type="button"
										className={`hs-dropdown-toggle ti-btn ti-btn-${idx.color} rounded-full`}>
										Actions
										<svg className="fill-white text-white hs-dropdown-open:rotate-180 ti-dropdown-caret" width="16"
											height="16" viewBox="0 0 16 16" fill="none"
											xmlns="http://www.w3.org/2000/svg">
				...
				<div className="col-span-12 xl:col-span-6">
					<div className="box">
						...
						<div className="box-body sm:space-x-2 rtl:space-x-reverse">
							<div className="hs-dropdown ti-dropdown">
				...
				<div className="col-span-12 xl:col-span-6">
					<div className="box">
						...
						<div className="box-body space-x-2 rtl:space-x-reverse">
							<div className="hs-dropdown ti-dropdown">
