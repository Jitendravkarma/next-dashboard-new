...
const Tooltipspopovers = () => {
	...
	return (
		<div>
			<Seo title={"Tooltip&Popover"} />
			<PageHeader currentpage="Tooltip & Popovers" activepage="Basic Ui" mainpage="Tooltip & Popovers" />
			<h6 className="text-base mb-4">Tooltips:</h6>
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12">
					<div className="box">
						<div className="box-header">
							<h5 className="box-title">Basic Tooltip </h5>
						</div>
						<div className="box-body">
							<div className="flex justify-center gap-4">
								<div className="hs-tooltip ti-main-tooltip">
									<button type="button" className="hs-tooltip-toggle w-10 h-10 ti-btn rounded-full p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white">
										<i className="ri-arrow-up-s-line"></i>
										<span className="hs-tooltip-content ti-main-tooltip-content py-1 px-2 bg-gray-900 text-xs font-medium text-white shadow-sm dark:bg-gray-900" role="tooltip">
											Tooltip on top
										</span>
									</button>
								</div>
								...
								<div className="hs-tooltip ti-main-tooltip [--placement:right]">
									<button type="button" className="hs-tooltip-toggle w-10 h-10 ti-btn rounded-full p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white">
								...
								<div className="hs-tooltip ti-main-tooltip [--placement:bottom]">
									<button type="button" className="hs-tooltip-toggle w-10 h-10 ti-btn rounded-full p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white">
			...
			<h6 className="text-base mb-4">Popovers:</h6>
			<div className="grid grid-cols-12 gap-6">
				<div className="col-span-12 xxl:col-span-3">
					<div className="box">
						<div className="box-header">
							<h5 className="box-title">Popover With Four Directions</h5>
						</div>
						<div className="box-body">
							<div className="flex justify-center gap-4">
								...
								<div className="hs-tooltip ti-main-tooltip [--trigger:click]">
									<Link className="hs-tooltip-toggle ti-main-tooltip-toggle" href="#!" scroll={false} >
										<span className="w-10 h-10 ti-btn p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white">
								...
								<div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:left]">
									<Link className="hs-tooltip-toggle ti-main-tooltip-toggle" href="#!" scroll={false} >
										<span className="w-10 h-10 ti-btn p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white rtl:rotate-180">
											<svg className="w-2.5 h-2.5" width="16" height="16" viewBox="0 0 16 16" fill="none">
								...
								<div className="hs-tooltip ti-main-tooltip [--trigger:click] [--placement:bottom]">
									<Link className="hs-tooltip-toggle ti-main-tooltip-toggle" href="#!" scroll={false} >
										<span className="w-10 h-10 ti-btn p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white">
											<svg className="w-2.5 h-2.5" width="16" height="16" viewBox="0 0 16 16" fill="none">
												<path d="M2.27921 4.64001L7.92565 10.2865C8.12091 10.4817 8.4375 10.4817 8.63276 10.2865L14.2792 4.64001" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
											</svg>
										</span>
										<div className="hs-tooltip-content ti-main-tooltip-content" role="tooltip">
											Bottom popover
				...
				<div className="col-span-12 xxl:col-span-3">
					<div className="box">
						<div className="box-header">
							<h5 className="box-title">Popover With Focus event</h5>
						</div>
						<div className="box-body">
				...
				<div className="col-span-12 xxl:col-span-3">
					<div className="box">
						<div className="box-header">
							<h5 className="box-title">Popover With Hover event</h5>
						</div>
						<div className="box-body">
							<div className="flex justify-center">
				...
				<div className="col-span-12 xxl:col-span-3">
					<div className="box">
						<div className="box-header">
							<h5 className="box-title">Popover With Content</h5>
						</div>
						<div className="box-body">
							<div className="flex justify-center">
								<div className="hs-tooltip ti-main-tooltip [--trigger:click]">
										...
										<div className="hs-tooltip-content ti-main-tooltip-content hidden p-0 max-w-xs border-gray-200 text-start rounded-md" role="tooltip">
											...
											<div className="py-2 px-3 text-sm text-gray-600 dark:text-white/70">
												<svg className="rounded-md mb-3" viewBox="0 0 500 300" fill="none" xmlns="http://www.w3.org/2000/svg">
													...
													<path fillRule="evenodd" clipRule="evenodd" d="M208.527 129.837L230.545 56.4768C232.123 51.2189 237.644 48.2161 242.916 49.7493L311.418 69.6738C316.749 71.2244 319.796 76.821 318.206 82.1404L311.499 80.1352C311.977 78.5394 311.062 76.8604 309.463 76.3953L240.961 56.4707C239.379 56.0108 237.723 56.9116 237.249 58.489L215.232 131.849L208.527 129.837ZM215.232 131.849L208.527 129.837C206.934 135.145 209.961 140.735 215.276 142.303L283.779 162.508C289.062 164.067 294.611 161.059 296.189 155.781L318.206 82.1404L311.499 80.1352L289.482 153.776C289.009 155.36 287.344 156.262 285.759 155.794L217.256 135.589C215.662 135.119 214.754 133.442 215.232 131.849Z" fill="white" />
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12 xxl:col-span-3">
					<div className="box">
						...
						<div className="box-body">
							<div className="flex justify-center">
								<div className="hs-tooltip ti-main-tooltip [--trigger:click]">
									<a className="hs-tooltip-toggle ti-main-tooltip-toggle" href="#!">
										<span className="w-10 h-10 ti-btn p-0 transition-none focus:outline-none bg-gray-50 border-gray-200 text-gray-600 hover:bg-primary/30 hover:border-primary hover:text-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70 dark:hover:bg-white/[.05] dark:hover:border-white/[.1] dark:hover:text-white">
											<i className="ri-arrow-up-s-line"></i>
										</span>
										<div className="hs-tooltip-content ti-main-tooltip-content hidden p-0 max-w-xs border-gray-200 text-start rounded-sm" role="tooltip">
											<span className="pt-3 px-4 block text-lg font-bold text-gray-800 dark:text-white">Overview</span>
											<div className="py-2 px-3 text-sm text-gray-600 dark:text-white/70">
												<img className="rounded-sm mb-3" src="../../assets/img/media/28.jpg" alt="Image Description" />
												<p>This is a popover body with supporting text below as a natural lead-in to additional content.</p>
												<dl className="mt-3">
													<dt className="font-bold pt-3 first:pt-0 dark:text-white">Assigned to:</dt>
													<dd className="m-0 text-gray-600 dark:text-white/70">Mark Welson</dd>
				...
				<div className="col-span-12 xxl:col-span-3">
					<div className="box">
						<div className="box-header">
							<h5 className="box-title">User popover example</h5>
						</div>
						<div className="box-body">
							{/* <!-- User --> */}
							<div className="hs-tooltip inline-block [--trigger:hover] [--placement:top] sm:![--placement:right] rtl:sm:![--placement:left]">
								<div className="hs-tooltip-toggle max-w-xs p-3 flex items-center gap-x-3 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-bgdark dark:border-white/10">
									<img className="inline-block size-9 rounded-full" src="../../assets/img/users/1.jpg" alt="Image Description" />
									{/* <!-- User Content --> */}
									<div className="grow">
									...
									{/* <!-- End User Content --> */}
									{/* <!-- Popover Content --> */}
									<div className="hs-tooltip-content overflow-hidden ti-main-tooltip-content hidden p-0 max-w-xs w-full after:absolute after:top-0 after:-start-4 after:w-4 after:h-full" role="tooltip">
										{/* <!-- Header --> */}
										<div className="py-3 px-4 border-b border-gray-200 dark:border-white/10">
											<div className="flex items-center gap-x-3">
												<img className="flex-shrink-0 inline-block size-10 rounded-full ring-2 ring-white dark:ring-bodybg" src="../../assets/img/users/1.jpg" alt="Image Description" />
												<div className="grow">
													<h4 className="font-semibold text-gray-800 dark:text-white">
														Amanda Harvey
														<span className="ms-0.5 inline-flex items-center align-middle gap-x-1.5 py-0.5 px-1.5 rounded-md text-[11px] font-medium bg-gray-800 text-white dark:bg-bgdark dark:text-white">
															PRO
														</span>
													</h4>
										...
										{/* <!-- End List --> */}
										{/* <!-- Footer --> */}
										<div className="py-2 px-4 flex justify-between items-center bg-gray-100 dark:bg-bgdark">
											<a className="inline-flex items-center gap-x-1.5 text-xs text-gray-500 hover:text-primary disabled:opacity-50 disabled:pointer-events-none dark:text-white/70 dark:hover:text-white dark:focus:outline-none" href="#!">
