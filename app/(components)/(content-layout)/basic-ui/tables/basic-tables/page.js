									...
									<tbody>
										<tr>
											...
											<td className="!text-end font-medium">
												<Link className="text-primary hover:text-primary" href="#!" scroll={false} >Delete</Link>
											</td>
										</tr>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-bordered rounded-md ">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
			...
			<div className="grid grid-cols-12 gap-6">
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-bordered rounded-md shadow dark:shadow-white/10">
									<thead>
										<tr className="">
											<th scope="col">Name</th>
											<th scope="col">Age</th>
								...
								<table className="ti-custom-table ti-custom-table-head">
									...
									<tfoot>
										<tr>
											...
											<td>Footer</td>
											<td className="text-end font-medium">
												<Link className="text-primary hover:text-primary" href="#!" scroll={false} >Footer</Link>
											</td>
										</tr>
									</tfoot>
								</table>
							...
							<div className="table-bordered rounded-md ti-custom-table-head">
								...
								<div className="py-1 px-4">
									<nav className="flex items-center space-x-0 rtl:space-x-reverse">
										<Link className="text-gray-400 dark:text-white/70 hover:text-primary p-4 inline-flex items-center gap-2 font-medium rounded-md" href="#!" scroll={false} >
										...
										<Link className="w-10 h-10 text-gray-400 dark:text-white/70 hover:text-primary p-4 inline-flex items-center text-sm font-medium rounded-full" href="#!" scroll={false} >2</Link>
										<Link className="w-10 h-10 text-gray-400 dark:text-white/70 hover:text-primary p-4 inline-flex items-center text-sm font-medium rounded-full" href="#!" scroll={false} >3</Link>
										<Link className="text-gray-400 dark:text-white/70 hover:text-primary p-4 inline-flex items-center gap-2 font-medium rounded-md" href="#!" scroll={false} >
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head ti-head-primary table-bordered rounded-md ">
									<thead className="">
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head ti-head-secondary table-bordered rounded-md ">
									<thead className="">
									...
									<tbody>
										<tr>
											...
											<td>New York No. 1 Lake Park</td>
											<td className="text-end font-medium">
												<Link className="text-secondary hover:text-secondary" href="#!" scroll={false} >Delete</Link>
											</td>
										</tr>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head ti-head-warning table-bordered rounded-md ">
									<thead className="">
									...
									<tbody>
										<tr>
											...
											<td>New York No. 1 Lake Park</td>
											<td className="text-end font-medium">
												<Link className="text-warning hover:text-warning" href="#!" scroll={false} >Delete</Link>
											</td>
										</tr>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head ti-head-info table-bordered rounded-md ">
									<thead className="">
									...
									<tbody>
										<tr>
											...
											<td>New York No. 1 Lake Park</td>
											<td className="text-end font-medium">
												<Link className="text-info hover:text-info" href="#!" scroll={false} >Delete</Link>
											</td>
										</tr>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head ti-head-danger table-bordered rounded-md ">
									...
									<tbody>
										<tr>
											...
											<td>New York No. 1 Lake Park</td>
											<td className="text-end font-medium">
												<Link className="text-danger hover:text-danger" href="#!" scroll={false} >Delete</Link>
											</td>
										</tr>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head ti-head-success table-bordered rounded-md ">
									<thead className="">
									...
									<tbody>
										<tr>
											...
											<td>New York No. 1 Lake Park</td>
											<td className="text-end font-medium">
												<Link className="text-success hover:text-success" href="#!" scroll={false} >Delete</Link>
											</td>
										</tr>
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-bordered-primary rounded-md">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-bordered-secondary rounded-md">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-bordered-warning rounded-md">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-bordered-info rounded-md">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-bordered-danger rounded-md">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-bordered-success rounded-md">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-primary  border border-gray-200 dark:border-white/10">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-secondary border border-gray-200 dark:border-white/10">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-warning  border border-gray-200 dark:border-white/10">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-info  border border-gray-200 dark:border-white/10">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-danger border border-gray-200 dark:border-white/10">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<div className="overflow-auto">
								<table className="ti-custom-table ti-custom-table-head table-success  border border-gray-200 dark:border-white/10">
									<thead>
										<tr>
											<th scope="col">Name</th>
											<th scope="col">Age</th>
