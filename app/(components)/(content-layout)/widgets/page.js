...
import { Bitcoins, DshCoin, Ethereum, Golem, WidgetsRevenue, Applicants, SessionsDevice, TargetReport, sales, WorldMap } from "@/shared/data/widgets/widgetsdata";
import { connect } from "react-redux";
import Link from "next/link";
import Seo from "@/shared/layout-components/seo/seo";
import store from "@/shared/redux/store";

const Widgets = ({ ThemeChanger }) => {
	...
	return (
		<div>
			...
			<PageHeader currentpage="Widgets" activepage="Main" mainpage="Widgets" />
							...
							<div className="flex">
								...
								<div className="flex-auto">
									<div className="flex flex-wrap items-center justify-between text-sm mb-2">
										...
										<span className=" text-gray-500 dark:text-white/70">BTC</span>
									</div>
							...
							<div className="flex">
								...
								<div className="flex-auto">
									<div className="flex flex-wrap items-center justify-between text-sm mb-2">
										...
										<span className=" text-gray-500 dark:text-white/70">ETH</span>
									</div>
									<div className="flex flex-wrap items-center justify-between">
							...
							<div className="flex">
								...
								<div className="flex-auto">
									<div className="flex flex-wrap items-center justify-between text-sm mb-2">
										...
										<span className=" text-gray-500 dark:text-white/70">DSH</span>
									</div>
									<div className="flex flex-wrap items-center justify-between">
							...
							<div className="flex">
								...
								<div className="flex-auto">
									<div className="flex flex-wrap items-center justify-between text-sm mb-2">
										...
										<span className=" text-gray-500 dark:text-white/70">GLM</span>
									</div>
									<div className="flex flex-wrap items-center justify-between">
					...
					<div className="box">
						<div className="box-body">
							<div className="flex flex-wrap justify-between">
								<div className="flex-auto">
									<p className="mb-0 text-gray-500 dark:text-white/70 text-sm">Total Candidates</p>
									<div className="flex items-center">
										<span className="text-xl font-semibold text-gray-800 dark:text-white">9,231</span>
										<span className="text-xs text-success ltr:ml-2 rtl:mr-2"><i className="ti ti-trending-up ltr:mr-1 rtl:ml-1 inline-block"></i>0.5%</span>
									</div>
								</div>
								<div>
							...
							<div className="flex flex-wrap justify-between">
								<div className="flex-auto">
									...
									<div className="flex items-center">
										...
										<span className="text-xs text-success ltr:ml-2 rtl:mr-2"><i className="ti ti-trending-up ltr:mr-1 rtl:ml-1 inline-block"></i>0.42%</span>
									</div>
								</div>
								<div>
							...
							<div className="flex flex-wrap  justify-between">
								<div className="flex-auto">
									...
									<div className="flex items-center">
										...
										<span className="text-xs text-success ltr:ml-2 rtl:mr-2"><i className="ti ti-trending-up ltr:mr-1 rtl:ml-1 inline-block"></i>5.1%</span>
									</div>
								</div>
								<div>
							...
							<div className="flex flex-wrap justify-between">
								<div className="flex-auto">
									...
									<div className="flex items-center">
										...
										<span className="text-xs text-success ltr:ml-2 rtl:mr-2"><i className="ti ti-trending-up ltr:mr-1 rtl:ml-1 inline-block"></i>3.5%</span>
									</div>
								</div>
								<div>
						...
						<div className="col-span-12 sm:col-span-6">
							<div className="box">
								<div className="box-body">
									...
									<span className="text-xl font-semibold text-gray-800 dark:text-white">9,231</span>
									<span className="text-xs text-success ltr:ml-1 rtl:mr-1"><i className="ti ti-trending-up ltr:mr-1 rtl:ml-1  inline-flex"></i>0.5%</span>
								</div>
							</div>
						</div>
						<div className="col-span-12 sm:col-span-6">
							<div className="box !bg-primary text-white">
								<div className="box-body">
									...
									<span className="text-xs opacity-70 ltr:ml-1 rtl:mr-1"><i className="ti ti-trending-up ltr:mr-1 rtl:ml-1  inline-flex"></i>0.5%</span>
								</div>
							</div>
						</div>
						<div className="col-span-12 sm:col-span-6">
							<div className="box overflow-hidden">
								<div className="box-body p-0">
									<div className="p-4">
										...
										<span className="text-xs text-success ltr:ml-1 rtl:mr-1"><i className="ti ti-trending-up ltr:mr-1 rtl:ml-1  inline-flex"></i>3.5%</span>
									</div>
									<WidgetsRevenue />
								</div>
							</div>
						...
						<div className="col-span-12 sm:col-span-6">
							<div className="box">
								<div className="box-body">
									...
									<span className="text-xl font-semibold text-gray-800 dark:text-white">$12,897</span>
									<span className="text-xs text-success"><i className="ti ti-trending-up ltr:mr-1 rtl:ml-1  inline-flex"></i>3.5%</span>
					...
					<div className="box">
						<div className="box-body">
							<div className="flex items-center mb-2">
								...
								<div>
									<Link href="#!" scroll={false} className="ti-btn ti-btn-soft-primary" aria-label="View All"><i className="ri-arrow-right-s-line"></i></Link>
								</div>
							</div>
							...
							<div className="flex items-center justify-between">
								<div className="flex -space-x-2 rtl:space-x-reverse">
									<img className="avatar w-6 h-6 rounded-full" src={"../assets/img/users/1.jpg"} alt="Image Description" />
									<img className="avatar w-6 h-6 rounded-full" src={"../assets/img/users/4.jpg"} alt="Image Description" />
									<img className="avatar w-6 h-6 rounded-full" src={"../assets/img/users/2.jpg"} alt="Image Description" />
									<img className="avatar w-6 h-6 rounded-full" src={"../assets/img/users/3.jpg"} alt="Image Description" />
						...
						<div className="box-body p-4">
							<div className="flex items-center">
								<div className="flex-auto">
									...
									<p className="mb-0 text-xs"><Link href="#!" scroll={false} className="text-success underline">View All</Link></p>
								</div>
								<div className="ltr:ml-2 rtl:mr-2">
				...
				<div className="xxl:!col-span-2 lg:col-span-6 col-span-12">
					<div className="box !bg-primary text-white">
						<div className="box-header flex justify-between border-b-0 bg-white/10">
							...
							<div>
								<button aria-label="button" type="button" className="ti-btn ti-btn-primary p-2"><i className="ri-arrow-right-s-line"></i></button>
							</div>
						</div>
						<div className="box-body">
					...
					<div className="box">
						<div className="box-body p-0">
							<div className="p-3">
								...
								<div className="flex items-center">
									<Link href="#!" scroll={false} className="flex-auto ti-btn !m-0 !py-1 bg-gray-100 text-gray-800 hover:text-white hover:bg-black/20 ring-offset-white  dark:bg-black/20 dark:text-white ltr:!mr-2 rtl:!ml-2">Short</Link>
									<Link href="#!" scroll={false} className="flex-auto ti-btn ti-btn-soft-primary !py-1 !m-0">Buy</Link>
								</div>
							</div>
						</div>
					</div>
					<div className="box">
						<div className="box-body p-0">
							<div className="p-3">
								...
								<div className="flex items-center">
									<Link href="#!" scroll={false} className="flex-auto ti-btn !m-0 !py-1 bg-gray-100 text-gray-800 hover:text-white hover:bg-black/20 ring-offset-white focus:ring-white/10 dark:bg-black/20  dark:text-white ltr:!mr-2 rtl:!ml-2">Short</Link>
									<Link href="#!" scroll={false} className="flex-auto ti-btn ti-btn-soft-primary !py-1 !m-0">Buy</Link>
								</div>
							</div>
						</div>
					...
					<div className="box">
						<div className="box-body">
							...
							<div className="flex items-center mb-0">
								...
								<span className="text-gray-500 dark:text-white/70 ltr:ml-2 rtl:mr-2"><i className="ti ti-trending-up align-middle text-success ltr:mr-1 rtl:ml-1  inline-flex"></i>2.5%</span>
							</div>
							<div className="flex items-center">
								<div className="flex-auto">
					...
					<div className="box">
						<div className="box-body">
							...
							<div className="flex items-center mb-0">
								...
								<span className="text-gray-500 dark:text-white/70 ltr:ml-2 rtl:mr-2"><i className="ti ti-trending-up align-middle text-success ltr:mr-1 rtl:ml-1  inline-flex"></i>3.1%</span>
							</div>
							<div className="flex items-center">
								<div className="flex-auto">
									<div className="ti-main-progress bg-gray-200 dark:bg-black/20">
					...
					<div className="box">
						<div className="box-body">
							...
							<div className="flex items-center mb-0">
								...
								<span className="text-gray-500 dark:text-white/70 ltr:ml-2 rtl:mr-2"><i className="ti ti-trending-up align-middle text-success ltr:mr-1 rtl:ml-1  inline-flex"></i>5.4%</span>
							</div>
							<div className="flex items-center">
								<div className="flex-auto">
									<div className="ti-main-progress bg-gray-200 dark:bg-black/20">
					...
					<div className="box">
						<div className="box-body">
							...
							<div className="flex items-center mb-0">
								...
								<span className="text-gray-500 dark:text-white/70 ltr:ml-2 rtl:mr-2"><i className="ti ti-trending-down align-middle text-danger ltr:mr-1 rtl:ml-1  inline-flex"></i>3.2%</span>
							</div>
							<div className="flex items-center">
								<div className="flex-auto">
									<div className="ti-main-progress bg-gray-200 dark:bg-black/20">
			...
			<div className="grid grid-cols-12 gap-x-6">
				{sales.map((idx) => (
					<div className="xxl:!col-span-2 md:!col-span-4 sm:col-span-6 col-span-12" key={Math.random()}>
						<div className={`box border-t-4 ${idx.color1}`}>
							<div className="box-body">
								<div className="text-center">
									<span className={`avatar inline-flex justify-center items-center avatar-sm bg-${idx.color2} text-white shadow-sm rounded-full mb-2`}>
										<i className={`ri-${idx.icon} text-base`}></i>
									</span>
									<p className="text-sm font-semibold mb-2">{idx.class}</p>
									<div className="flex items-center justify-center">
										<h5 className="mb-0 font-semibold">{idx.data}</h5>
										<span className={`badge bg-${idx.color}/10 rounded-full ltr:ml-1 rtl:mr-1 py-1 text-${idx.color}`}>{idx.data1}</span>
									</div>
								</div>
							</div>
						</div>
									...
									<ul className="list-unstyled mb-0 upcoming-events-list">
										<li className="ti-list-group border-0 p-0 w-full">
											<div className="sm:flex justify-between w-full">
												...
												<div>
													<span className="text-gray-500 dark:text-white/70"><i className="ri-time-line align-middle ltr:mr-1 rtl:ml-1  inline-block"></i>9:00am - 10:00am</span>
												</div>
											</div>
										</li>
										<li className="ti-list-group border-0 p-0 w-full">
											<div className="sm:flex justify-between w-full">
												...
												<div>
													<span className="text-gray-500 dark:text-white/70"><i className="ri-time-line align-middle ltr:mr-1 rtl:ml-1 inline-block"></i>12:00pm - 12:45am</span>
												</div>
											</div>
										</li>
										<li className="ti-list-group border-0 p-0 w-full">
											<div className="sm:flex justify-between w-full">
												...
												<div>
													<span className="text-gray-500 dark:text-white/70"><i className="ri-time-line align-middle ltr:mr-1 rtl:ml-1 inline-block"></i>4:00pm - 5:30pm</span>
												</div>
											</div>
										</li>
										<li className="ti-list-group border-0 p-0 w-full">
											<div className="sm:flex justify-between w-full">
												...
												<div>
													<span className="text-gray-500 dark:text-white/70"><i className="ri-time-line align-middle ltr:mr-1 rtl:ml-1 inline-block"></i>5:00pm - 5:45pm</span>
												</div>
											</div>
										</li>
									</ul>
									...
									<li className="ti-list-group border-0 p-0 w-full timeline-widget-list">
										<div className="flex w-full">
											...
											<div className="flex flex-wrap flex-auto items-center justify-between">
												<div>
													<p className="mb-1 truncate timeline-widget-content text-sm">You have an announcement - Ipsum Est Diam Eirmod</p>
												...
												<div className="hs-dropdown ti-dropdown">
													<Link aria-label="anchor" href="#!" scroll={false} className="text-lg leading-none text-gray-500">
								...
								<table className="ti-custom-table ti-custom-table-head whitespace-nowrap">
									...
									<tbody>
										<tr>
											...
											<td>
												<div className="flex -space-x-2 rtl:space-x-reverse">
													<img className="avatar w-5 h-5 rounded-full" src={"../assets/img/users/1.jpg"} alt="Image Description" />
													<img className="avatar w-5 h-5 rounded-full" src={"../assets/img/users/4.jpg"} alt="Image Description" />
													<img className="avatar w-5 h-5 rounded-full" src={"../assets/img/users/2.jpg"} alt="Image Description" />
													<img className="avatar w-5 h-5 rounded-full" src={"../assets/img/users/3.jpg"} alt="Image Description" />
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12">
					<div className="box overflow-hidden">
						...
						<div className="box-body">
							<div className="md:flex space-y-3 md:space-y-0 flex-wrap justify-between mb-12">
							...
							<div className="sm:grid sm:grid-cols-12 gap-x-6 space-y-6 sm:space-y-0">
										...
										<ul className="list-group">
											<li className="ti-list-group border-gray-200 bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white w-full">
												<div className="flex items-center justify-between w-full">
													<div><i className="ri-checkbox-blank-circle-fill text-primary text-xs ltr:mr-1 rtl:ml-1 align-middle inline-block"></i>Brazil</div>
													<div>1,290</div>
											...
											<li className="ti-list-group border-gray-200 bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white w-full">
												<div className="flex items-center justify-between w-full">
													<div><i className="ri-checkbox-blank-circle-fill text-secondary text-xs ltr:mr-1 rtl:ml-1 align-middle inline-block"></i>Greenland</div>
													<div>2,596</div>
											...
											<li className="ti-list-group border-gray-200 bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white w-full">
												<div className="flex items-center justify-between w-full">
													<div><i className="ri-checkbox-blank-circle-fill text-success text-xs ltr:mr-1 rtl:ml-1 align-middle inline-block"></i>Russia</div>
													<div>3,710</div>
											...
											<li className="ti-list-group border-gray-200 bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white w-full">
												<div className="flex items-center justify-between w-full">
													<div><i className="ri-checkbox-blank-circle-fill text-warning text-xs ltr:mr-1 rtl:ml-1 align-middle inline-block"></i>Palestine</div>
													<div>1,116</div>
											...
											<li className="ti-list-group border-gray-200 bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white w-full">
												<div className="flex items-center justify-between w-full">
													<div><i className="ri-checkbox-blank-circle-fill text-danger text-xs ltr:mr-1 rtl:ml-1 align-middle inline-block"></i>Canada</div>
													<div>12,150</div>
								...
								<div className="col-span-12 md:col-span-7 user-by-country">
									<div id="users-map">
										<WorldMap />
									</div>
