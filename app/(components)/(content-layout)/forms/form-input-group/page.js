"use client"
import { InlineAddonData, InlineData } from "@/shared/data/forms/forminputgroupdata";
			...
			<div className="grid grid-cols-12 gap-x-6">
				...
				<div className="col-span-12 md:col-span-6 xxl:!col-span-3">
					<div className="box">
						...
						<div className="box-body">
							<div>
								<label htmlFor="hs-input-with-leading-and-trailing-icon" className="ti-form-label">Website URL</label>
								<div className="flex rounded-sm">
						...
						<div className="box-body">
							<div>
								...
								<div className="relative">
									...
									<div className="absolute inset-y-0 ltr:left-0 rtl:right-0 flex items-center text-gray-500 dark:text-white/70 ltr:pl-px rtl:pr-px" id="currency-select">
										<label htmlFor="hs-inline-leading-select-country" className="sr-only">Country</label>
										<Select classNamePrefix='react-select' className=" border-0 block w-full border-transparent rounded-sm focus:ring-primary focus:border-primary dark:bg-bgdark" options={InlineData} defaultValue={[InlineData[0]]} />
									</div>
								</div>
							</div>
						</div>
						...
						<div className="box-body">
							<div>
								...
								<div className="relative">
									...
									<div className="absolute inset-y-0 ltr:right-0 rtl:left-0 flex items-center text-gray-500 dark:text-white/70 ltr:pr-px rtl:pl-px" id="currency-select">
										<label htmlFor="hs-inline-leading-select-currency" className="sr-only">Currency</label>
										<Select className="block w-full border-transparent rounded-sm focus:ring-primary focus:border-primary dark:bg-bgdark" options={InlineAddonData} defaultValue={[InlineAddonData[0]]} classNamePrefix='react-select' />
									</div>
								</div>
							</div>
						</div>
