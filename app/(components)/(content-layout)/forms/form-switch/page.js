    ...
    <div>
      ...
      <div className="grid grid-cols-12 gap-6">
        <div className="col-span-12 lg:col-span-4">
          <div className="box">
            ...
            <div className="box-body">
              <div className="space-y-4">
                <div className="flex items-center">
                  <input type="checkbox" id="hs-xs-switch" className="ti-switch shrink-0 w-[35px] h-[21px] before:size-4" />
            ...
            <div className="box-body">
              <div className="space-y-4">
                <div className="flex items-center">
                  ...
                  <label htmlFor="hs-valid-toggle-switch" className="text-sm text-gray-500 ms-3 dark:text-white/70">Valid toggle switch</label>
                </div>
        ...
        <div className="col-span-12 lg:col-span-4">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Solid Color variants</h5>
            </div>
            <div className="box-body">
              <div className="space-x-4 rtl:space-x-reverse">
                <div className="relative inline-block">
                  <input type="checkbox" id="hs-xs-solid-switch" className="ti-switch shrink-0 w-[35px] h-[21px] before:size-4" />
                  <label htmlFor="hs-xs-solid-switch" className="sr-only">Extra small</label>
                </div>

                <div className="relative inline-block">
                  <input type="checkbox" id="hs-small-solid-switch" className="ti-switch shrink-0 w-11 h-6 before:size-5" />
                ...
                <div className="relative inline-block">
                  <input type="checkbox" id="hs-large-solid-switch" className="ti-switch shrink-0 w-[4.25rem] h-9 before:w-8 before:h-8" />
          ...
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Solid Color With icons </h5>
            </div>
            <div className="box-body">
              <div className="space-x-4 rtl:space-x-reverse">
                {/* <!-- Switch/Toggle --> */}
                <div className="relative inline-block">
                  <input type="checkbox" id="hs-small-solid-switch-with-icons" className="peer relative shrink-0 w-11 h-6 p-px mb-1 bg-gray-100 border-transparent text-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:ring-primary disabled:opacity-50 disabled:pointer-events-none checked:bg-none checked:text-primary checked:border-primary focus:checked:border-primary dark:bg-bodybg dark:border-white/10 dark:checked:bg-primary dark:checked:border-primary dark:focus:ring-offset-gray-600 before:inline-block before:size-5 before:bg-white checked:before:bg-white before:translate-x-0 checked:before:translate-x-full rtl:checked:before:-translate-x-full before:rounded-full before:shadow before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-black/20 dark:checked:before:bg-white" />
                ...
                {/* <!-- Switch/Toggle --> */}
                <div className="relative inline-block">
                  <input type="checkbox" id="hs-large-solid-switch-with-icons" className="peer relative shrink-0 w-[4.25rem] h-9 p-px mb-1 bg-gray-100 border-transparent text-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:ring-primary disabled:opacity-50 disabled:pointer-events-none checked:bg-none checked:text-primary checked:border-primary focus:checked:border-primary dark:bg-bodybg dark:border-white/10 dark:checked:bg-primary dark:checked:border-primary dark:focus:ring-offset-gray-600
        ...
        <div className="col-span-12 lg:col-span-4">
          <div className="box">
            <div className="box-header">
              <h5 className="box-title">Soft Color variants</h5>
            </div>
            <div className="box-body">
              <div className="space-x-4 rtl:space-x-reverse">
                <div className="relative inline-block">
                  <input type="checkbox" id="hs-xs-soft-switch" className="ti-switch checked:!bg-primary/10 checked:!text-primary/10 checked:!border-primary/20 focus:checked:!border-primary/10 checked:before:!bg-primary dark:checked:before:bg-primary shrink-0 w-[35px] h-[21px] before:size-4" />
                  <label htmlFor="hs-xs-soft-switch" className="sr-only">Extra small</label>
                </div>

                <div className="relative inline-block">
                  <input type="checkbox" id="hs-small-soft-switch" className="ti-switch checked:!bg-primary/10 checked:!text-primary/10 checked:!border-primary/20 focus:checked:!border-primary/10 checked:before:!bg-primary dark:checked:before:bg-primary shrink-0 w-11 h-6 before:size-5" />
                  <label htmlFor="hs-small-soft-switch" className="sr-only">Small</label>
                </div>


                <div className="relative inline-block">
                  <input type="checkbox" id="hs-medium-soft-switch" className="ti-switch checked:!bg-primary/10 checked:!text-primary/10 checked:!border-primary/20 focus:checked:!border-primary/10 checked:before:!bg-primary dark:checked:before:bg-primary shrink-0" />
                  <label htmlFor="hs-medium-soft-switch" className="sr-only">Medium</label>
                </div>

                <div className="relative inline-block">
                  <input type="checkbox" id="hs-large-soft-switch" className="ti-switch checked:!bg-primary/10 checked:!text-primary/10 checked:!border-primary/20 focus:checked:!border-primary/10 checked:before:!bg-primary dark:checked:before:bg-primary shrink-0 w-[4.25rem] h-9 before:w-8 before:h-8" />
          ...
          <div className="box">
            ...
            <div className="box-body">
              <div className="space-x-4 rtl:space-x-reverse">
                ...
                {/* <!-- Switch/Toggle --> */}
                <div className="relative inline-block">
                  <input type="checkbox" id="hs-default-switch-soft-with-icons" className="peer relative w-[3.25rem] h-7 p-px mb-1 bg-gray-100 border border-gray-200 text-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:ring-primary disabled:opacity-50 disabled:pointer-events-none checked:bg-none checked:text-primary/30 checked:border-primary/50 focus:checked:border-primary/50 dark:bg-bodybg dark:border-white/10 dark:checked:bg-primary/30 dark:checked:border-primary dark:focus:ring-offset-gray-600
                ...
                {/* <!-- Switch/Toggle --> */}
                <div className="relative inline-block">
                  <input type="checkbox" id="hs-large-switch-soft-with-icons" className="peer relative shrink-0 w-[4.25rem] h-9 p-px mb-1 bg-gray-100 border border-gray-200 text-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:ring-primary disabled:opacity-50 disabled:pointer-events-none checked:bg-none checked:text-primary/30 checked:border-primary/50 focus:checked:border-primary/50 dark:bg-bodybg dark:border-white/10 dark:checked:bg-primary/30 dark:checked:border-primary dark:focus:ring-offset-gray-600
