...
import { Month, Year } from "@/shared/data/forms/formlayouts";
								...
								<div className="flex">
									...
									<label htmlFor="hs-checkbox-group-11"
										className="text-sm text-gray-500 ltr:ml-3 rtl:mr-3 dark:text-white/70">I agree with the <Link
											href="#!" scroll={false} className="text-primary hover:underline">terms and
								...
								<div className="sm:grid grid-cols-12 gap-x-6">
									...
									<div className="col-span-9">
										...
										<label htmlFor="hs-checkbox-group-12"
											...
											<Link href="#!" scroll={false} className="text-primary hover:underline ltr:ml-1 rtl:ml-1">terms and
												conditions</Link></label>
									</div>
								</div>
