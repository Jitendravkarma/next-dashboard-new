        ...
        <Fragment>
            ...
            <div className="grid grid-cols-12 gap-x-6">
                <div className="col-span-12 xxl:col-span-6">
                    <div className="box">
                        <div className="box-header">
                            <h5 className="box-title">Checkbox Toggle Count</h5>
                        </div>
                        <div className="box-body">
                            {/* <!-- Toggle --> */}
                            <div className="flex justify-end mb-3">
                                <div id="toggle-count" className="p-0.5 inline-block bg-gray-100 rounded-sm dark:bg-bodybg">
                                    <label htmlFor="toggle-count-monthly" className="relative inline-block py-2 px-3">
                                        ...
                                        <input id="toggle-count-monthly" name="toggle-count" type="radio" className="absolute top-0 end-0 size-full border-transparent bg-transparent bg-none text-transparent rounded-sm cursor-pointer before:absolute before:inset-0 before:size-full before:rounded-sm focus:ring-offset-0 checked:before:bg-white checked:before:shadow-sm checked:bg-none focus:ring-transparent dark:checked:before:bg-bgdark dark:focus:ring-offset-transparent" />
                                    </label>
                ...
                <div className="col-span-12 xxl:col-span-6">
                    <div className="box">
                        <div className="box-header">
                            <h5 className="box-title">Switch Toggle Count</h5>
                        </div>
                        <div className="box-body">
                            {/* <!-- Toggle --> */}
            ...
            <div className="grid grid-cols-12 gap-x-6">
                ...
                <div className="col-span-12 md:col-span-6">
                    <div className="box">
                        <div className="box-header">
                            <h5 className="box-title">Select Markup</h5>
                        </div>
                        <div className="box-body">
