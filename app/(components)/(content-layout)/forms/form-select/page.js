...
import { DefaultSelect, DisabledGroupData, GroupedData, Multiselectcomponent } from "@/shared/data/forms/formselect/formselect";
import DropdownSelect from "@/shared/data/forms/formselect/dropdownselect";
				...
				<div className="col-span-12 md:col-span-6 xl:!col-span-3">
					<div className="box">
						...
						<div className="box-body">
							...
							<Select classNamePrefix='react-select' className="pilledselect" options={DefaultSelect} placeholder='Open this select menu' />
						</div>
					</div>
				</div>
				<div className="col-span-12 md:col-span-6 xl:!col-span-3">
				...
				<div className="col-span-12 md:col-span-6 xl:!col-span-3">
					<div className="box">
						...
						<div className="box-body">
							...
							<Select classNamePrefix='react-select' options={DefaultSelect} placeholder='Open this select menu' required />
						</div>
					</div>
				</div>
			</div>
					...
					<div className="box">
						...
						<div className="box-body">
							<div className="space-y-3 select-sizes">
								...
								<Select classNamePrefix='react-select' className='py-0 !text-[12px] !px-0 ti-form-select' options={DefaultSelect} placeholder='Open this select menu' />
								<Select className='ti-form-select sm:p-4 !px-0 !py-0' classNamePrefix='react-select' options={DefaultSelect} placeholder='Open this select menu' />
								<Select className='ti-form-select sm:p-5 !px-0 !py-0 !text-[16px]' classNamePrefix='react-select' options={DefaultSelect} placeholder='Open this select menu' />
					...
					<div className="box">
						...
						<div className="box-body">
							<div className="space-y-3">
								<div className='ti-form-invalid'>
									<label htmlFor="select-1" className="ti-form-select-label">Label</label>
									<div className="relative">
										<Select classNamePrefix='react-select' className='border !border-red-500 focus:border-red-500 focus:ring-red-500' aria-valid='false' options={DefaultSelect} placeholder='Open this select menu' />
								...
								<div className="ti-form-valid">
									<label htmlFor="select-2" className="ti-form-select-label">Label</label>
									<div className="relative">
										<Select classNamePrefix='react-select' className='border !border-green-500 focus:border-green-500 focus:ring-green-500' aria-valid='false' options={DefaultSelect} placeholder='Open this select menu' />
										<div className="absolute inset-y-0 ltr:right-0 rtl:left-0 flex items-center pointer-events-none ltr:pr-8 rtl:pl-8">
			...
			<div className="grid grid-cols-12 gap-x-6">
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body  multiple-select">
							<label className="ti-form-select-label">Default MultiSelect</label>
							<Select isMulti classNamePrefix='react-select' className='!border-green-500 focus:border-green-500 focus:ring-green-500' aria-valid='false' options={Multiselectcomponent} placeholder='Open this select menu' />
							<label className="ti-form-select-label mt-3">MultiSelect Disabled</label>
							<Select isMulti classNamePrefix='react-select' className='!border-green-500 focus:border-green-500 focus:ring-green-500' aria-valid='false' options={Multiselectcomponent} placeholder='Open this select menu' isDisabled />
							<label className="ti-form-select-label mt-3">Multiple Select with Group Option</label>
							<Select isMulti name="state" options={GroupedData} className="js-example-placeholder-multiple w-full js-states"
				...
				<div className="col-span-12 lg:col-span-6">
					<div className="box">
						...
						<div className="box-body">
							<label className="ti-form-select-label">Default Single Choices Select</label>
							<CreatableSelect components={components} classNamePrefix='react-select' inputValue={inputValue} isClearable isMulti menuIsOpen={false}
								// onChange={(newValue: React.SetStateAction<never[]>) => setValue(newValue)} 
							...
							<label className="ti-form-select-label mt-3">Option groups</label>
