...
import { FileChart, RecentfileData } from "@/shared/data/advance-ui/file-manager/filemanagerdata";
...
const Filemanager = () => {
	...
	return (
		<Fragment>
			...
			<PageHeader currentpage="File Manager" activepage="Advanced UI" mainpage="File Manager" />
			<div className="grid grid-cols-12 gap-6">
						...
						<div className="box-body">
							<div>
								<div className="w-40 h-40 relative mx-auto mb-5">
									...
									<Doughnut className="chartjs-chart w-full" data={chartjsdata.fileData} options={chartjsdata.fileOptions} height={250} />
								</div>
								<div className="grid grid-cols-12 gap-6 overflow-auto mb-5">
							...
							<Link href="#!" scroll={false} className="ti-btn w-full !mt-5 !mb-0 ti-btn-primary p-2"><i className="ri ri-upload-cloud-2-line"></i>Upgrade Your Plan</Link>
						</div>
					</div>
					<div className="box">
						<div className="box-body">
							<div className="flex items-center justify-between">
								...
								<div className="space-x-2 rtl:space-x-reverse">
									<Link href="#!" scroll={false} className="ti-btn ti-btn-secondary p-2 mb-0"><span>Clean</span></Link>
								</div>
							</div>
						</div>
					</div>
				...
				<div className="col-span-12 xxl:col-span-9">
								...
								<div className="grid grid-cols-12 gap-6">
									<div className="col-span-12 sm:col-span-6 lg:!col-span-3">
										<div className="box mb-0 overflow-hidden">
											<div className="box-body">
												<Link href={"/advance-ui/file-manager/file-details/"} className="mx-auto my-3"><img className="mx-auto" src={"../../../assets/img/files/2.png"} alt="img" /></Link>
											</div>
									...
									<div className="col-span-12 sm:col-span-6 lg:!col-span-3">
										<div className="box mb-0 overflow-hidden">
											<div className="box-body">
												<Link href={"/advance-ui/file-manager/file-details/"} className="mx-auto my-3"><img className="mx-auto" src={"../../../assets/img/files/9.png"} alt="img" /></Link>
											</div>
											<div className="box-footer bg-transparent">
												<div className="flex justify-between flex-wrap">
									...
									<div className="col-span-12 sm:col-span-6 lg:!col-span-3">
										<div className="box mb-0 overflow-hidden">
											<div className="box-body">
												<Link href={"/advance-ui/file-manager/file-details/"} className="mx-auto my-3"><img className="mx-auto" src={"../../../assets/img/files/3.png"} alt="img" /></Link>
											</div>
											<div className="box-footer bg-transparent">
												<div className="flex justify-between flex-wrap">
									...
									<div className="col-span-12 sm:col-span-6 lg:!col-span-3">
										<div className="box mb-0 overflow-hidden">
											<div className="box-body">
												<Link href={"/advance-ui/file-manager/file-details/"} className="mx-auto my-3"><img className="mx-auto" src={"../../../assets/img/files/5.png"} alt="img" /></Link>
											</div>
											<div className="box-footer bg-transparent">
												<div className="flex justify-between flex-wrap">
								...
								<div className="box">
									<div className="box-body space-y-3">
										...
										<div className="flex items-center justify-between text-xs">
											...
											<Link href="#!" scroll={false} className="text-primary">Manage Files</Link>
										</div>
									</div>
								</div>
								<div className="box">
									<div className="box-body space-y-3">
										...
										<div className="flex items-center justify-between text-xs"> <span
											className="text-gray-500 dark:text-white/70">10Gb / 16GB</span> <Link href="#!" scroll={false} className="text-danger">Manage Files</Link>
										</div>
									</div>
								</div>
								<div className="box">
									<div className="box-body space-y-3">
										...
										<div className="flex items-center justify-between text-xs"> <span
											className="text-gray-500 dark:text-white/70">3Gb / 8 GB</span> <Link href="#!" scroll={false} className="text-secondary">Manage Files</Link>
										</div>
									</div>
								</div>
							</div>
					...
					<div className="box">
						...
						<div className="box-body">
							<div className="pb-5">
								<div className="md:flex justify-between flex-wrap space-y-2 md:space-y-0">
									...
									<div className="md:ltr:ml-auto md:rtl:mr-auto">
										<Link href="#!" scroll={false} className="ti-btn text-xs !m-0 ti-btn-soft-success !p-2"><i className="ri ri-add-circle-line"></i>Create New File</Link>
									</div>
								</div>
							</div>
										...
										{allData.map((idx) => (
											<tr key={Math.random()}>
												<td className="font-medium">
													<Link className="flex items-center space-x-2 rtl:space-x-reverse" href={"/advance-ui/file-manager/file-manager-list"}>
														<img src={"../../../assets/img/files/5.png"} alt="img" className="w-10" />
														<span>{idx.name}</span>
													</Link>
												</td>
												<td>{idx.File}</td>
												...
												<td>
													<div className="flex -space-x-2 rtl:space-x-reverse">
														<img className="inline-block h-10 w-10 rounded-full ring-2 ring-white" src={"../../../assets/img/users/8.jpg"} alt="Image Description" />
														<img className="inline-block h-10 w-10 rounded-full ring-2 ring-white" src={"../../../assets/img/users/4.jpg"} alt="Image Description" />
														<img className="inline-block h-10 w-10 rounded-full ring-2 ring-white" src={"../../../assets/img/users/6.jpg"} alt="Image Description" />
														<img className="inline-block h-10 w-10 rounded-full ring-2 ring-white" src={"../../../assets/img/users/7.jpg"} alt="Image Description" />
														<img className="inline-block h-10 w-10 rounded-full ring-2 ring-white" src={"../../../assets/img/users/2.jpg"} alt="Image Description" />
													</div>
												</td>
												<td className="!text-end">
													<div className="hs-dropdown ti-dropdown">
														<button aria-label="button" type="button" className="hs-dropdown-toggle p-3 ti-dropdown-toggle">
							...
							<div className="py-1 ltr:float-right rtl:float-left">
								<nav className="flex items-center space-x-2 rtl:space-x-reverse">
									<Link className="text-gray-500 dark:text-white/70 hover:text-primary p-4 inline-flex items-center gap-2 font-medium rounded-md" href="#!" scroll={false} >
