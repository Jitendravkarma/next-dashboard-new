...
import { ProfileService2 } from "@/shared/data/pages/contactdata";
import { HomeGallery } from "@/shared/data/advance-ui/file-manager/filedetailsdata";
...
const Home = () => {
  ...
  const Skillsdata = [
    ...
    { id: 4, class: "VueJs" },
    { id: 5, class: "React" },
    { id: 6, class: "Codeignator" },
    { id: 7, class: "Javascript" },
    { id: 8, class: "Bootstrap" },
    { id: 9, class: "Php" },
  ];
  ...
  //URl image
  const [UrlImage, setUrlImage] = useState("../assets/img/png-images/2.png");
  //Disabling input feild
  const [UrlDisabled, setUrlDisabled] = useState(true);

  const [fileDisabled, setfileDisabled] = useState(false);
  //Default image
  const [Image, setImage] = useState("../assets/img/png-images/2.png");

  let location = useRouter();

  const putImage = () => {
    setImage(ProfileService2.returnImage());
    if (UrlImage != Image) {
      ProfileService2.handleChangeUrl(UrlImage);
      setImage(ProfileService2.returnImage());
    }
    // setSmShow(false)
  };
  ...
  useEffect(() => {
    if (ProfileService2.returnImage() != undefined) {
      setImage(ProfileService2.returnImage());
    }
              ...
              <div className="ti-modal-content">
                ...
                <div className="ti-modal-body">
                  <div onClick={() => { toggleImage("fileDisabled"); }}>
                    ...
                    <input type="file" name="file-input" id="file-input" disabled={fileDisabled} onChange={(ele) => ProfileService2.handleChange(ele)} className=" inset-0 block w-full h-full cursor-pointer border my-2 border-gray-200 focus:shadow-sm dark:focus:shadow-white/10 rounded-sm text-sm focus:z-10 focus:outline-0 focus:border-gray-200 dark:focus:border-white/10 dark:border-white/10 dark:text-white/70  file:border-0 file:bg-gray-100 ltr:file:mr-4 rtl:file:ml-4 file:py-3 file:px-4 dark:file:bg-black/20 dark:file:text-white/70" />
                  </div>
        ...
        <div className="absolute top-28 inset-x-0 text-center space-y-3">
          <div className="flex justify-center w-full">
            <div className="relative cursor-pointer">
              <img src={selectedImage || '../assets/img/users/1.jpg'} style={{ objectFit: 'cover' }} className="w-24 h-24 rounded-full ring-4 ring-white/10 mx-auto" id="profile-img" alt="profile-img" />
              ...
              <span
                ...
                />
                <i data-hs-overlay="#hs-small-modal1" className="ri ri-pencil-line cursor-pointer"></i>
              </span>
            </div>
          ...
          <div className="flex space-x-1 rtl:space-x-reverse justify-center text-center">
            <div className="hs-tooltip ti-main-tooltip">
              <button type="button" className="hs-tooltip-toggle !m-0 !rounded-full !p-2 ti-btn ti-btn-outline ring-white/10 text-white bg-white/10  border-white/10">
                ...
                <div className="box-body space-y-4 text-center">
                  <ul className="flex flex-col">
                    <li className="ti-list-group bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white">
                      <div className="sm:flex xxl:block xxxl:flex space-y-2 xxxl:space-y-0 justify-between w-full">
                        <div className="flex items-center">
                          <img className="avatar avatar-xs rounded-sm" src={"../assets/img/users/2.jpg"}
                    ...
                    <li className="ti-list-group bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white">
                      <div className="sm:flex xxl:block xxxl:flex space-y-2 xxxl:space-y-0 justify-between w-full">
                        <div className="flex items-center">
                          <img className="avatar avatar-xs rounded-sm" src={"../assets/img/users/12.jpg"}
                            alt="Image Description" />
                          <div className="ltr:ml-4 rtl:mr-4">
                    ...
                    <li className="ti-list-group bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white">
                      <div className="sm:flex xxl:block xxxl:flex space-y-2 xxxl:space-y-0 justify-between w-full">
                        <div className="flex items-center">
                          <img className="avatar avatar-xs rounded-sm" src={"../assets/img/users/3.jpg"}
                            alt="Image Description" />
                          <div className="ltr:ml-4 rtl:mr-4">
                    ...
                    <li className="ti-list-group bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white">
                      <div className="sm:flex xxl:block xxxl:flex space-y-2 xxxl:space-y-0 justify-between w-full">
                        <div className="flex items-center">
                          <img className="avatar avatar-xs rounded-sm" src={"../assets/img/users/13.jpg"}
                            alt="Image Description" />
                          <div className="ltr:ml-4 rtl:mr-4">
                    ...
                    <li className="ti-list-group bg-white text-gray-800 dark:bg-bgdark dark:border-white/10 dark:text-white">
                      <div className="sm:flex xxl:block xxxl:flex space-y-2 xxxl:space-y-0 justify-between w-full">
                        <div className="flex items-center">
                          <img className="avatar avatar-xs rounded-sm" src={"../assets/img/users/4.jpg"}
                            alt="Image Description" />
                          <div className="ltr:ml-4 rtl:mr-4">
                  ...
                  <Link href="#!" scroll={false} className="ti-btn ti-btn-primary py-1 px-2 m-0">View more</Link>
                </div>
              </div>
            </div>
                  ...
                  <div id="profile-2" className="hidden" role="tabpanel" aria-labelledby="profile-item-2">
                    <div className="">
                      <div className="flex flex-row">
                        <div className="mx-auto relative">
                          ...
                          <div
                            ...
                            <img src={"../assets/img/users/1.jpg"} className="rounded-full" alt="profile-img" />
                          </div>
                        </div>
                        <div className="flex w-full pb-8">
                          <div className="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                            ...
                            <div className="flex -space-x-2 rtl:space-x-reverse">
                              <img className="avatar avatar-xs rounded-full" src={"../assets/img/users/1.jpg"}
                                alt="Image Description" />
                      ...
                      <div className="flex flex-row">
                        <div className="mx-auto relative">
                          ...
                          <div
                            className="avatar avatar-xs absolute top-0 rounded-full bg-gray-200 shadow text-center ltr:-left-[4px] rtl:-right-[4px]">
                            <img src={"../assets/img/users/3.jpg"} className="rounded-full" alt="profile-img" />
                          </div>
                        </div>
                        <div className="flex w-full pb-8">
                          <div className="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                      ...
                      <div className="flex flex-row">
                        <div className="mx-auto relative">
                          ...
                          <div
                            className="avatar avatar-xs absolute top-0 rounded-full bg-gray-200 shadow text-center ltr:-left-[4px] rtl:-right-[4px]">
                            <img src={"../assets/img/users/2.jpg"} className="rounded-full" alt="profile-img" />
                          </div>
                        </div>
                        <div className="flex w-full pb-8">
                          <div className="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                            ...
                            <div><img src={"../assets/img/gallery/2.jpg"} className="avatar avatar-lg rounded-sm"
                              alt="profile-img" /></div>
                          </div>
                        </div>
                      </div>
                      <div className="flex flex-row">
                        <div className="mx-auto relative">
                          ...
                          <div
                            className="avatar avatar-xs absolute top-0 rounded-full bg-gray-200 shadow text-center ltr:-left-[4px] rtl:-right-[4px]">
                            <img src={"../assets/img/users/15.jpg"} className="rounded-full" alt="profile-img" />
                          </div>
                        </div>
                        <div className="flex w-full pb-8">
                          <div className="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                            ...
                            <div className="space-y-3">
                              ...
                              <img src={"../assets/img/gallery/5.jpg"} className="avatar avatar-lg rounded-sm"
                                alt="profile-img" />
                            </div>
                          </div>
                        </div>
                    ...
                    <div className="flex flex-row">
                      <div className="mx-auto relative">
                        ...
                        <div
                          className="avatar avatar-xs absolute top-0 rounded-full bg-gray-200 shadow text-center ltr:-left-[4px] rtl:-right-[4px]">
                          <img src={"../assets/img/users/21.jpg"} className="rounded-full" alt="profile-img" />
                        </div>
                      </div>
                      <div className="flex w-full pb-8">
                        <div className="ltr:ml-5 rtl:mr-5 rounded-sm ltr:mr-auto rtl:ml-auto my-auto w-full space-y-3">
                    ...
                    <div className="box text-start">
                      <div className="box-body p-0">
                        <div
                          ...
                          <img className="avatar avatar-sm rounded-full" src={"../assets/img/users/1.jpg"} alt="profile-img" />
                        ...
                        <ul className="sm:flex sm:space-x-5 space-y-2 sm:space-y-0 flex-row p-6 rtl:space-x-reverse overflow-auto">
                          <li>
                            <Link className="flex space-x-1 rtl:space-x-reverse" href="#!" scroll={false} >
                      ...
                      <div className="box-footer">
                        <div className="Profile-post-footer flex space-x-5 rtl:space-x-reverse justify-end">
                          ...
                          <Link href="#!" scroll={false} className="!my-0 ti-btn ti-btn-primary">post</Link>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="box-body ltr:sm:pl-5 rtl:sm:pr-5 px-0 py-0 space-y-4 my-auto w-full">
                          ...
                          <div className="space-x-2 sm:space-y-0 rtl:space-x-reverse flex">
                            <Link href="#!" scroll={false}
                              className="text-xs leading-[0] text-gray-500 dark:text-white/70 space-x-2 rtl:space-x-reverse rounded-full bg-gray-100 px-3 py-1 font-normal hover:bg-gray-300 focus:bg-gary-800 dark:bg-black/20 dark:hover:bg-bgdark inline-flex items-center"><i
                          ...
                          <div className="md:flex md:justify-between space-y-2 md:space-y-0">
                            <div className="flex items-center space-x-3 rtl:space-x-reverse">
                              <div className="flex">
                                <img className="avatar avatar-xs ring-0 rounded-full" src={"../assets/img/users/1.jpg"}
                                  alt="avatar" />
                              </div>
                              <div>
                      ...
                      <div className="sm:flex flex-row space-y-2 sm:space-y-0">
                        ...
                        <div className="box-body ltr:sm:pl-5 rtl:sm:pr-5 px-0 py-0 space-y-4 my-auto w-full">
                          ...
                          <div className="md:flex md:justify-between space-y-2 md:space-y-0">
                            <div className="flex items-center space-x-3 rtl:space-x-reverse">
                              <div className="flex">
                                <img className="avatar avatar-xs ring-0 rounded-full" src={"../assets/img/users/3.jpg"}
                                  alt="avatar" />
                              </div>
                              <div>
                                <p className="text-slate-700 font-semibold text-sm dark:text-white">
                      ...
                      <div className="sm:flex flex-row space-y-2 sm:space-y-0">
                        ...
                        <div className="box-body ltr:sm:pl-5 rtl:sm:pr-5 px-0 py-0 space-y-4 my-auto w-full">
                          ...
                          <div className="md:flex md:justify-between space-y-2 md:space-y-0">
                            <div className="flex items-center space-x-3 rtl:space-x-reverse">
                              <div className="flex">
                                <img className="avatar avatar-xs ring-0 rounded-full" src={"../assets/img/users/13.jpg"}
                                  alt="avatar" />
                              </div>
                              <div>
                                <p className="text-slate-700 font-semibold text-sm dark:text-white">
                      ...
                      <div className="sm:flex flex-row space-y-2 sm:space-y-0">
                        ...
                        <div className="box-body ltr:sm:pl-5 rtl:sm:pr-5 px-0 py-0 space-y-4 my-auto w-full">
                          ...
                          <div className="md:flex md:justify-between space-y-2 md:space-y-0">
                            <div className="flex items-center space-x-3 rtl:space-x-reverse">
                              <div className="flex">
                                <img className="avatar avatar-xs ring-0 rounded-full" src={"../assets/img/users/15.jpg"}
                                  alt="avatar" />
                              </div>
                              <div>
                                <p className="text-slate-700 font-semibold text-sm dark:text-white">
                          ...
                          <div className="box-body space-y-3">
                            <div className="sm:flex sm:space-x-3 sm:space-y-0 space-y-2 rtl:space-x-reverse">
                              ...
                              <div className="my-auto space-y-2">
                                ...
                                <div className="flex -space-x-2 rtl:space-x-reverse">
                                  <img className="avatar w-6 h-6 rounded-full" src={"../assets/img/users/15.jpg"}
                                    alt="Image Description" />
                                  <img className="avatar w-6 h-6 rounded-full" src={"../assets/img/users/4.jpg"}
                                    alt="Image Description" />
                                  <img className="avatar w-6 h-6 rounded-full" src={"../assets/img/users/12.jpg"}
                                    alt="Image Description" />
                                  <span
                            ...
                            <div className="sm:flex sm:space-x-3 sm:space-y-0 space-y-2 rtl:space-x-reverse">
                              ...
                              <div className="my-auto space-y-2">
                                ...
                                <div className="flex -space-x-2 rtl:space-x-reverse">
                                  ...
                                  <img className="avatar w-6 h-6 rounded-full" src={"../assets/img/users/4.jpg"}
                                    alt="Image Description" />
                                  <img className="avatar w-6 h-6 rounded-full" src={"../assets/img/users/3.jpg"}
                                    alt="Image Description" />
                                  <img className="avatar w-6 h-6 rounded-full" src={"../assets/img/users/12.jpg"}
                                    alt="Image Description" />
                                  <span
                        ...
                        <div className="box">
                          <div className="box-body space-y-3">
                            ...
                            <div className="sm:flex sm:space-y-0 space-y-2 justify-between">
                              ...
                              <p className="text-gray-500 dark:text-white/70 text-sm font-medium my-auto">5-2-2022</p>
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div className="col-span-12 xxl:col-span-3">
              <div className="box">
                ...
                <div className="box-body skills-box">
                  {Skillsdata.map((idx) => (
                    <span key={Math.random()} className="badge bg-gray-100 text-gray-800 dark:bg-black/20 dark:text-gray-200 me-1">{idx.class}</span>
                  ))}
                  ...
                  <ul className="flex flex-col">
                    <li className="ti-list-group pt-0 px-0 border-0 text-gray-800 dark:text-white">
                      <Link href="#!" scroll={false} className="space-x-3 flex rtl:space-x-reverse">
                        <img src={"../assets/img/gallery/1.jpg"} className="avatar rounded-sm ring-0" alt="profile-img" />
                    ...
                    <li className="ti-list-group px-0 border-0 text-gray-800 dark:text-white">
                      <Link href="#!" scroll={false} className="space-x-3 flex rtl:space-x-reverse">
                        <img src={"../assets/img/gallery/2.jpg"} className="avatar rounded-sm ring-0" alt="profile-img" />
                        <div className="space-y-1 my-auto">
                    ...
                    <li className="ti-list-group px-0 border-0 text-gray-800 dark:text-white">
                      <Link href="#!" scroll={false} className="space-x-3 flex rtl:space-x-reverse">
                        <img src={"../assets/img/gallery/3.jpg"} className="avatar rounded-sm ring-0" alt="profile-img" />
                        <div className="space-y-1 my-auto">
                    ...
                    <li className="ti-list-group px-0 border-0 text-gray-800 dark:text-white">
                      <Link href="#!" scroll={false} className="space-x-3 flex rtl:space-x-reverse">
                        <img src={"../assets/img/gallery/4.jpg"} className="avatar rounded-sm ring-0" alt="profile-img" />
                        <div className="space-y-1 my-auto">
