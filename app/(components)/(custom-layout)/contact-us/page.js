...
const Contactus = () => {
  ...
  return (
    <div>
      ...
      <div className="absolute top-12 md:top-16 lg:top-28 inset-x-1/4 text-center space-y-3">
        <div className="text-white space-y-3">
          ...
          <Link href="#!" scroll={false} className="ti-btn ti-btn-secondary"> <i className="ri-phone-line"></i> Call Us </Link>
        </div>
      </div>
                    ...
                    <div className="space-y-4 text-start">
                      ...
                      <div className="grid sm:grid-cols-12 gap-x-6">
                        ...
                        <div className="col-span-9">
                          <Link className="ti-btn ti-btn-primary mb-0" href="#!" scroll={false} >Send Message</Link>
                        </div>
                      </div>
                    </div>
                  </div>
