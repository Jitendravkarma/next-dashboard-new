  ...
  return (
    <div>
      ...
      <div className="flex relative before:bg-primary/80 before:absolute before:w-full before:h-full">
        <img src={"../assets/img/png-images/14.jpg"} alt="" className="h-[500px] w-full" id="profile-img2" />
      </div>
      <div className="absolute xxl:!top-24 top-16 xxl:!inset-x-1/4  sm:inset-x-[15%] text-center space-y-3">
        <div className="text-white space-y-3">
          <p className="text-xl text-white/70">About Us</p>
          <h1 className="text-5xl font-bold">We Do Things Differently ....!!</h1>
          <p className="text-sm text-white/50 px-2">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aspernatur
      ...
      <div className="main-content sm:-mt-32 sm-mt-16">
          ...
          <div className="box">
            <div className="box-body">
              <div className="grid xl:grid-cols-2 gap-6">
                <div>
                  <img className="rounded-sm" src={"../assets/img/gallery/10.jpg"} alt="" />
                </div>
                <div className="space-y-3">
                  ...
                  <Link className="ti-btn ti-btn-primary" href="#!" scroll={false} >Read More <i className="ri ri-arrow-right-s-line"></i></Link>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="box">
            <div className="box-body">
              <div className="grid xl:grid-cols-2 gap-6">
                ...
                <div>
                  <img className="rounded-sm" src={"../assets/img/gallery/9.jpg"} alt="" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="sm:grid sm:space-y-0 space-y-6 grid-cols-12 gap-6">
                  ...
                  <div className="box mb-0">
                    <div className="box-body space-y-3 text-center">
                      <div className="mx-auto">
                        <img alt="service-img" src={"../assets/img/png-images/3.png"} />
                      </div>
                ...
                <div className="col-span-12 xl:col-span-3 md:col-span-6">
                  <div className="box mb-0">
                    <div className="box-body space-y-3 text-center">
                      <div className="mx-auto">
                        <img alt="service-img" src={"../assets/img/png-images/4.png"} />
                      </div>
                ...
                <div className="col-span-12 xl:col-span-3 md:col-span-6">
                  <div className="box mb-0">
                    <div className="box-body space-y-3 text-center">
                      <div className="mx-auto">
                        <img alt="service-img" src={"../assets/img/png-images/6.png"} />
                      </div>
                ...
                <div className="col-span-12 xl:col-span-3 md:col-span-6">
                  <div className="box mb-0">
                    <div className="box-body space-y-3 text-center">
                      <div className="mx-auto">
                        <img alt="service-img" src={"../assets/img/png-images/5.png"} />
                      </div>
                  ...
                  <div className="box mb-0 text-start">
                    <div className="box-body">
                      ...
                      <a className="flex my-auto">
                        <img alt="testimonial" src={"../assets/img/users/2.jpg"} className="avatar avatar-sm !rounded-full !p-0" />
                ...
                <SwiperSlide>
                  <div className="box mb-0 text-start">
                    <div className="box-body">
                      ...
                      <a className="flex my-auto ">
                        <img alt="testimonial" src={"../assets/img/users/12.jpg"} className="avatar avatar-sm !rounded-full !p-0" />
                        <div className="ltr:pl-4 rtl:pr-4 my-auto">
                ...
                <SwiperSlide>
                  <div className="box mb-0 text-start">
                    <div className="box-body">
                      ...
                      <a className="flex my-auto ">
                        <img alt="testimonial" src={"../assets/img/users/3.jpg"} className="avatar avatar-sm !rounded-full !p-0" />
                        <div className="ltr:pl-4 rtl:pr-4 my-auto">
                ...
                <SwiperSlide>
                  <div className="box mb-0 text-start">
                    <div className="box-body">
                      ...
                      <a className="flex my-auto ">
                        <img alt="testimonial" src={"../assets/img/users/13.jpg"} className="avatar avatar-sm !rounded-full !p-0" />
                        <div className="ltr:pl-4 rtl:pr-4 my-auto">
                ...
                <SwiperSlide>
                  <div className="box mb-0 text-start">
                    <div className="box-body">
                      ...
                      <a className="flex my-auto ">
                        <img alt="testimonial" src={"../assets/img/users/5.jpg"} className="avatar avatar-sm !rounded-full !p-0" />
                        <div className="ltr:pl-4 rtl:pr-4 my-auto">
                ...
                <SwiperSlide>
                  <div className="box mb-0 text-start">
                    <div className="box-body">
                      ...
                      <a className="flex my-auto ">
                        <img alt="testimonial" src={"../assets/img/users/15.jpg"} className="avatar avatar-sm !rounded-full !p-0" />
                        <div className="ltr:pl-4 rtl:pr-4 my-auto">
            ...
            <div className="box-body">
              <div className="space-y-8 my-auto text-center">
                ...
                <div>
                  ...
                  <Link className=" text-center ti-btn ti-btn-primary" href="#!" scroll={false} >Send Message</Link>
                </div>
              </div>
            </div>
          </div>
