...
const Faqs = () => {
  ...
  return (
    <div>
      ...
      <div className="absolute top-16 md:top-24 inset-x-1/4 text-center space-y-3">
        ...
        <Link href={"/contact-us/"} className="ti-btn ti-btn-secondary">
            ...
            <div className="box">
              <div className="box-body p-0">
                <nav className="flex flex-col space-y-3 p-4" aria-label="Tabs" role="tablist" data-hs-tabs-vertical="true">
                  <Link href="#!" scroll={false} id="faq-item-1" data-hs-tab="#faq-1" aria-controls="faq-1" role="tab"
                  ...
                  <Link href="#!" scroll={false} id="faq-item-2" data-hs-tab="#faq-2" aria-controls="faq-2" role="tab"
                  ...
                  <Link href="#!" scroll={false} id="faq-item-3" data-hs-tab="#faq-3" aria-controls="faq-3" role="tab"
                    className="w-full hs-tab-active:border-secondary hs-tab-active:text-white hs-tab-active:bg-secondary dark:hs-tab-active:border-secondary dark:hs-tab-active:text-white dark:hs-tab-active:bg-secondary text-base leading-none rounded-sm p-3 bg-gray-100 dark:bg-black/20">
                    Common {`Faq's`}
                  </Link>
                  <Link href="#!" scroll={false} id="faq-item-4" data-hs-tab="#faq-4" aria-controls="faq-4" role="tab"
                    className="w-full hs-tab-active:border-secondary hs-tab-active:text-white hs-tab-active:bg-secondary dark:hs-tab-active:border-secondary dark:hs-tab-active:text-white dark:hs-tab-active:bg-secondary text-base leading-none rounded-sm p-3 bg-gray-100 dark:bg-black/20">
                    Advanced {`Faq's`}
                  </Link>
                </nav>
