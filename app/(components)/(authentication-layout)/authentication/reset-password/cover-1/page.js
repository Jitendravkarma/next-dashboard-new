...
const Resetpasswordcover1 = () => {
	...
	return (
		<>
			<Seo title={"Resetpassword-cover1"} />
						...
						<div className="p-4 sm:p-7">
							<div className="text-center">
								...
								<p className="mt-3 text-sm text-gray-600 dark:text-white/70">
									...
									<Link className="text-primary decoration-2 hover:underline font-medium ms-1 inline-flex" href={"/authentication/sign-in/cover-1/"}> Sign in here </Link>
								</p>
							</div>
