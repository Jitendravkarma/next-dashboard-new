...
const Signupbasic = () => {
	...
	return (
		<main id="content" className="w-full max-w-md mx-auto p-6 h-8vh h-full">
					...
					<div className="text-center">
						...
						<p className="mt-3 text-sm text-gray-600 dark:text-white/70">
							...
							<Link className="text-primary decoration-2 hover:underline font-medium ms-1 inline-flex"
								href={"/authentication/sign-in/basic"}>  Sign in here
							</Link>
						</p>
					</div>
						...
						<form>
							<div className="grid gap-y-4">
								...
								<div className="flex items-center">
									<div className="flex">
										<input id="hs-default-checkbox" type="checkbox"
											className="border-gray-500 ti-form-checkbox mt-0.5 check-all" />
									</div>
									<div className="ltr:ml-3 rtl:mr-3">
										<label className="text-sm dark:text-white">I accept the <Link
