      ...
      <div className="py-20">
        <div className="max-w-screen-xl mx-auto px-4">
          ...
          <div className="text-center">
            <h1 className="text-2xl sm:text-4xl text-gray-800 font-semibold"><span className="text-blue-500">So Lets Talk Data</span><br/>Documentation</h1>
          ...
          <div className="mt-10">
            ...
            <div className="py-24">
              ...
              <ul className="list-disc text-base ml-5">
                <li>Locate the downloaded file, and simply unzip it.</li>
                <li>
