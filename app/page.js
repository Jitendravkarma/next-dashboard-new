...
const Firebaselogin = () => {
    ...
    return (
        <Fragment>
            <html className="h-full light" dir="ltr">
                <body className="error-page flex h-full !py-0 bg-white dark:bg-bgdark">
                        ...
                        <div className="lg:col-span-6 col-span-12 hidden lg:block relative">
                            <div className="cover relative w-full h-full z-[1] p-10">
                                <Link href="#!" scroll={false} className="header- logo">
                                    <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/img/brand-logos/desktop-light.png`} alt="logo"
                                ...
                                <div className="authentication-page !h-full justify-center w-full max-w-7xl mx-auto p-0">
                                    <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/img/authentication/2.png`} alt="logo" className="mx-auto h-[500px]" />
                                </div>
                            </div>
                        </div>
                        <div className="lg:col-span-6 col-span-12">
                            <div className="authentication-page w-full">
                                <main id="content" className="w-full max-w-md mx-auto p-6">
                                    <Link href="#!" scroll={false} className="header-logo lg:hidden">
                                        <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/img/brand-logos/desktop-logo.png`} alt="logo" className="mx-auto block dark:hidden" />
                                        <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/img/brand-logos/desktop-logo.png`} alt="logo" className="mx-auto hidden dark:block" />
                                    </Link>
                                    <div className="mt-7">
                                        <nav className="!block px-6  mx-auto firebase-data" aria-label="Tabs" role="tablist">
                                            <div className="flex justify-center space-x-2 bg-light p-2 rounded-md rtl:space-x-reverse">
                                                ...
                                                <button type="button" className="hs-tab-active:bg-primary hs-tab-active:text-white py-2 px-2 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-gray-500 rounded-sm hover:text-primary  dark:text-white/70 dark:hover:text-white active" id="pills-with-brand-color-item-1" data-hs-tab="#pills-with-brand-color-01" aria-controls="pills-with-brand-color-01">
                                                    <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/img/brand-logos/nextjs.png`} alt="user-img" className="avatar avatar-sm w-6 h-6 rounded-full ring-0" />
                                                </button>
                                                <button type="button" className="hs-tab-active:bg-primary hs-tab-active:text-white py-2 px-2 inline-flex items-center gap-2 bg-transparent text-sm font-medium text-center text-gray-500 rounded-sm hover:text-primary  dark:text-white/70 dark:hover:text-white" id="pills-with-brand-color-item-2" data-hs-tab="#pills-with-brand-color-02" aria-controls="pills-with-brand-color-02">
                                                    <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/img/brand-logos/firbase.png`} alt="user-img" className="avatar avatar-sm w-6 h-6 rounded-full ring-0" />
                                                </button>
                                            </div>
                                        </nav>
                                            ...
                                            <div className="p-4 sm:p-7">
                                                <div className="text-center">
                                                    ...
                                                    <p className="mt-3 text-sm text-gray-600 dark:text-white/70">
                                                        ...
                                                        <Link className="text-primary decoration-2 hover:underline font-medium" href={"/authentication/sign-up/cover-2/"}>
                                                            Sign up here
                                                        </Link>
                                                    </p>
                                                </div>
                                                <div className="mt-5">
                                                    <button type="button"
                                                        ...
                                                        <img src={`${process.env.NODE_ENV === "production" ? basePath : ""}/assets/img/authentication/social/1.png`} className="w-4 h-4"
                                                            alt="google-img" />
                                                        Sign in with Google
                                                    </button>
                                                        ...
                                                        <div className="grid gap-y-4">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="relative">
                                                                    <input type="email" id="email1" name="email" onChange={changeHandler} value={email}
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="relative">
                                                                    <input type="password" id="password1" name="password" value={password} onChange={changeHandler}
                                                                        className="py-2 px-3 block w-full border-gray-200 rounded-sm text-sm focus:border-primary focus:ring-primary dark:bg-bgdark dark:border-white/10 dark:text-white/70"
                                                                        required />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="flex items-center">
                                                                ...
                                                                <div className="ltr:ml-3 rtl:mr-3">
                                                                    <label className="text-sm dark:text-white">Remember
                                                                        me</label>
                                                                </div>
                                                            </div>
                                        ...
                                        <div id="pills-with-brand-color-02" className="hidden" role="tabpanel" aria-labelledby="pills-with-brand-color-item-2">
                                            <div className="p-4 sm:p-7">
                                                <div className="text-center">
                                                    ...
                                                    <p className="mt-3 text-sm text-gray-600 dark:text-white/70">
                                                        {`Don't`} have an account yet?
                                                        <Link className="text-primary decoration-2 hover:underline font-medium" href={"/signup/"}>
                                                            Sign up here
                                                        </Link>
                                                    </p>
                                                </div>
