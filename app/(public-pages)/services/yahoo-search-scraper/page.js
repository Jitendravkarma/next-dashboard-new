...
import {
  ...
  YahoosearchscraperVideo,
  HowitworksYahoosearchscraper,
    ...
    <>
      <section className="py-14 lg:py-16 bg-gradient-to-b from-blue-200 to-white flex justify-center items-center">
        <div className="w-full lg:w-[80%] text-center px-4 lg:px-16">
          <PageHeader {...YahoosearchscraperProps} />
        ...
        <div className="w-full lg:w-[80%] text-center px-4 lg:px-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
            <div className="bg-white shadow-md rounded-md lg:px-8 px-2 py-10 col-span-1">
              {yahoosearchscraperdataget
                .slice(0, Math.ceil(yahoosearchscraperdataget.length / 3))
                .map((data, dataindex) => (
                  <div
                    key={dataindex}
            ...
            <div className="bg-white shadow-md rounded-md lg:px-8 px-2 py-10 col-span-1">
              {yahoosearchscraperdataget
                .slice(
                  Math.ceil(yahoosearchscraperdataget.length / 3),
                  Math.ceil((2 * yahoosearchscraperdataget.length) / 3)
                )
                .map((data, dataindex) => (
                  <div
                    key={dataindex}
            ...
            <div className="bg-white shadow-md rounded-md lg:px-8 px-2 py-10 col-span-1">
              {yahoosearchscraperdataget
                .slice(Math.ceil((2 * yahoosearchscraperdataget.length) / 3))
                .map((data, dataindex) => (
                  <div
                    key={dataindex}
                    className="flex items-center justify-between md:justify-start text-base text-black font-light gap-2 mb-2"
