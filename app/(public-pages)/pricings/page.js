      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-50 hover:shadow-xl hover:scale-105 duration-300 border border-gray-200 rounded-md p-7">
            ...
            <button className="w-full bg-gray-200 hover:bg-gray-300 text-gray-800 py-3 rounded-md font-semibold mb-6 transition">
              Buy Silver Plan ↗
            </button>
          ...
          <div className="relative bg-gray-50 hover:shadow-xl hover:scale-105 duration-300 border-2 border-orange-400 rounded-md p-7 shadow-lg">
            ...
            <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-md font-semibold mb-6 transition">
              Buy Gold Plan ↗
            </button>
      ...
      <section className="relative py-24 px-6 bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#1e293b] text-center overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <p className="text-gray-400 text-sm mt-6">
            Usually responds within a few minutes · Mon–Sat, 10am–7pm IST
          </p>
        </div>
      </section>
    </>
