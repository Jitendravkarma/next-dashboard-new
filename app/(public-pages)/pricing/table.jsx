...
const PricingTable = () => {
  return (
    <div className="bg-white py-14 max-w-screen-lg mx-auto">
      {/* Table Heading */}
      <h1 className="text-4xl font-bold text-center mb-10">Compare Plans & Features</h1>
        ...
        <table className="min-w-full border-collapse text-center">
          ...
          <thead>
            <tr className="border-b border-gray-200">
              ...
              <th className="py-4 px-6">Professional Plan</th>
            </tr>
          </thead>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="pb-5 px-6">
                <Link href={"https://codecanyon.net/item/google-map-scraper-pro/25283251"} target="_blank" className="inline-block mt-6 w-[130px] py-2 border-b-2 border-green-500 hover:text-white font-semibold rounded-md hover:bg-green-500">Subscribe</Link>
              </td>
              <td className="pb-5 px-6">
                <Link href={"https://codecanyon.net/item/google-map-scraper-pro/25283251"} target="_blank" className="inline-block mt-6 w-[130px] py-2 border-b-2 border-yellow-500 hover:text-white font-semibold rounded-md hover:bg-yellow-500">Subscribe</Link>
              </td>
            </tr>
            ...
            {/* devices access */}
            <tr>
              <td className="py-4 px-6 text-left bg-gray-100 md:bg-white shadow-md">Login Access</td>
              <td className="py-4 px-6">Single Device</td>
              <td className="py-4 px-6">5 Devices</td>
              <td className="py-4 px-6">10 Devices</td>
            </tr>
